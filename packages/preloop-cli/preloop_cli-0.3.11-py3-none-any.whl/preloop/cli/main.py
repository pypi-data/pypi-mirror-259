...
#     """
#     print_json(preloop_client.delete_datasource(DeleteDatasourceRequest(datasource_id=datasource_id)).model_dump_json())
...
def stop_ml_model(hosted_ml_model_id: Annotated[str, typer.Option()]):
    ...
    """
    print_json(preloop_client.stop_ml_model(StopMLModelRequest(ml_model_id=hosted_ml_model_id)).model_dump_json())
