...
class Sound:
    ...
    def buffer(self, data: typing.Any, rate: float) -> "Sound":
    ...
    def file(self, filename: str) -> "Sound":
    ...
    def sawtooth(self, frequency: float, rate: int = 48000) -> "Sound":
    ...
    def silence(self, rate: int = 48000) -> "Sound":
    ...
    def sine(self, frequency: float, rate: int = 48000) -> "Sound":
    ...
    def square(self, frequency: float, rate: int = 48000) -> "Sound":
    ...
    def triangle(self, frequency: float, rate: int = 48000) -> "Sound":
