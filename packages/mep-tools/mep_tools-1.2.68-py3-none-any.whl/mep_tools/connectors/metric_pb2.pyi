...
class AvailableValues(_message.Message):
    ...
    metric_key: _containers.RepeatedScalarFieldContainer[str]
    values: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, metric_key: _Optional[_Iterable[str]] = ..., values: _Optional[_Iterable[str]] = ...) -> None: ...

class AvailableValuesResponse(_message.Message):
    __slots__ = ("filter_values",)
    FILTER_VALUES_FIELD_NUMBER: _ClassVar[int]
    filter_values: _containers.RepeatedCompositeFieldContainer[AvailableValues]
    def __init__(self, filter_values: _Optional[_Iterable[_Union[AvailableValues, _Mapping]]] = ...) -> None: ...

class ValuesAvailabilityRequest(_message.Message):
