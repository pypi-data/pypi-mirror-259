...
class RiskReward:
    ...
    def __init__(self, *, position: Position, broker_symbol: BrokerSymbol, symbol_name: str, symbol_price: float, sl: float, tgt: float | None = None, tsl: float | None = None) -> None: ...
    @property
    def ltp(self) -> float: ...
    @property
