...
class TaskAdapter:
    ...
    def from_task_v1(self) -> Task:
        ...
        task_dict['exclusion_level'] = ExclusionLevelEnum.AD_GROUP.value
        task_dict['placement_types'] = self._build_placement_types()
        task_dict['status'] = TaskStatus.ACTIVE
