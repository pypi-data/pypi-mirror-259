...
class KinesisstreamsToGluejob(
    ...
    def __init__(
        ...
        *,
        ...
        :param database_props: The props for the Glue database that the construct should use to create. If @database is set then this property is ignored. If none of @database and @databaseprops is provided, the construct will define a GlueDatabase resource.
