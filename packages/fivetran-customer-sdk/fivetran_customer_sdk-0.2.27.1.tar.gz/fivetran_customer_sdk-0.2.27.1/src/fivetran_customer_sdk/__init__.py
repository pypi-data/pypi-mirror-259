...
class Connector(connector_sdk_pb2_grpc.ConnectorServicer):
    ...
    def deploy(self, project_path: str, deploy_key: str, group: str, connector: str, configuration: dict = None):
        ...
        print(f"Deploying '{project_path}' to '{group}/{connector}' using key '{deploy_key}'")
        group_id = self.__get_group_id(group, deploy_key)
    ...
    @staticmethod
    def __get_group_id(group: str, deploy_key: str):
