...
def main():
    ...
    parser.add_argument("--state", type=str, default=None, help="Provide json state")
    parser.add_argument("--configuration", type=str, default=None, help="Provide secrets and payloads in json")
    ...
    # Read optional args from CLI args or ENV vars
    configuration = json.loads(args.configuration) if args.configuration else json.loads(os.getenv('CONFIGURATION', "{}"))
    state = json.loads(args.state) if args.state else json.loads(os.getenv('STATE', "{}"))
