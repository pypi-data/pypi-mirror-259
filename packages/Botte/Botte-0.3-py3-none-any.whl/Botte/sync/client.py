...
class TelegramClient:
    def __init__(self, token):
        ...
        self.openai_model = "text-davinci-003"  # Default model; users can modify it  # Default model; users can modify it
    ...
    def openai(self, chat_id, message):
        """Generates a response using OpenAI and sends it back to the user."""
        if not self.openai_api_key:
            self.send_message(chat_id, "OpenAI API key is not configured.")
            return
