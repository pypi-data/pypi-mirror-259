...
class IntegrationsEditor:
    ...
    def __set_editable_cfg(self, edit_cfg_part: list[dict]):
    ...
    def delete_integration(self, integrations_list: list[str]):
        editable_part = self.__get_editable_cfg()
        new_cfg_list = []
    ...
    def delete_automation(self, integrations_list: list[str]):
        editable_part = self.__get_editable_cfg()
        new_cfg_list = []
