...
class プロットアダプタークラス:
    ...
    def 追加する_カラム(
        ...
        カラム名: Union[str, int, float],
        ボディ: List[Union[str, int, float]],
    ) -> None:
        ...
    ...
    @staticmethod
    def 設定する_テーブルインデックス(データフレーム: pd.DataFrame, カラム名: Union[str, int, float]) -> None:
        ...
...
class 抽象構文木クラス:
    ...
    def 取得する_末端の葉s(
        self,
        抽象構文木: Union[astElement, None] = None,
    ...
    def 取得する_べき乗項(self, 抽象構文木: Union[astElement, None] = None) -> List[str]:
        """
...
class 座標クラス(座標ベースクラス):
    ...
    def プロットする_条件(
        self,
        条件: SymbolCondition,
        軸s: Union[List[str], None] = None,
        色: Union[hsla, None] = None,
    ) -> 座標クラス:
        ...

    def プロットする_直線の式(
        self,
        式: Union[式クラス, str, float, int, NativeFraction],
        変数: str,
        色: hsla = (220, 100, 50),
        ラベル: str = "",
    ) -> 座標クラス:
    ...
    def プロットする_散布の式(
        self,
        データ: Union[List[Position_x], Positions_list_x],
        式: Union[式クラス, str, float, int, NativeFraction],
        変数: str,
        色: Union[plot_color, hex_rgb] = "black",
        ラベル: str = "",
    ) -> 座標クラス:
        ...
    ...
    def プロットする_散布点(
        self,
        データ: Union[List[Position], Positions_list],
        色: Union[plot_color, hex_rgb],
    ) -> 座標クラス:
        ...
    ...
    def リセットする_プロットのプロパティ(
        self, プロパティ: Literal["dot_radius", "line_width", "z_oder"], 値: Union[float, int]
    ) -> 座標クラス:
        ...
...
class 複合条件クラス:
    ...
    def __eq__(self, other: Union[bool, symbol_condition]) -> 数理的ブールクラス:
        ...

    def __ne__(self, other: Union[bool, symbol_condition]) -> 数理的ブールクラス:
        ...

    def __lt__(self, other: Union[bool, symbol_condition]) -> 数理的ブールクラス:
        ...

    def __le__(self, other: Union[bool, symbol_condition]) -> 数理的ブールクラス:
        ...

    def __gt__(self, other: Union[bool, symbol_condition]) -> 数理的ブールクラス:
        ...

    def __ge__(self, other: Union[bool, symbol_condition]) -> 数理的ブールクラス:
        ...
...
class 複合条件_v1クラス(複合条件クラス):
    ...
    def __sub__(self, formula: 複合条件_v1クラス) -> Union[複合条件_v1クラス, 方程式クラス]:
        ...
...
class 浮動小数クラス:
    ...
    def __eq__(self, other: term_) -> Union[数理的ブールクラス, 方程式クラス]:
        ...

    def __ne__(self, other: term_) -> Union[数理的ブールクラス, 非等号クラス]:
        ...

    def __lt__(self, other: term_) -> Union[数理的ブールクラス, 不等式クラス]:
        ...

    def __le__(self, other: term_) -> Union[数理的ブールクラス, 不等式クラス]:
        ...

    def __gt__(self, other: term_) -> Union[数理的ブールクラス, 不等式クラス]:
        ...

    def __ge__(self, other: term_) -> Union[数理的ブールクラス, 不等式クラス]:
        ...
    ...
    @overload
    def __add__(self, formula: Union[float, int, 浮動小数クラス, 整数クラス, 分数クラス]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __sub__(self, formula: Union[整数クラス, int, 浮動小数クラス, float, 分数クラス]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __mul__(self, formula: Union[整数クラス, int, 浮動小数クラス, float, 分数クラス]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __truediv__(self, formula: Union[整数クラス, int, 浮動小数クラス, float, 分数クラス]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __mod__(self, formula: Union[整数クラス, int, 浮動小数クラス, float, 分数クラス]) -> 浮動小数クラス:
        """
        [%] の中置演算子
    ...
    @overload
    def __floordiv__(self, formula: Union[整数クラス, int, 浮動小数クラス, float, 分数クラス]) -> 整数クラス:
        """
        [//] の中置演算子
    ...
    def __pow__(
        self,
        formula: Union[式クラス, float, int, 分数クラス, 整数クラス, 浮動小数クラス],
    ) -> 式クラス:
        """
        [**] の中置演算子
    ...
    def __radd__(self, formula: Union[float, int]) -> 浮動小数クラス:
        """
        [+] の中置演算子
    ...
    def __rsub__(self, formula: Union[float, int]) -> 浮動小数クラス:
        """
        [-] の中置演算子
    ...
    def __rmul__(self, formula: Union[float, int]) -> 浮動小数クラス:
        """
        [*] の中置演算子
    ...
    def __rtruediv__(self, formula: Union[float, int]) -> 浮動小数クラス:
        """
        [/] の中置演算子
    ...
    def __rpow__(self, formula: Union[float, int]) -> 式クラス:
        """
        [**] の中置演算子
    ...
    def __rmod__(self, formula: Union[float, int]) -> 浮動小数クラス:
        """
        [%] の中置演算子
    ...
    def __rfloordiv__(self, formula: Union[float, int]) -> 整数クラス:
        """
        [//] の中置演算子
    ...
    def キャストできますか(self, タイプ: Union[type[整数クラス], type[分数クラス]]) -> bool:
        ...
    ...
    @property
    def は整数ですか(self) -> Union[bool, None]:
        ...
...
class 範囲クラス:
    ...
    def __or__(self, formula: 範囲クラス) -> Union[集合クラス, 範囲クラス]:
        ...

    def __and__(self, formula: 範囲クラス) -> Union[集合クラス, 範囲クラス]:
        ...

    def __sub__(self, formula: 範囲クラス) -> Union[集合クラス, 範囲クラス]:
        ...
    ...
    def 取得する_整数集合(
        self, 抽象構文木: Union[astElement, None] = None, 集合限界: int = 1000
    ) -> set[int]:
        ...
...
class 方程式クラス:
    def __init__(self, proof: 証明クラス, equation: Union[str, term_pair]) -> None:
        ...
    ...
    def __add__(
        self,
        equation_or_term: Union[方程式クラス, Term, int, float, NativeFraction],
    ) -> 方程式クラス:
        """
        [+] の中置演算子
    ...
    @property
    def 評価済み(self) -> Union[方程式クラス, 数理的ブールクラス]:
        ...
    ...
    def 取得する_特殊解_d1_v2(self, 検索範囲: Tuple[int, int]) -> Union[dict_int, None]:
        ...
    ...
    def 解く(self, フォーカスする変数: Union[str, 式クラス]) -> ベクトル式クラス:
        ...
    ...
    def 代入する(
        self,
        条件: Union[dict_float, dict_int, dict_term, 方程式クラス, 方程式sクラス],
        辺: Union[literal_direction, None] = None,
    ) -> 方程式クラス:
        ...
...
class 説明式クラス(方程式クラス):
    def __init__(self, proof: 証明クラス, equation: Union[str, formula_term_pair]) -> None:
        ...
...
class 方程敷く便利ツールクラス:
    ...
    def 調整関数(
        ...
        方程式: 方程式クラス,
        調整関数記号: Literal["+", "-", "*", "/", "**"],
        方程式または項: Union[方程式クラス, Term, float, int, NativeFraction],
        右から操作するかい: bool = True,
    ) -> 方程式クラス:
        ...
...
class 方程式sクラス:
    def __init__(
        self, proof: 証明クラス, equations: Union[express_list, express_tuple]
    ) -> None:
        ...
    ...
    def 変数を減らす(self, ターゲット変数: str = "", 定義方程式: Union[方程式クラス, None] = None) -> 方程式sクラス:
        ...

    def 解く(self, フォーカス項s: set[str] = set()) -> Union[ベクトル方程式クラス, None]:
        ...
...
class 解sクラス(方程式sクラス):
    def __init__(
        self,
        proof: 証明クラス,
        equations: Union[List[方程式クラス], Tuple[ベクトルクラス, ベクトルクラス]],
    ) -> None:
        ...
...
class 図登録クラス:
    def __init__(
        self,
        express: Union[SymbolCondition, 式クラス],
        plot_ranges: Union[
            plotRange,
            plotRanges,
            plotRange_2d,
...
class 式クラス:
    ...
    def __add__(
        self,
        other: Union[float, int, 整数クラス, 浮動小数クラス, 分数クラス, 式クラス],
    ) -> 式クラス:
        """
        [+] の中置演算子
    ...
    def __sub__(
        self,
        other: Union[式クラス, float, int, 分数クラス, 整数クラス, 浮動小数クラス],
    ) -> 式クラス:
        """
        [-] の中置演算子
    ...
    def __mod__(self, other: Union[式クラス, float, int, 整数クラス, 浮動小数クラス]) -> 式クラス:
        """
        [%] の中置演算子
    ...
    def __floordiv__(self, other: Union[式クラス, float, int, 整数クラス, 浮動小数クラス]) -> 式クラス:
        """
        [//] の中置演算子
    ...
    def __radd__(self, other: Union[float, int]) -> 式クラス:
        """
        [+] の中置演算子
    ...
    def __rsub__(self, other: Union[float, int]) -> 式クラス:
        """
        [-] の中置演算子
    ...
    def __rmul__(self, other: Union[float, int]) -> 式クラス:
        """
        [*] の中置演算子
    ...
    def __rtruediv__(self, other: Union[float, int]) -> 式クラス:
        """
        [/] の中置演算子
    ...
    def __rpow__(self, other: Union[float, int]) -> 式クラス:
        """
        [**] の中置演算子
    ...
    def __rmod__(self, other: Union[float, int]) -> 式クラス:
        """
        [%] の中置演算子
    ...
    def __rfloordiv__(self, other: Union[float, int]) -> 式クラス:
        """
        [//] の中置演算子
    ...
    def キャスト可能か(
        self,
        タイプ: Union[type[整数クラス], type[浮動小数クラス], type[分数クラス]],
    ) -> bool:
        ...
    ...
    @property
    def 整数である(self) -> Union[bool, None]:
        ...

    def ラフチェックする_整数(self, 大まかな検索: bool = False, 正のみ: bool = True) -> Union[bool, None]:
        ...

    def チェックする_互いに素か(
        self,
        その他: Union[整数クラス, int, 式クラス],
        相対的な素数のペア: List[Tuple[Union[int, 整数クラス, 式クラス], Union[int, 整数クラス, 式クラス]]] = [],
    ) -> Union[bool, None]:
        ...
...
class 式便利ツールクラス:
    ...
    def 左の関数を調整する(
        証明: 証明クラス,
        数式: 式クラス,
        調整関数: Callable[[variables, str, Union[str, int, float]], str],
        他の: Union[
            整数クラス,
            int,
            浮動小数クラス,
...
class 分数クラス:
    def __init__(self, proof: 証明クラス, express: Union[str, express_fraction]) -> None:
        ...
    ...
    @overload
    def __add__(self, formula: Union[整数クラス, int, 分数クラス]) -> Union[分数クラス, 整数クラス]:
        ...

    @overload
    def __add__(self, formula: Union[浮動小数クラス, float]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __sub__(self, formula: Union[整数クラス, int, 分数クラス]) -> Union[分数クラス, 整数クラス]:
        ...

    @overload
    def __sub__(self, formula: Union[浮動小数クラス, float]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __mul__(self, formula: Union[整数クラス, int, 分数クラス]) -> Union[分数クラス, 整数クラス]:
        ...

    @overload
    def __mul__(self, formula: Union[浮動小数クラス, float]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __truediv__(self, formula: Union[整数クラス, int, 分数クラス]) -> Union[分数クラス, 整数クラス]:
        ...

    @overload
    def __truediv__(self, formula: Union[浮動小数クラス, float]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __mod__(self, formula: Union[整数クラス, int, 分数クラス]) -> Union[整数クラス, 分数クラス]:
        """
        [%] の中置演算子
    ...
    @overload
    def __mod__(self, formula: Union[float, 浮動小数クラス]) -> 浮動小数クラス:
        """
        [%] の中置演算子
    ...
    def __pow__(
        self,
        formula: Union[整数クラス, int, 浮動小数クラス, float, 分数クラス, 式クラス],
    ) -> 式クラス:
        ...

    @overload
    def __radd__(self, formula: Union[int, 整数クラス]) -> Union[分数クラス, 整数クラス]:
        ...
    ...
    @overload
    def __rsub__(self, formula: Union[int, 整数クラス]) -> Union[分数クラス, 整数クラス]:
        ...
    ...
    @overload
    def __rmul__(self, formula: Union[int, 整数クラス]) -> Union[分数クラス, 整数クラス]:
        ...
    ...
    @overload
    def __rtruediv__(self, formula: Union[int, 整数クラス]) -> Union[分数クラス, 整数クラス]:
        ...
    ...
    @overload
    def __rmod__(self, formula: Union[int, 整数クラス]) -> Union[整数クラス, 分数クラス]:
        """
        [%] の中置演算子
    ...
    @overload
    def __rpow__(self, formula: Union[int, 整数クラス]) -> Union[分数クラス, 整数クラス]:
        ...
    ...
    def キャストできるか(self, タイプ: Union[type[浮動小数クラス], type[整数クラス]]) -> bool:
        ...
    ...
    @property
    def は整数か(self) -> Union[bool, None]:
        ...

    @property
    def 数(self) -> Union[int, NativeFraction]:
        ...
...
class 不等式クラス:
    ...
    @property
    def 評価された(self) -> Union[不等式クラス, 数理的ブールクラス]:
        ...
    ...
    @property
    def 解かれた(self) -> Union[不等式クラス, 数理的ブールクラス, 複合条件クラス]:
        ...
...
class 不等式_v1クラス(不等式クラス):
    ...
    def __sub__(self, formula: 不等式_v1クラス) -> Union[複合条件_v2クラス, 複合条件_v1クラス, 方程式クラス]:
        ...
...
class 不等式_v2クラス(不等式クラス):
    ...
    def __sub__(self, formula: 不等式_v1クラス) -> Union[複合条件_v2クラス, 方程式クラス]:
        ...
...
class 整数クラス:
    ...
    @overload
    def __add__(self, other: Union[整数クラス, int]) -> 整数クラス:
        ...
    ...
    @overload
    def __add__(self, other: Union[浮動小数クラス, float]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __sub__(self, other: Union[整数クラス, int]) -> 整数クラス:
        ...
    ...
    @overload
    def __sub__(self, other: Union[浮動小数クラス, float]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __mul__(self, other: Union[整数クラス, int]) -> 整数クラス:
        ...
    ...
    @overload
    def __mul__(self, other: Union[浮動小数クラス, float]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __truediv__(self, other: Union[整数クラス, int, 分数クラス]) -> Union[分数クラス, 整数クラス]:
        ...

    @overload
    def __truediv__(self, other: Union[浮動小数クラス, float]) -> 浮動小数クラス:
        ...
    ...
    @overload
    def __mod__(self, other: Union[整数クラス, int]) -> 整数クラス:
        """
        [%] の中置演算子

        引数:
            other: Union[整数クラス, int]
        結果:
            式クラス
        """
        ...
    ...
    @overload
    def __mod__(self, other: 分数クラス) -> Union[整数クラス, 分数クラス]:
        """
        [%] の中置演算子
    ...
    @overload
    def __mod__(self, other: Union[float, 浮動小数クラス]) -> 浮動小数クラス:
        """
        [%] の中置演算子
    ...
    @overload
    def __floordiv__(self, other: Union[整数クラス, int, 浮動小数クラス, float, 分数クラス]) -> 整数クラス:
        """
        [//] の中置演算子
    ...
    @overload
    def __pow__(self, other: Union[整数クラス, int]) -> 整数クラス:
        """
        [**] の中置演算子
    ...
    def __pow__(
        self,
        other: Union[式クラス, float, 浮動小数クラス, 分数クラス],
    ) -> 式クラス:
        """
        [**] の中置演算子
    ...
    @overload
    def __radd__(self, other: Union[int, 整数クラス]) -> 整数クラス:
        """
        [+] の中置演算子
    ...
    @overload
    def __rsub__(self, other: Union[int, 整数クラス]) -> 整数クラス:
        """
        [-] の中置演算子
    ...
    @overload
    def __rmul__(self, other: Union[int, 整数クラス]) -> 整数クラス:
        """
        [*] の中置演算子
    ...
    @overload
    def __rtruediv__(self, other: Union[int, 整数クラス]) -> Union[整数クラス, 分数クラス]:
        """
        [/] の中置演算子
    ...
    @overload
    def __rpow__(self, other: Union[int, 整数クラス]) -> 整数クラス:
        """
        [**] の中置演算子
    ...
    @overload
    def __rmod__(self, other: Union[int, 整数クラス]) -> 整数クラス:
        """
        [%] の中置演算子
    ...
    def __rfloordiv__(self, other: Union[float, int]) -> 整数クラス:
        """
        [//] の中置演算子
    ...
    def __eq__(self, term: term_) -> Union[数理的ブールクラス, 方程式クラス]:
        ...

    def キャスト可能か(self, 型: Union[type[浮動小数クラス], type[分数クラス]]) -> bool:
        """
        キャストが可能かどうかを返します。
        """
        ...
    ...
    @property
    def 整数であるか(self) -> Union[bool, None]:
        """
        整数であるかどうかを返します。
        """
        ...
    ...
    def 互いに素であるか(
        self,
        その他: Union[整数クラス, int],
        互いに素なペア: List[Tuple[Union[int, 整数クラス, 式クラス], Union[int, 整数クラス, 式クラス]]] = [],
    ) -> bool:
        """
        互いに素であるかどうかを返します。
        """
...
class 整数便利ツール:
    ...
    def 演算する_左(
        証明: 証明クラス,
        整数: 整数クラス,
        演算子: Callable[[variables, str, Union[str, int, float]], str],
        その他: Union[int, 整数クラス],
    ) -> 整数クラス:
        ...
    ...
    def 除算し切り捨てる(
        証明: 証明クラス,
        整数: 整数クラス,
        その他: Union[整数クラス, int, 浮動小数クラス, float, 分数クラス],
    ) -> 整数クラス:
        """
            [//] の中置演算子
    ...
    @staticmethod
    @overload
    def 取得する_剰余(証明: 証明クラス, 整数: 整数クラス, その他: Union[整数クラス, int]) -> 整数クラス:
        ...

    @staticmethod
    @overload
    def 取得する_剰余(証明: 証明クラス, 整数: 整数クラス, その他: 分数クラス) -> Union[整数クラス, 分数クラス]:
        ...
    ...
    @staticmethod
    @overload
    def べき乗を計算する(証明: 証明クラス, 整数: 整数クラス, その他: Union[整数クラス, int]) -> 整数クラス:
        """
            [**] の中置演算子
    ...
    def べき乗を計算する(
        証明: 証明クラス,
        整数: 整数クラス,
        その他: Union[式クラス, float, 浮動小数クラス, 分数クラス],
    ) -> 式クラス:
        """
            [**] の中置演算子
    ...
    @staticmethod
    def 除算し切り捨てる_右_(証明: 証明クラス, 整数: 整数クラス, その他: Union[float, int]) -> 整数クラス:
        """
            [//] の中置演算子
    ...
    @staticmethod
    @overload
    def 剰余_右_(証明: 証明クラス, 整数: 整数クラス, その他: Union[int, 整数クラス]) -> 整数クラス:
        """
            [%] の中置演算子
    ...
    @staticmethod
    @overload
    def べき乗_右_(証明: 証明クラス, 整数: 整数クラス, その他: Union[int, 整数クラス]) -> 整数クラス:
        """
            [**] の中置演算子
    ...
    @staticmethod
    @overload
    def 除算_右_(証明: 証明クラス, 整数: 整数クラス, その他: Union[int, 整数クラス]) -> Union[整数クラス, 分数クラス]:
        """
            [/] の中置演算子
...
class 証明クラス:
    ...
    @overload
    def 取得する_変数(self, 変数: Union[List[str], set[str]]) -> List[式クラス]:
        ...
    ...
    def 挿入する_セクション(
        self,
        セクション: Union[セクションクラス, str],
        親セクション: Union[str, セクションクラス, None] = None,
    ) -> 証明クラス:
        ...
    ...
    def 作成する_変数(
        self,
        変数s: str,
        変数の種類s: Union[variable_type_optional, variable_types_optional] = {},
    ) -> 式クラス:
        ...
...
class pythonユーティリティクラス:
    @staticmethod
    def 表示する_安全に(内容s: Union[str, Markdown, Math]) -> None:
        ...
...
class 関係コンテンツクラス:
    ...
    def 表示する(
        self,
        インデントの深さ: int = 0,
        前の内容: Union[関係コンテンツクラス, None] = None,
...
class セクションクラス:
    ...
    def 挿入する_セクション(self, セクション: Union[セクションクラス, str]) -> セクションクラス:
        ...

    def 作成する_サブセクション(
        self, タイトル: str, ID: str, インデックス: Union[int, None] = None
    ) -> セクションクラス:
        ...
...
class 数理的条件ユーティリティクラス:
    ...
    def 論理和(
        ...
        条件_右: Union[bool, symbol_condition],
    ) -> symbol_condition:
        """
            論理和の中置演算子
...
class 数理的ブールクラス:
    ...
    @overload
    def __and__(self, other: Union[bool, 数理的ブールクラス]) -> 数理的ブールクラス:
        ...
    ...
    @overload
    def __or__(self, other: Union[bool, 数理的ブールクラス]) -> 数理的ブールクラス:
        ...
...
class テーブルクラス:
    ...
    def 追加する_列(
        self, 列名: Union[str, int, float], ボディ: List[Union[str, int, float]]
    ) -> テーブルクラス:
        ...
...
class 項ユーティリティクラス:
    @staticmethod
    def 確認する_整数か(証明: 証明クラス, 項: Term) -> Union[bool, None]:
        ...
    ...
    @staticmethod
    def 評価する_等価(証明: 証明クラス, 項_左: Term, 項_右: term_) -> Union[数理的ブールクラス, 方程式クラス]:
        ...

    @staticmethod
    def 評価する_以上(証明: 証明クラス, 項_左: Term, 項_右: term_) -> Union[数理的ブールクラス, 不等式クラス]:
        ...

    @staticmethod
    def 評価する_大なり(証明: 証明クラス, 項_左: Term, 項_右: term_) -> Union[数理的ブールクラス, 不等式クラス]:
        ...

    @staticmethod
    def 評価する_以下(証明: 証明クラス, 項_左: Term, 項_右: term_) -> Union[数理的ブールクラス, 不等式クラス]:
        ...

    @staticmethod
    def 評価する_小なり(証明: 証明クラス, 項_左: Term, 項_右: term_) -> Union[数理的ブールクラス, 不等式クラス]:
        ...

    @staticmethod
    def 評価する_非等価(証明: 証明クラス, 項_左: Term, 項_右: term_) -> Union[数理的ブールクラス, 非等号クラス]:
        ...
...
class 非等号クラス:
    def __init__(self, proof: 証明クラス, equation: Union[str, express_term]) -> None:
        ...
    ...
    @property
    def 評価済み(self) -> Union[非等号クラス, 数理的ブールクラス]:
        ...
    ...
    def 代入する(
        ...
        辺: Union[Literal["left", "right"], None] = None,
    ) -> 非等号クラス:
        ...
...
class 便利ツールクラス:
    ...
    ) -> Union[整数クラス, 浮動小数クラス, 分数クラス, 式クラス]:
        ...

    @staticmethod
    def 表示する(内容s: Union[str, Markdown]) -> None:
        ...
...
class 整数ペアクラス(ベクトルクラス):
    ...
    def __getitem__(self, index: int) -> Union[式クラス, 整数クラス]:
        ...
...
class 自然数ペアクラス(整数ペアクラス):
    ...
    @property
    def 最大公約数(self) -> Union[自然数ペアクラス, integer_candidate]:
        ...
    ...
    @property
    def 最小公倍数(self) -> Union[integer_candidate, None]:
        ...
    ...
    @property
    def 総和の関係式(self) -> Union[方程式クラス, None]:
        ...
...
class ベクトル解sクラス:
    def __init__(
        self,
        proof: 証明クラス,
        equations: Union[List[ベクトル方程式クラス], List[解sクラス]],
    ) -> None:
        ...
    ...
    def 結合する(self, ベクトル方程式s: Union[List[ベクトル方程式クラス], ベクトル解sクラス]) -> ベクトル解sクラス:
        ...
