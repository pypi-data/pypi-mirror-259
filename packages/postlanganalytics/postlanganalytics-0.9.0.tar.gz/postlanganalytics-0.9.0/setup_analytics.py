...
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "postlanganalytics"))
...
setup(
    ...
    test_suite="postlanganalytics.test.all",
    packages=["postlanganalytics", "postlanganalytics.test"],
    license="MIT License",
