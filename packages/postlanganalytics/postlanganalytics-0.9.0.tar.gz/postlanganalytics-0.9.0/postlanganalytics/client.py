...
from postlanganalytics.consumer import Consumer
from postlanganalytics.poller import Poller
from postlanganalytics.request import APIError, batch_post, decide, get
from postlanganalytics.utils import clean, guess_timezone
...
class Client(object):
    """Create a new postlang client."""

    log = logging.getLogger("postlang")
    ...
    def __init__(
        ...
        self.host = host
        # host: the host is required as there is no default host
        require("host", self.host, string_types)
        self.gzip = gzip
    ...
    def _enqueue(self, msg):
        ...
        if not msg.get("properties"):
            msg["properties"] = {}
        msg["properties"]["$lib"] = "postlang-python"
