...
def worker_configuration_parser():
    ...
    docker_parser.add_option("build", type=str, default=None)
    docker_parser.add_option("context", type=str, default=None)
    docker_parser.add_option("image", type=str, default="")
    docker_parser.add_option("command", type=str, default=None)
    docker_parser.add_option("environment", type=dict, default={})
