...
class SparclClient:  # was SparclApi()
    ...
    Args:
        ...
        password (:obj:`str`, optional): User SSO password. If not given, the output will
    ...
    """
        ...
        try:
            ...
            self.token = None
            msg = (
                f'Could not login with given credentials. Reverted to "Anonymous" user.'
            )
            return msg
    ...
    def logout(self):
        ...
        Example:
            >>> client = SparclClient()
            >>> client.logout()
            Logged-out successfully.  Previously logged-in with email test_user@noirlab.edu.
        """
