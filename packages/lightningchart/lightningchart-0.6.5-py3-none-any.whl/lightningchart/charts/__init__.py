...
class Chart:
    ...
    def open(self, method: str = 'browser', live=False, width: int = 800, height: int = 600):
        ...
        if live and not self.instance.live:
            ...
            for i in self.instance.items:
                self.instance.send(i['id'], i['command'], i['param'])
        ...
        if str(method).lower() == 'browser':
            ...
            return self.instance.open_in_notebook(width, height)
        else:
            self.instance.open_in_browser()
            return self
