...
class Series:
    ...
    def clear(self):
        ...
        """
        self.instance.send(self.id, 'clearSeries')
        return self
...
class BetaXYFeatures(Series):
    ...
    def append_samples(
            ...
            colors: list[int | float] = None,

            start: list[int | float] = None,
            step: list[int | float] = None,
            count: list[int | float] = None,
            offset: list[int | float] = None,
            offset_colors: list[int | float] = None,
            offset_ids: list[int | float] = None,
            offset_lookup_values: list[int | float] = None,
            offset_rotations: list[int | float] = None,
            offset_sizes: list[int | float] = None,
    ):
    ...
    def alter_samples(
        ...
        This method alters existing samples by referencing sample indexes. This simply refers to a incrementing counter
...
class SeriesWithIndividualPoint(Series):
    ...
    def set_individual_point_color_enabled(self, enabled: bool = True):
...
class SeriesWith2DPoints(Series):
    ...
    def set_palette_colors(
        ...
        # self.instance.send(self.id, 'setIndividualPointValueEnabled', {'enabled': True})
    ...
    def set_min_max_palette_colors(
            self,
            min_value: int | float,
            max_value: int | float,
        ...
        """
        self.instance.send(self.id, 'setIndividualPointValueEnabled', {'enabled': True})
        self.instance.send(self.id, 'setPalettedPointFillStyleMinMax', {
            'minValue': min_value,
            'maxValue': max_value,
...
class SeriesWithLUT(Series):
    ...
    def set_min_max_palette_colors(
        ...
        Returns:
            The instance of the class for fluent interface.
        """
        self.instance.send(self.id, 'setPalettedFillStyleMinMax', {
            'minValue': min_value,
            'maxValue': max_value,
            'minColor': min_color.get_hex(),
            'maxColor': max_color.get_hex(),
...
class SeriesWith3DShading(Series):
    ...
    def set_color_shading_style(
            ...
            specular_color: lightningchart.Color = lightningchart.ColorHEX('#ffffff')
    ):
...
class Series2D(Series):
    ...
    def set_cursor_enabled(self, enabled: bool = True):
