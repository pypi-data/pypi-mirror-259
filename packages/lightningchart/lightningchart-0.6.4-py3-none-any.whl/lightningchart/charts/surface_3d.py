...
class Surface3D(Chart3D):
    ...
    def __init__(
            ...
            min_color: lightningchart.Color = lightningchart.ColorHEX('#000000'),
            max_color: lightningchart.Color = lightningchart.ColorHEX('#ffffff'),
        ...
        self.instance.send(self.id, 'chart3D', {'theme': theme.value, 'license': license or conf.LICENSE_KEY})
