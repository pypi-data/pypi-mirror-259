...
class EdukaConnector(SisConnector):
    ...
    def __init__(
        ...
        :param eduka_properties_mapping: The mapping between the Eduka
            properties (the keys) and the Xebus properties (the values),
            containing information about children and their guardians.

        :param eduka_grades_names_mapping: The mapping between the names of
            the education grades (the keys) declared in Eduka and their
            corresponding levels (the values).
        ...
        self.__eduka_grades_names_mapping = utils.normalize_names_codes_mapping(eduka_grades_names_mapping)

        self.__eduka_languages_names_mapping = utils.normalize_names_codes_mapping(
            eduka_languages_names_mapping
            or self.__load_eduka_languages_names_mapping_from_default_csv_file(FRENCH_LOCALE)
        )

        self.__eduka_nationalities_names_mapping = utils.normalize_names_codes_mapping(
