...
class AppInfo(BaseModel):
    ...
    error404_callback_func: Optional[Callable[[str, bool], ResponseTemplateResult]] = None
    # 错误500创建context_data的函数，参数：(message: str, is_mobile: bool = False)
    error500_callback_func: Optional[Callable[[str, bool], ResponseTemplateResult]] = None
    ...
    error501_callback_func: Optional[Callable[[str, bool], ResponseTemplateResult]] = None
    # 额外的数据参数
