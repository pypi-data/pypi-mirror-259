...
import typing
__all__ = ['Camera', 'CameraConfig', 'CaptureMethodConflict', 'CaptureTimeout', 'ConfigFileEmpty', 'ConfigFormatError', 'Control', 'ControlFormatError', 'Critical', 'DMA', 'Debug', 'Device', 'DeviceConnect', 'DeviceDisconnect', 'DeviceToHost', 'Empty', 'Err', 'ErrorCode', 'EventCode', 'Exit', 'Format', 'FormatMode', 'Frame', 'FrameEnd', 'FrameStart', 'FreeEmptyBuffer', 'FreeUnknowBuffer', 'Full', 'High', 'HostToDevice', 'I2CMode', 'I2C_MODE_16_16', 'I2C_MODE_16_32', 'I2C_MODE_16_8', 'I2C_MODE_8_16', 'I2C_MODE_8_8', 'Info', 'InitCameraFailed', 'JPG', 'LoggerLevel', 'Low', 'MON', 'MON_D', 'MemType', 'MemoryAllocateFailed', 'NotSupport', 'Off', 'OpenCameraFailed', 'Param', 'RAM', 'RAW', 'RAW_D', 'RGB', 'ReadConfigFileFailed', 'RegisterMultipleCallback', 'STATS', 'StateError', 'Success', 'Super', 'SuperPlus', 'Trace', 'TransferError', 'TransferTimeout', 'USBSpeed', 'USBTypeMismatch', 'Unknown', 'UnknownDeviceType', 'UnknownError', 'UnknownUSBType', 'UserdataAddrError', 'UserdataLenError', 'VRCommandDirection', 'VRCommandError', 'Warn', 'YUV', 'free_device_list', 'get_error_name', 'list_devices']
class Camera:
...
class ErrorCode:
    ...
    NotSupport: typing.ClassVar[ErrorCode]  # value = <ErrorCode.NotSupport: 61441>
...
class EventCode:
    ...
    DeviceDisconnect: typing.ClassVar[EventCode]  # value = <EventCode.DeviceDisconnect: 513>
...
class FormatMode:
    ...
    __members__: typing.ClassVar[dict[str, FormatMode]]  # value = {'RAW': <FormatMode.RAW: 0>, 'RGB': <FormatMode.RGB: 1>, 'YUV': <FormatMode.YUV: 2>, 'JPG': <FormatMode.JPG: 3>, 'MON': <FormatMode.MON: 4>, 'RAW_D': <FormatMode.RAW_D: 5>, 'MON_D': <FormatMode.MON_D: 6>, 'STATS': <FormatMode.STATS: 8>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
DeviceDisconnect: EventCode  # value = <EventCode.DeviceDisconnect: 513>
...
NotSupport: ErrorCode  # value = <ErrorCode.NotSupport: 61441>
