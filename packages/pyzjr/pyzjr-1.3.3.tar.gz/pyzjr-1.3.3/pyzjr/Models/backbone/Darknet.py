    ...
    def make_layers(self, cfg):
        ...
        for i in cfg:
            if i == 'M':
                ...
                out_channels, kernel_size, padding = i[0], i[1], i[2]
...
cfg = {"A":[(32, 3, 1), 'M', (64, 3, 1), 'M', (128, 3, 1), (64, 1, 0), (128, 3, 1), 'M', (256, 3, 1),
         (128, 1, 0), (256, 3, 1), 'M', (512, 3, 1), (256, 1, 0), (512, 3, 1), (256, 1, 0),
         (512, 3, 1), 'M', (1024, 3, 1), (512, 1, 0), (1024, 3, 1), (512, 1, 0), (1024, 3, 1)],
