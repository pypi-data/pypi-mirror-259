...
def get_model_test_data(test_import_path: str) -> Tuple[Dict, Optional[Dict], bool]:
    ...
    return test_input, input_file_reference, check  # type: ignore
...
if __name__ == "__main__":
    ...
    test_input, input_file_reference, check = get_model_test_data(c.test_import_path)
    ...
    if input_file_reference is not None:
        ...
        content_to_upload = str(json.dumps(test_input["input"][0]["input_logs"]))
        ...
        input_file_reference["input"][0][
            "input_file_reference"
        ] = file_metadata.external_id
