...
# [Aspose.3D for Python via .NET](https://releases.aspose.com/3d/python-net/) (v24.1.0)
...
```python
pip install aspose-3d==24.1.0
```

# [Aspose.BarCode for Python via .NET](https://releases.aspose.com/barcode/python-net/) (v24.1.0)
...
```python
pip install aspose-barcode-for-python-via-net==24.1
```

# [Aspose.CAD for Python via .NET](https://releases.aspose.com/cad/python-net/) (v23.12.0)
...
```python
pip install aspose-cad==23.12
```

# [Aspose.Cells for Python via .NET](https://releases.aspose.com/cells/python-net/) (v24.2.0)
...
```python
pip install aspose-cells-python==24.2.0
```

# [Aspose.Diagram for Python via .NET](https://releases.aspose.com/diagram/python-net/) (v24.2.0)
...
```python
pip install aspose-diagram-python==24.2
```

# [Aspose.Email for Python via .NET](https://releases.aspose.com/email/pythonnet/) (v24.1)
...
```python
pip install Aspose.Email-for-Python-via-NET==24.1
```

# [Aspose.Finance for Python via .NET](https://releases.aspose.com/finance/python-net/) (v24.1.0)
...
```python
pip install aspose-finance==24.1
```
...
# [Aspose.OCR for Python via .NET](https://releases.aspose.com/ocr/python-net/) (v24.1.0)
...
```python
pip install aspose-ocr-python-net==24.1.0
```
...
# [Aspose.PDF for Python via .NET](https://releases.aspose.com/pdf/pythonnet/) (v24.2.0)
...
```python
pip install aspose-pdf==24.2.0
```

# [Aspose.PSD for Python via .NET](https://releases.aspose.com/slides/python-net/) (v23.12.0)
...
```python
pip install aspose-psd==23.12.0
```

# [Aspose.Slides for Python via .NET](https://releases.aspose.com/slides/python-net/) (v24.2.0)
...
```python
pip install Aspose.Slides==24.2.0
```

# [Aspose.Tasks for Python via .NET](https://releases.aspose.com/tasks/python-net/) (v24.1.0)
...
```python
pip install aspose-tasks==24.1.0
```

# [Aspose.TeX for Python via .NET](https://releases.aspose.com/tex/python-net/) (v24.2.0)
...
```python
pip install aspose-tasks==24.2.0
```

# [Aspose.Words for Python via .NET](https://releases.aspose.com/words/python/) (v24.2.0)
...
```python
pip install aspose-words==24.2.0
```

# [Aspose.ZIP for Python via .NET](https://releases.aspose.com/zip/python-net/) (v24.1.0)
