...
from ourskyai_sda_api.models.observation_feature import ObservationFeature
...
class ObservationResult(BaseModel):
    ...
    features: Optional[conlist(ObservationFeature)] = None
    __properties = ["imageId", "astrometricOffsets", "imageUrl", "jpgUrl", "ra", "dec", "boundingBox", "timestamp", "apparentMagnitude", "distanceFromPrediction", "features"]
    ...
    def from_dict(cls, obj: dict) -> ObservationResult:
        ...
        _obj = ObservationResult.parse_obj({
            ...
            "features": [ObservationFeature.from_dict(_item) for _item in obj.get("features")] if obj.get("features") is not None else None
        })
        return _obj
