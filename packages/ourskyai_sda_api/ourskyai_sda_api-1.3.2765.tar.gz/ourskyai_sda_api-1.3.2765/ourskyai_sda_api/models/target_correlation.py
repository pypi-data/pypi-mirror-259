...
class TargetCorrelation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TargetCorrelation:
        """Create an instance of TargetCorrelation from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TargetCorrelation:
        """Create an instance of TargetCorrelation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TargetCorrelation.parse_obj(obj)

        _obj = TargetCorrelation.parse_obj({
