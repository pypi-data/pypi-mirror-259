...
from ourskyai_sda_api.models.target_correlation import TargetCorrelation
...
class ObservationFeature(BaseModel):
    ...
    target_correlations: Optional[conlist(TargetCorrelation)] = Field(None, alias="targetCorrelations")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ObservationFeature:
        """Create an instance of ObservationFeature from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ObservationFeature:
        """Create an instance of ObservationFeature from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ObservationFeature.parse_obj(obj)

        _obj = ObservationFeature.parse_obj({
            "ra": obj.get("ra"),
            "dec": obj.get("dec"),
            ...
            "target_correlations": [TargetCorrelation.from_dict(_item) for _item in obj.get("targetCorrelations")] if obj.get("targetCorrelations") is not None else None
        })
        return _obj
