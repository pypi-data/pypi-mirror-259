...
class DefaultApi:
    ...
    @validate_arguments
    def v1_get_observation_statuses(self, target_id : Optional[StrictStr] = None, before : Optional[datetime] = None, search_instruction_id : Optional[StrictStr] = None, **kwargs) -> List[V1ObservationStatus]:  # noqa: E501
        """v1_get_observation_statuses  # noqa: E501

        Get the status of observations tasked on our network either for an entire organization, by a specific `targetId` or by a specific `searchInstructionId`.  By default `before` is set to the current time and returns 20 results with `observationTime` less than `before`. To paginate through responses, pass the earliest timestamp in the previous response as the `before` parameter.  When searching by `searchInstructionId`, a `before` timestamp is not required.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v1_get_observation_statuses(target_id, before, search_instruction_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.v1_get_observation_statuses_with_http_info(target_id, before, search_instruction_id, **kwargs)  # noqa: E501

    @validate_arguments
    def v1_get_observation_statuses_with_http_info(self, target_id : Optional[StrictStr] = None, before : Optional[datetime] = None, search_instruction_id : Optional[StrictStr] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """v1_get_observation_statuses  # noqa: E501
        ...
        >>> thread = api.v1_get_observation_statuses_with_http_info(target_id, before, search_instruction_id, async_req=True)
        >>> result = thread.get()
