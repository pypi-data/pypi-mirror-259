...
class Debye:
    ...
    where:
       ...
       The equation involves a double summation over all atoms i and j in the structure.
       The terms in the equation represent the wave nature of the scattered intensity,
    ...
    def __init__(self, qvec=None, custom_cm=False):
        if qvec is None:
        ...
        # only used if custom_cm = True, otherwise the cromermann method
        # from periodictable will take care of it
        self.cm = {
