...
from chalk.features.cron import CronQuery
...
@overload
def convert_type_to_gql(t: CronQuery, path_prefix: Optional[str] = None) -> UpsertCronQueryGQL:
    ...
