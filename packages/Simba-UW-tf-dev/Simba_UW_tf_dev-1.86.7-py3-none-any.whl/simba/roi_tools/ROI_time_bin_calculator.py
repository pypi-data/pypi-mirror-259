...
# data = np.random.randint(0, 2000, (1000000, 2))
# data_p = np.random.random((1000000, 1))
# data = np.hstack((data, data_p))
# data = pd.DataFrame(data, columns=['Nose_x', 'Nose_y', 'Nose_p'])
# data.to_csv('/Users/simon/Desktop/envs/simba/troubleshooting/two_black_animals_14bp/project_folder/csv/outlier_corrected_movement_location/test_1m.csv')
...
#                            bin_length=3600, body_parts=['Nose'], threshold=0.00)
# test.run()
# test.save()
