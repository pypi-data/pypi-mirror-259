...
class PageDatasetResponse(BaseModel):
    """
    PageDatasetResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDatasetResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PageDatasetResponse:
        """Create an instance of PageDatasetResponse from a dict"""
        if obj is None:
            return None
