...
class PageDashboardItem(BaseModel):
    """
    PageDashboardItem
    """

    items: conlist(DashboardItem) = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PageDashboardItem:
        """Create an instance of PageDashboardItem from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> PageDashboardItem:
        ...
        _obj = PageDashboardItem.parse_obj(
            {
                "items": [DashboardItem.from_dict(_item) for _item in obj.get("items")]
