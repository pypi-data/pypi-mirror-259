...
class DashboardItemQuery(BaseModel):
    """
    DashboardItemQuery
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DashboardItemQuery:
        """Create an instance of DashboardItemQuery from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DashboardItemQuery:
        """Create an instance of DashboardItemQuery from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DashboardItemQuery.parse_obj(obj)

        _obj = DashboardItemQuery.parse_obj(
            {
