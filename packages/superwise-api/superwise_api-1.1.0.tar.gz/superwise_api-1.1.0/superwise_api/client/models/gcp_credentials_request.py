...
class GCPCredentialsRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GCPCredentialsRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GCPCredentialsRequest:
        """Create an instance of GCPCredentialsRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GCPCredentialsRequest.parse_obj(obj)

        _obj = GCPCredentialsRequest.parse_obj(
            {
