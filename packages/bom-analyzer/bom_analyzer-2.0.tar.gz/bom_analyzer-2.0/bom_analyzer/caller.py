...
def report_suspect_units(
    ...
    Args:
        suspect_components (pd.DataFrame or str): DataFrame containing suspect components
            or the file path to the suspect components table.
        bom (pd.DataFrame or str): DataFrame containing the Bill of Materials (BoM)
            or the file path to the BoM table.
        archive_path (str, optional): Path to a CSV file where the filtered units will be archived.
...
def find_sernum(
        sernum_values: Union[str, list],
        table: Union[pd.DataFrame, str],
        archive_path: Optional[str] = None
) -> pd.DataFrame:

    """
    Filters input table to include only the units containing the specified sernum value in the SERNUM column.

    Args:
        sernum_values (Union[str, list]): The sernum value or list of sernum values to filter by.
    ...
    # Check sernum_values input
    sernum_values = to_strlist(sernum_values)
...
def find_differences(
        table: pd.DataFrame,
        sernum_values: Union[str, list] = None,
        archive_path: Optional[str] = None
) -> pd.DataFrame:
    ...
    Args:
        ...
        archive_path (str, optional): Path to a CSV file where the DataFrame of part differences will be archived.
...
def filter_by_PCA(
    ...
    Args:
        pca_values (Union[str, list]): The PCA value or list of PCA values to filter by.
        table (Union[pd.DataFrame, str]): The DataFrame or file path to the DataFrame to filter.
        archive_path (str, optional): Path to a CSV file where the filtered DataFrame will be archived.
    ...
    # Check values input
    pca_values = to_strlist(pca_values)
...
def filter_by_CPN(
    ...
    Args:
        cpn_values (Union[str, list]): The CPN value or list of CPN values to filter by.
        table (Union[pd.DataFrame, str]): The DataFrame or file path to the DataFrame to filter.
        archive_path (str, optional): Path to a CSV file where the filtered DataFrame will be archived.
    ...
    """
    if archive_path:
        filtered_table = filter_by_Util(header='CPN_', values=cpn_values, table=table, archive_path=archive_path)
    else:
        filtered_table = filter_by_Util(header='CPN_', values=cpn_values, table=table)

    return filtered_table

def filter_by_DateCode(
        datecode_values: Union[str, list],
        table: Union[pd.DataFrame, str],
        archive_path: Optional[str] = None
) -> pd.DataFrame:
    ...
    Args:
        datecode_values (Union[str, list]): The DateCode value or list of DateCode values to filter by.
        table (Union[pd.DataFrame, str]): The DataFrame or file path to the DataFrame to filter.
        archive_path (str, optional): Path to a CSV file where the filtered DataFrame will be archived.
    ...
    if archive_path:
        filtered_table = filter_by_Util(header='DateCode_', values=datecode_values, table=table, archive_path=archive_path)
    else:
        filtered_table = filter_by_Util(header='DateCode_', values=datecode_values, table=table)

    return filtered_table

def filter_by_LOTCODE(
        lotcode_values: Union[str, list],
        table: Union[pd.DataFrame, str],
        archive_path: Optional[str] = None
) -> pd.DataFrame:
    ...
    Args:
        lotcode_values (Union[str, list]): The LOTCODE value or list of LOTCODE values to filter by.
        table (Union[pd.DataFrame, str]): The DataFrame or file path to the DataFrame to filter.
        archive_path (str, optional): Path to a CSV file where the filtered DataFrame will be archived.
    ...
    if archive_path:
        filtered_table = filter_by_Util(header='LOTCODE_', values=lotcode_values, table=table, archive_path=archive_path)
    else:
        filtered_table = filter_by_Util(header='LOTCODE_', values=lotcode_values, table=table)

    return filtered_table

def filter_by_MPN(
        mpn_values: Union[str, list],
        table: Union[pd.DataFrame, str],
        archive_path: Optional[str] = None
) -> pd.DataFrame:
    ...
    Args:
        MPN_values (Union[str, list]): The MPN value or list of MPN values to filter by.
        table (Union[pd.DataFrame, str]): The DataFrame or file path to the DataFrame to filter.
        archive_path (str, optional): Path to a CSV file where the filtered DataFrame will be archived.
    ...
    if archive_path:
        filtered_table = filter_by_Util(header='MPN_', values=mpn_values, table=table, archive_path=archive_path)
    else:
        filtered_table = filter_by_Util(header='MPN_', values=mpn_values, table=table)

    return filtered_table

def filter_by_RD(
        rd_values: Union[str, list],
        table: Union[pd.DataFrame, str],
        archive_path: Optional[str] = None
) -> pd.DataFrame:
    ...
    Args:
        rd_values (Union[str, list]): The RD value or list of RD values to filter by.
        table (Union[pd.DataFrame, str]): The DataFrame or file path to the DataFrame to filter.
        archive_path (str, optional): Path to a CSV file where the filtered DataFrame will be archived.
...
def filter_by_Util(
    ...
    """
    Filters input table to include only the units containing the specified value in any header_i column.

    Args:
        values (Union[str, list]): The MPN value or list of values to filter by.
        table (Union[pd.DataFrame, str]): The DataFrame or file path to the DataFrame to filter.
        archive_path (str, optional): Path to a CSV file where the filtered DataFrame will be archived.
...
def to_strlist(
    ...
    """
    Converts values to list of str with error checking
    ...
    # Ensure values is a list of strings or a single string
    if isinstance(values, list):
        if not all(isinstance(val, str) for val in values):
            raise ValueError("All elements in 'values' list must be strings.")
    elif not isinstance(values, str):
        raise ValueError("Input 'values' must be either a list of strings or a single string.")
