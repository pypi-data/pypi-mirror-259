...
class SqliteStatementsMixin:
    ...
    def _get_conditions_statement(self, conditions: Q, *, is_internal_table: bool = False, use_internal_meta_tables: bool = False, is_grouped: bool = False) -> tuple[str, list[Any]]: ...
    def _get_filter_statement(self, filter_item: Filter, *, is_internal_table: bool = False, use_internal_meta_tables: bool = False) -> tuple[str, Any]: ...
    ...
    def _build_order_by_statement(self, order_by: list[OrderBy] | None, *, is_internal_table: bool = False, use_internal_meta_tables: bool = False) -> str: ...
    @classmethod
