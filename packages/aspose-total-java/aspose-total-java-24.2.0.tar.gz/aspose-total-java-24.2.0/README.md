...
# [Aspose.BarCode for Python via Java](https://releases.aspose.com/barcode/python-java/) (24.2.0)
...
```python
pip install aspose-barcode-for-python-via-java==24.2.0
```

# [Aspose.Cells for Python via Java](https://releases.aspose.com/cells/python-java/) (24.2.0)
...
```python
pip install aspose-cells==24.2.0
```

# [Aspose.Diagram for Python via Java](https://releases.aspose.com/diagram/python-java/) (24.2.0)
...
```python
pip install aspose-diagram==24.2.0
```

# [Aspose.OCR for Python via Java](https://releases.aspose.com/ocr/python-java/) (24.2.0)
...
```python
pip install aspose-ocr-python-java==24.2.0
```
