...
class Weather:
    ...
    Attributes:
        ...
        data (dict): JSON data containing weather information.
        latitude (float): The latitude of the location.
        longitude (float): The longitude of the location.
        forecast_url (str): URL for accessing weather forecast information if available.
        weather_details (dict): Detailed weather information for the location if available.
    """
    ...
    def _load_json_data(self) -> dict:
        ...
        """
        with open("data/2022_gazetteer_zcta_national.json", "r") as json_file:
