...
class PrrteSystem(MCASystemModule):
    ...
    def _set_system_topology(self, topo_graph):
        ...
        # Start PRRTE
        v_print("Running os.system("+"prte --report-pid "+filename+" --daemonize --mca ras timex --host "+hosts+")", 3, self.verbosity)
        os.system("prte --report-pid "+filename+" --daemonize --mca ras timex --host "+hosts)
        start = time.time()
