...
class Discrete_Steepest_Ascend(MCAPolicyModule):
    ...
    def eval_policy_function(self, system: MCASystemModule):
        ...
        while True:
            ...
            setops_data[best_setop_index]["gain"] = best_gain
        ...
        while True:
            ...
            setops_data[best_setop_index_sub]["gain"] = best_gain_sub
            ...
            setops_data[best_setop_index_add]["gain"] = best_gain_add
