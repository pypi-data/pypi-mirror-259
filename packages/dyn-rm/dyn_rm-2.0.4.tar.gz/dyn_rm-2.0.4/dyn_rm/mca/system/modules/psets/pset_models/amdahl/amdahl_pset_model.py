...
class AmdahlPsetModel(MCAPSetModelModule):
    ...
    def eval_state_speedup_function(self, num_procs) -> list:
        ...
        return (self.params["t_p"] + self.params["t_s"]) / (self.params["t_s"] + self.params["t_p"] / num_procs)
    ...
    def eval_state_gradient_speedup_function(self, num_procs):
        ...
        return (self.params["t_p"]*(self.params["t_p"] + self.params["t_s"])) / \
