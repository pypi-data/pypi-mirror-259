...
class Client(Session, Wss):
    ...
    @typing.overload
    def login(self: typing.Self, email: str, password: str, *, socket: bool = False) -> Login: ...
    @typing.overload
    def login(self: typing.Self, email: typing.Optional[str] = None, *, secret: str, socket: bool = False) -> Login: ...
    def login(
        self: typing.Self,
