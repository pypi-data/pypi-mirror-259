...
class AsyncClient(AsyncSession, AsyncWss):
    ...
    @typing.overload
    async def login(self: typing.Self, email: str, password: str, *, socket: bool = False) -> Login: ...
    @typing.overload
    async def login(self: typing.Self, email: str, *, secret: str, socket: bool = False) -> Login: ...
    async def login(
        self: typing.Self,
    ...
    async def verify_account(self, email: str, key: str, code: str) -> Json:
