...
class DocTreeMixin(treemixin.VirtualTree):
    ...
    def OnGetItemText(self, indices: Tuple[int, ...]) -> str:
        """
    ...
    def OnGetItemImage(
        self, indices: Tuple[int, ...], which=wx.TreeItemIcon_Normal, column=0
    ):
        """
