...
from .custom_types import FilesDict
...
class FileUploadData(BaseModel):
    ...
    @root_validator
    def check_url_or_content(cls, values):
        file_url, file_content = values.get('file_url'), values.get('file_content')
...
class HttpBodyFormSchema(BaseModel):
    type: Union[Literal['JSON'], Literal['Form'], Literal['File']]
    Form: Optional[list[tuple[str, str]]]
    JSON: Optional[Any]
    File: Optional[FileUploadData]
