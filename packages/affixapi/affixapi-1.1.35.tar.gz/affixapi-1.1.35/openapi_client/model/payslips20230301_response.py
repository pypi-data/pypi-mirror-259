...
def lazy_import():
    ...
    globals()['PayslipResponse'] = PayslipResponse


class Payslips20230301Response(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """Payslips20230301Response - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([PayslipResponse]):  # noqa: E501

        Keyword Args:
            value ([PayslipResponse]):  # noqa: E501
