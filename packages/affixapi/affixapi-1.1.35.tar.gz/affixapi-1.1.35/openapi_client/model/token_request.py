...
class TokenRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, client_id, client_secret, code, redirect_uri, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            grant_type (str): This is a hardcoded value required by the OAuth 2.1 spec. defaults to "authorization_code", must be one of ["authorization_code", ]  # noqa: E501
