...
def lazy_import():
    ...
    globals()['ModeResponse'] = ModeResponse
    globals()['ProviderResponse'] = ProviderResponse
    globals()['ScopesResponse'] = ScopesResponse
...
class TokenResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'mode': (ModeResponse,),  # noqa: E501
            'provider': (ProviderResponse,),  # noqa: E501
            'scopes': ([ScopesResponse],),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, access_token, mode, provider, scopes, *args, **kwargs):  # noqa: E501
        """TokenResponse - a model defined in OpenAPI

        Args:
            access_token (str): The issued access_token
            mode (ModeResponse):
            provider (ProviderResponse):
            scopes ([ScopesResponse]): One or more scope values indicating which parts of the user's account you wish to access.  Note, slight deviation from the OAuth 2.1 spec in that the param is scopes (plural) is used vs scope (singular) 

        Keyword Args:
            token_type (str): The token type to pass in the `Authorization` header. defaults to "Bearer", must be one of ["Bearer", ]  # noqa: E501
