...
def lazy_import():
    ...
    globals()['GroupNoNullEnumRequest'] = GroupNoNullEnumRequest


class GroupsNoNullEnumRequest(ModelSimple):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'value': ([GroupNoNullEnumRequest], none_type,),
        }
    ...
    def __init__(self, *args, **kwargs):
        """GroupsNoNullEnumRequest - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([GroupNoNullEnumRequest], none_type):  # noqa: E501

        Keyword Args:
            value ([GroupNoNullEnumRequest], none_type):  # noqa: E501
