...
class DisconnectResponse(ModelNormal):
    ...
    attribute_map = {
        'disconnected': 'disconnected',  # noqa: E501
    }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """DisconnectResponse - a model defined in OpenAPI

        Args:

        Keyword Args:
            disconnected (bool): The access token has been disconnected and is no longer allowed to be used by your application. defaults to True, must be one of ["true", ]  # noqa: E501
        ...
        disconnected = kwargs.get('disconnected', True)
