...
def lazy_import():
    ...
    globals()['TimeOffBalanceResponse'] = TimeOffBalanceResponse


class TimeOffBalances20230301Response(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TimeOffBalances20230301Response - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([TimeOffBalanceResponse]):  # noqa: E501

        Keyword Args:
            value ([TimeOffBalanceResponse]):  # noqa: E501
