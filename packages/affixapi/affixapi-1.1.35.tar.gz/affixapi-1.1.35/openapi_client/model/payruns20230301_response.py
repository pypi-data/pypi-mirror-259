...
def lazy_import():
    ...
    globals()['PayrunResponse'] = PayrunResponse


class Payruns20230301Response(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """Payruns20230301Response - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([PayrunResponse]):  # noqa: E501

        Keyword Args:
            value ([PayrunResponse]):  # noqa: E501
