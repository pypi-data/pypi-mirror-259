...
class CreateEmployeeRequestBankAccount(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, account_number, bank_name, bic, holder_name, iban, *args, **kwargs):  # noqa: E501
        """CreateEmployeeRequestBankAccount - a model defined in OpenAPI
