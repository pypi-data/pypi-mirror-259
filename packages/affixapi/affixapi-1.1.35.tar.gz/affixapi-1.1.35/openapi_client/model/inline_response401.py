...
class InlineResponse401(ModelNormal):
    ...
    allowed_values = {
        ...
        ('code',): {
            ...
            'REAUTHENTICATION_REQUIRED_//_COOKIES_ARE_NOW_EXPIRED': "reauthentication_required // cookies are now expired",
            'ADDITIONAL_ACCOUNT_SETUP_REQUIRED_//_PASSWORD_RESET,_ETC': "additional_account_setup_required // password reset, etc",
            'CAPTCHA_CHALLENGE_//_AMAZON_TYPE1_CAPTCHA_CHALLENGE_(CURRENTLY_UNSOVABLE)': "captcha_challenge // amazon type1 captcha challenge (currently unsovable)",
            'NO_VALID_ACCOUNTS_//_NOT_USED_CURRENTLY_BUT_RESERVED_FOR_FUTURE_USE': "no_valid_accounts // not used currently but reserved for future use",
            'INSUFFICIENT_PERMISSION_//_NOT_ENOUGH_PRIVILEGES_(IE_NOT_AN_ADMIN,_OR_NOT_ENOUGH_PROVIDER_SCOPES_ON_A_PROVIDER_API_TOKEN_FOR_THE_AFFIX_SCOPES_REQUESTED)': "insufficient_permission // not enough privileges (ie not an admin, or not enough provider scopes on a provider api token for the Affix scopes requested)",
        },
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, message, code, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            error (str): The type of error. defaults to "authentication_error", must be one of ["authentication_error", ]  # noqa: E501
        ...
        error = kwargs.get('error', "authentication_error")
