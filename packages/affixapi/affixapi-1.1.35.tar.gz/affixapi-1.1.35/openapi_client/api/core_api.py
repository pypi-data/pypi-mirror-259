    ...
    def __init__(self, api_client=None):
        ...
        def __providers(
            ...
            **kwargs
            ...
            Retrieve the api modes (official, developer) and providers for the respective modes   # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.providers(async_req=True)
            >>> result = thread.get()
