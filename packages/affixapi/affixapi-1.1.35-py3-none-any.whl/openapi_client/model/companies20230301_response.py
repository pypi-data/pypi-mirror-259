...
def lazy_import():
    ...
    globals()['CompanyResponse'] = CompanyResponse


class Companies20230301Response(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """Companies20230301Response - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([CompanyResponse]):  # noqa: E501

        Keyword Args:
            value ([CompanyResponse]):  # noqa: E501
