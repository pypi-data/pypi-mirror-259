...
class ClientResponse(ModelNormal):
    ...
    attribute_map = {
        ...
        'name': 'name',  # noqa: E501
        'webhook_uri': 'webhook_uri',  # noqa: E501
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, client_id, client_secret, redirect_uris, name, *args, **kwargs):  # noqa: E501
        """ClientResponse - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            webhook_uri (str, none_type): If enabled, webhooks will be sent to this endpoint . [optional]  # noqa: E501
        """
