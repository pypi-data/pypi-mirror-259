...
class GroupNoNullEnumRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, remote_id, name, type, *args, **kwargs):  # noqa: E501
        """GroupNoNullEnumRequest - a model defined in OpenAPI
