...
def lazy_import():
    ...
    globals()['EmployeeResponse'] = EmployeeResponse


class Employees20230301Response(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """Employees20230301Response - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([EmployeeResponse]):  # noqa: E501

        Keyword Args:
            value ([EmployeeResponse]):  # noqa: E501
