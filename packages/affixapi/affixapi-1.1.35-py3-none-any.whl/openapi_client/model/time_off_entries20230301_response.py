...
def lazy_import():
    ...
    globals()['TimeOffEntryResponse'] = TimeOffEntryResponse


class TimeOffEntries20230301Response(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """TimeOffEntries20230301Response - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([TimeOffEntryResponse]):  # noqa: E501

        Keyword Args:
            value ([TimeOffEntryResponse]):  # noqa: E501
