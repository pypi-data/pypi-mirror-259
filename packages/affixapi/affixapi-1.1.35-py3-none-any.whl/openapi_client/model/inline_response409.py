...
class InlineResponse409(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            error (str): The description of the type of error, ie conflict of two requests of the the same authorization code . defaults to "conflict", must be one of ["conflict", ]  # noqa: E501
            ...
            code (str): The authorization code insert that caused a conflict . [optional]  # noqa: E501
            token (str): The access token insert that caused a conflict . [optional]  # noqa: E501
        """

        error = kwargs.get('error', "conflict")
