...
class CreateEmployeeRequestManager(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, first_name, last_name, id, work_email, remote_id, *args, **kwargs):  # noqa: E501
        """CreateEmployeeRequestManager - a model defined in OpenAPI
