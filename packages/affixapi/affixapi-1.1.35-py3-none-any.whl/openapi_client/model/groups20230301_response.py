...
def lazy_import():
    ...
    globals()['GroupResponse'] = GroupResponse


class Groups20230301Response(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """Groups20230301Response - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([GroupResponse], none_type):  # noqa: E501

        Keyword Args:
            value ([GroupResponse], none_type):  # noqa: E501
