...
from chaiverse.lib.class_tools import get_class_properties
...
class BaseLeaderboardRow(BaseModel, extra=Extra.allow):
    ...
    def all_fields_dict(self):
        properties = get_class_properties(self.__class__)
        properties_dict = {key: getattr(self, key) for key in properties}
        all_fields_dict = {** self.dict(), **properties_dict}
