...
class base_utest(unittest.TestCase):
    ...
    def test_apply_filters(self):
        ...
        self.assertEqual(20000/2, self.fsys_client.get_data_file_metadata(Path(self.tmp_data_path, self.tmp_dataset_1)).time_range.fs)
        ...
        self.assertEqual(1.0, self.fsys_client.link_data_file(Path(self.tmp_data_path, self.tmp_dataset_1)).time_range.dur_sec)
