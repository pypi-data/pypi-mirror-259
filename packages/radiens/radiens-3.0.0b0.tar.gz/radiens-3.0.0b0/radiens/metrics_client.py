...
class MetricsClient:
    ...
    def get_params(self, dataset_metadata=None, hub_name=DEFAULT_HUB_ID) -> pd.DataFrame:
        """
    ...
    def get_metrics_status(self, dataset_metadata=None, hub_name=DEFAULT_HUB_ID) -> SignalMetricsStatus:
        """
