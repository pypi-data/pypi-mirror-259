...
class FileSystemClient(BaseClient):
    ...
    def ls(self, req_dir: any, sort_by='date', hub_name=DEFAULT_HUB) -> FileSysResponse:
        ...
        return api.dsrc_list_dir(self._server_address(hub_name, CORE_SERVICE),  pArgs, sort_by)
    ...
    def cp(self, source: any, dest: any, force=False,  hub_name=DEFAULT_HUB) -> FileSysResponse:
        """
        ...
        if src_one is not None:
            ...
            return api.dsrc_copy(self._server_address(hub_name, CORE_SERVICE), req)
    ...
    def delete_files(self, source: any, hub_name=DEFAULT_HUB) -> FileSysResponse:
        """
    ...
    def rm(self, source: any, hub_name=DEFAULT_HUB) -> FileSysResponse:
        ...
        return api.dsrc_remove(self._server_address(hub_name, CORE_SERVICE), req)
    ...
    def mv(self, source: any, dest=any, force=True, validate=True, hub_name=DEFAULT_HUB) -> FileSysResponse:
        ...
        return api.dsrc_move(self._server_address(hub_name, CORE_SERVICE), req)
