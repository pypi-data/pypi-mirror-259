...
class SpikeSorterClient():
    ...
    def initialize(self):
        ...
        """
        api.sorter_cmd(NEURONS1_ADDR, spikesorter_pb2.SORTER_CMD_INIT)
    ...
    def rebase(self):
        ...
        """
        api.sorter_cmd(NEURONS1_ADDR, spikesorter_pb2.SORTER_CMD_REBASE)
    ...
    def clear_spikes(self):
        ...
        """
        api.sorter_cmd(NEURONS1_ADDR, spikesorter_pb2.SORTER_CMD_CLEAR_SORT)
    ...
    def set_sorting(self, mode: str):
        ...
        """
        if mode in ['on']:
            api.sorter_cmd(NEURONS1_ADDR, spikesorter_pb2.SORTER_CMD_ON)
        elif mode in ['off']:
            api.sorter_cmd(NEURONS1_ADDR, spikesorter_pb2.SORTER_CMD_OFF)
        else:
    ...
    def set_threshold_level(self, neg_thr=None, pos_thr=None, scale='uV', ntv_idxs=None, weak_thr=False, channel_meta=None):
        """
    ...
    def set_spike_shadow(self, shadow_ms=None):
        ...
        return '[{} channels] shadow window: {:.2f}  ms [{} points]' .format(len(ntv_chan_idxs), cur_wdw * 1000.0, cur_pts)
