...
from radiens.grpc_radiens import (common_pb2, allegoserver_pb2, datasource_pb2)
from radiens.api.api_utils.util import (to_file_ext)
from radiens.lib.channel_metadata import (ChannelMetadata)
from radiens.utils.constants import (TIME_RANGE, SignalType)
...
class FileSetStat():
    ...
    def __init__(self, raw_msg: datasource_pb2.DataSourceFileSetStat):
        ...
        self._dset_spec = {'uid': raw_msg.datasetUID, 'checksum': raw_msg.datasetChecksum, 'provenance': []}
