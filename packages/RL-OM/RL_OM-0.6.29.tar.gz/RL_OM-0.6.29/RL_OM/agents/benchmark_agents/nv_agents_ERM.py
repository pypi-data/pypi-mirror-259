...
class RNN(nn.Module):
    def __init__(self, input_size, hidden_size, output_size, num_hidden_layers=2, drop_prob=0.0, num_time_series_features=None, lag_window=None):
        super().__init__()
...
class SGDBase(Agent):
    ...
    def __init__(self, input_size, hidden_size=64, output_size=1, learning_rate=0.01, num_hidden_layers=3, drop_prob=0.0, l2_reg=0.0, num_time_series_features=None, lag_window=None):
        if self.model_type=="Linear":
            ...
            self.model=RNN(input_size, hidden_size, output_size, num_hidden_layers=num_hidden_layers, drop_prob=drop_prob, num_time_series_features=num_time_series_features, lag_window=lag_window)
...
class RNNsgdAgent(SGDBase):
    def __init__(self,
        ...
        super().__init__(input_size=input_size, hidden_size=hidden_size, output_size=output_size, learning_rate=learning_rate, num_hidden_layers=num_hidden_layers, drop_prob=drop_prob, l2_reg=l2_reg, num_time_series_features=num_time_series_features, lag_window=lag_window)
