...
AVATARS = [
    ...
    "https://th.bing.com/th/id/OIP.sU-uj10S6p05niuTGnpkUgAAAA?rs=1&pid=ImgDetMain", 
...
with gr.Blocks() as demo:
    with gr.Tab("boobles"):
        chatbot_a = MultiChat(
            value=[], label="CustomChat", characters=entities, layout="bubble"
        )
    with gr.Tab("panels"):
        chatbot_b = MultiChat(
            value=[], label="CustomChat", characters=entities, layout="panel"
        )
    with gr.Row():
        ...
        gr.on(
            ...
            example,
            text_input,
            [text_input, chatbot_a, chatbot_b],
        )
