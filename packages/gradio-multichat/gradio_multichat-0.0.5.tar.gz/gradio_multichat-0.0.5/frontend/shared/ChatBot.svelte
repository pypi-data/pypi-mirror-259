        ...
        {#if contents.message !== null}
          <div
            class="message-row {layout} {layout === 'panel'
              ? contents.style
              : ''}"
            class:user-row={contents.origin === "user" &&
              (contents.style === null || layout === "bubble")}
            class:bot-row={contents.origin === "bot" &&
              (contents.style === null || layout === "bubble")}
          >
            ...
            <div
              class="message {contents.origin === 'user'
                ? 'user'
                : 'bot'} {contents.style}"
              ...
              style:text-align={rtl && contents.origin === "user"
                ? "left"
                : "right"}
            >
              <button
                data-testid={contents.origin === "user" ? "user" : "bot"}
              ...
              >
                ...
                {/if}
                {#if (likeable && contents.origin !== "user") || (show_copy_button && contents.message && typeof contents.message === "string")}
                  <div class="message-buttons">
                    {#if likeable && contents.origin !== "user"}
                      <LikeDislike
