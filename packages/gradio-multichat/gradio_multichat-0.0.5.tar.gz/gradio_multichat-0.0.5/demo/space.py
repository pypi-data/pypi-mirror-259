...
# style must be a css tag set on the css parameter of the gr.blocks, in this case both John and Gust has two set up to them. john-msg-template
characters = [
...
- **As input:** Is passed, a list of elements ready to deploy.
