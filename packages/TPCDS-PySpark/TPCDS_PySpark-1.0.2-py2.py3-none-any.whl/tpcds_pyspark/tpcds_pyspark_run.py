...
The tool runs with Python and PySpark, and is instrumented to collect Spark metrics with sparkMeasure
...
if __name__ == '__main__':
    ...
    if args.output_file:
        print("\n Saving the collected metrics to a local filesystem")
    ...
    if args.cluster_output_file:
        print("\n Saving the collected metrics to a cluster filesystem using Spark")
