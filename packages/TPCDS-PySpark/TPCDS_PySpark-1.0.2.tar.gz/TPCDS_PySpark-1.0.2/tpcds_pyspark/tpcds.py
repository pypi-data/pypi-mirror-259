...
class TPCDS:
    ...
    def run_TPCDS(self):
        ...
        # save the aggregated results to the object, rounded to the nearest integer
        self.aggregated_results_pdf = aggregated_results_pdf.astype('int64')
    ...
    def write_output(self, file_csv=sys.stdout, file_metadata=sys.stdout, file_grouped=sys.stdout, file_aggregated=sys.stdout):
        ...
        if file_grouped == sys.stdout:
            ...
            print("****************************************************************************************")
            print()
        self.grouped_results_pdf.to_csv(file_grouped)
        ...
        if file_grouped == sys.stdout:
            ...
            print("****************************************************************************************")
            print()
        self.aggregated_results_pdf.to_csv(file_aggregated, header=False)
