...
def fetch_vocal_separations(order="asc", page=1, per_page=10):
    """
    Fetch vocal separation inference jobs from the Arpeggi API.
    ...
    try:
        ...
        print(f"Error fetching vocal separations: {error}")
        return None
