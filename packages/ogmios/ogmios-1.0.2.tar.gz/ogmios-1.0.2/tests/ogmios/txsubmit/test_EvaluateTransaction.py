...
def test_EvaluateTransaction_empty(chain_context, test_psk, test_pvk, test_svk, test_address):
    ...
    resp = chain_context.client.evaluate_transaction.execute(signed_tx.to_cbor_hex())
    assert resp == ([], None)
