...
if __name__ == "__main__":
    # These arguments are here only for the purpose of the -h flag.
    # Another approach to do the same which was discarded was supplying -h flag all the way to gen_apidocs
    # This approach would have exposed some hidden flags like "-p" which we didn't want
