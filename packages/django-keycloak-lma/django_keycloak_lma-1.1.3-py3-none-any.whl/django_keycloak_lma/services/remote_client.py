...
from django_keycloak_lma.models import ExchangedToken
...
def exchange_token(oidc_profile, remote_client):
    ...
    :param django_keycloak_lma.models.OpenIdConnectProfile oidc_profile:
    :param django_keycloak_lma.models.RemoteClient remote_client:
    :rtype: dict
    """
    active_access_token = django_keycloak_lma.services.oidc_profile\
...
def get_active_remote_client_token(oidc_profile, remote_client):
    ...
    if exchanged_token.refresh_expires_before is None \
        ...
        exchanged_token = django_keycloak_lma.services.oidc_profile.update_tokens(
