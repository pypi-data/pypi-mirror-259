"use strict";
(self["webpackChunklab_instance_name"] = self["webpackChunklab_instance_name"] || []).push([["lib_index_js"],{
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'lab-instance-name', // API Namespace
    endPoint);
    let response;
    try {
...
const plugin = {
    ...
    description: 'A JupyterLab extension for showing the lab instance name on the statusbar.',
    autoStart: true,
    optional: [_jupyterlab_statusbar__WEBPACK_IMPORTED_MODULE_1__.IStatusBar],
    activate: async (app, statusBar) => {
        var _a;
        const serverResponse = await (0,_handler__WEBPACK_IMPORTED_MODULE_2__.requestAPI)('name');
        const labInstanceName = (_a = serverResponse.data) !== null && _a !== void 0 ? _a : '';
        if (statusBar) {
            const statusWidget = new _lumino_widgets__WEBPACK_IMPORTED_MODULE_0__.Widget();
...
//# sourceMappingURL=lib_index_js.7a2ba57c255aba3000aa.js.map