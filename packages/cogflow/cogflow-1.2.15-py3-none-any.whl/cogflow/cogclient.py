...
class Cog_Client:
    def __init__(self, tracking_uri: Optional[str] = None, registry_uri: Optional[str] = None):
        ...
        # `Cog_Client` also references a `ModelRegistryClient` instance that is provided by the
        # `Cog_Client._get_registry_client()` method. This `ModelRegistryClient` is not explicitly
        # defined as an instance variable in the `Cog_Client` constructor; an instance variable
        # is assigned lazily by `Cog_Client._get_registry_client()` and should not be referenced
        # outside of the `Cog_Client._get_registry_client()` method
    ...
    def _get_registry_client(self):
        ...
        # an instance variable on this `Cog_Client` instance. Because the instance variable
        ...
        if registry_client is None:
            try:
                ...
                # Define an instance variable on this `Cog_Client` instance to reference the
