from hi_spike.redis_client import RedisClient
import psutil
import json
import time
from nvitop import Device, GpuProcess, NA
import setproctitle
from hi_spike.utils import Logger

log = Logger(__name__)

def main():

    setproctitle.setproctitle("Redis Maintainer!!!")
    ...
    while True:
        ...
        for task in self_occupied_gpus:
            ...
            if not psutil.pid_exists(pid):
                redis_client.client.hdel("running_processes", task['task_id'])
