...
class OurUrl:
    ...
    domain_mapping = {
        ...
        'smartlink.dvlp1.circ.zone': 'https://r547khejrh.execute-api.us-east-1.amazonaws.com/dev'
    ...
    def endpoint_url(brand_name: str, environment_name: str, component_name: str, entity_name: str,
                     version: int, action_name: str, path_parameters=None, query_parameters=None) -> str:
        """
