...
class ModelsGameBinaryRecordAdminResponse(Model):
    """Models game binary record admin response (models.GameBinaryRecordAdminResponse)
    ...
    def with_key(self, value: str) -> ModelsGameBinaryRecordAdminResponse:
        self.key = value
        return self

    def with_namespace(self, value: str) -> ModelsGameBinaryRecordAdminResponse:
        self.namespace = value
        return self

    def with_updated_at(self, value: str) -> ModelsGameBinaryRecordAdminResponse:
    ...
    def create_many_from_dict(
        cls, dict_: dict, include_empty: bool = False
    ) -> Dict[str, ModelsGameBinaryRecordAdminResponse]:
        return (
    ...
    ) -> List[ModelsGameBinaryRecordAdminResponse]:
        return (
    ...
    def create_from_any(
        ...
        ModelsGameBinaryRecordAdminResponse,
        List[ModelsGameBinaryRecordAdminResponse],
        Dict[Any, ModelsGameBinaryRecordAdminResponse],
    ]:
        if many:
