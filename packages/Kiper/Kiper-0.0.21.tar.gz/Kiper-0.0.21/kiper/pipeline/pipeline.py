...
import inspect
from kiper.data.data import DataManager

import coloredlogs
from kiper.logging import logger
...
class PipelineManager:
    def __init__(self):
        ...
        """
        self.data_manager = DataManager(caller_path=self.get_caller_path())
        self.pipelines = {}
    ...
    def load_pipelines(self):
        ...
        """
        base_path = self.get_caller_path()
