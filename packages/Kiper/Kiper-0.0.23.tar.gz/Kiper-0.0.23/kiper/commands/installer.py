...
def installer(project_name, pipeline_name):
    click.echo(f"{Fore.BLUE}Welcome to Kiper, a powerful, lightweight pipeline builder!{Style.RESET_ALL}")
    ...
    click.echo(f"{Fore.BLUE}Run cd {project_name} There is an example pipeline for you :). Run kiper-new-pipe to create a new pipeline")
