...
from .parse.xpathApi import Xpath
from .parse.cssApi import Css
            ...
            try:
                ...
                if self.response.ok:
                    ...
                    if retry_xpath and retry is True:
                        ...
                        if not xpath_check:
                            raise Exception(f"Response Xpath Parse False ({self.code}) <{self.method} {self.url}>")
                ...
                if retry_time < 0 or self.Prspider.retry is False or retry is False:
                    ...
                    loguercor.log("Retry", f"Response ({self.code}) <{self.method} {self.url}>")
