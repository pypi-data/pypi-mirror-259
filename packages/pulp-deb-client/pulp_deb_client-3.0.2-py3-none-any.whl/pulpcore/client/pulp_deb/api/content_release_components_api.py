...
class ContentReleaseComponentsApi(object):
    ...
    def create(self, deb_release_component,  **kwargs):  # noqa: E501
        ...
        A ReleaseComponent represents a single APT repository component.  Associated artifacts: None; contains only metadata.  # noqa: E501
    ...
    def list(self,  **kwargs):  # noqa: E501
        ...
        :param str package:      Must be a comma-separated string: \"package_href,repository_or_repository_version_href\"     package_href: Filter results where ReleaseComponent contains Package     repository_or_repository_version_href: The RepositoryVersion href to filter by, or Repository         href (assume latest version)     
