...
from IPython.core.magic_arguments import argument, magic_arguments, parse_argstring, register_cell_magic
...
class IPythonExtension:
    ...
    def post_run_cell(self, result):
        ...
        self._last_display_pub_output = None
        self._plot_magic_args = {}
