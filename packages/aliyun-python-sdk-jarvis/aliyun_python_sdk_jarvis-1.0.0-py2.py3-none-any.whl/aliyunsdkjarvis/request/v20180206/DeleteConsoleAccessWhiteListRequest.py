...
class DeleteConsoleAccessWhiteListRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'jarvis', '2018-02-06', 'DeleteConsoleAccessWhiteList')
	...
	def get_DisableWhitelist(self): # String
		return self.get_query_params().get('DisableWhitelist')

	def set_DisableWhitelist(self, DisableWhitelist):  # String
