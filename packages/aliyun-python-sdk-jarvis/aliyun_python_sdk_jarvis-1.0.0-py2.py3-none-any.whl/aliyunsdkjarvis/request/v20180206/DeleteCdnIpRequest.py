...
class DeleteCdnIpRequest(RpcRequest):
	...
	def __init__(self):
		RpcRequest.__init__(self, 'jarvis', '2018-02-06', 'DeleteCdnIp')
	...
	def get_ItemId(self): # Integer
		return self.get_query_params().get('ItemId')

	def set_ItemId(self, ItemId):  # Integer
	...
	def get_CdnIp(self): # String
		return self.get_query_params().get('CdnIp')

	def set_CdnIp(self, CdnIp):  # String
