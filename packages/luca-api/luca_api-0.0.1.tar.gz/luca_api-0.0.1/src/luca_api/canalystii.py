...
try:
    if platform.system() == "Windows":
        CANalystII = WinDLL("/home/quyennt/lucapi/ControlCAN.dll")
        # TODO : need to confirm this on ubuntu ?
    else:
        CANalystII = CDLL("/home/quyennt/lucapi/libcontrolcan.so")
...
class CANalystIIBus(BusABC):
    ...
    def __init__(self, channel, device=0, bitrate=None, Timing0=None, Timing1=None, can_filters=None):
        ...
        # why comment out this 2 lines in base code ?
    ...
    def send(self, msg, timeout=None):
        ...
        raw_message = VCI_CAN_OBJ(msg.arbitration_id, 0, 0, 0, msg.is_remote_frame, extern_flag, msg.dlc,
                                  (c_ubyte * 8)(*msg.data), (c_byte * 3)(*[0, 0, 0]))
