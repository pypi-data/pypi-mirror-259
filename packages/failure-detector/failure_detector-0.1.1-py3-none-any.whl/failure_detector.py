...
class PhiAccrualFailureDetector:
    ...
    Args:
        ...
        mean_estimate (float): An initial estimate of the mean heartbeat
            inter-arrival time
        min_stddev (float): A lower bound on the standard-deviation of heartbeat
            inter-arrival times. The computation of the phi-value uses 
            max(min_stddev, sample stddev); this prevents the estimated 
            distribution from collapsing when e.g., all sampled heartbeats are 
            equal
