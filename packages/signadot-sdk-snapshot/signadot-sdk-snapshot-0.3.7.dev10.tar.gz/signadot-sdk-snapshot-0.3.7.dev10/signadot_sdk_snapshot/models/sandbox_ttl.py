...
class SandboxTTL(object):
    ...
    def offset_from(self):
        ...
        OffsetFrom indicates what the Duration is relative to.  It may be the empty string, \"createdAt\" or \"updatedAt\".  The empty string defaults to meaning \"createdAt\".  # noqa: E501
