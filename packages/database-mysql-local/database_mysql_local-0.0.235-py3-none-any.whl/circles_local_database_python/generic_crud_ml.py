...
class GenericCRUDML(GenericCRUD, metaclass=MetaLogger, object=LOGGER_CRUD_ML_CODE_OBJECT):
    ...
    def update_value_by_id(self, data_ml_json: dict, ml_table_id: int, table_id: int,
        ...
        if data_json:
            self.update_by_id(data_json=data_json, table_name=table_name, id_column_name=id_column_name,
                              id_column_value=table_id, limit=limit, order_by=order_by)
        ...
        self.update_by_id(data_json=data_ml_json, table_name=ml_table_name, id_column_name=id_column_name,
                          id_column_value=ml_table_id, limit=limit, order_by=order_by)
        return table_id, ml_table_id

    def upsert_value(self, data_ml_json: dict, table_id: int = None, lang_code: LangCode = None,
                     is_main: int = 0, data_json: dict = None, table_name: str = None,
        ...
        table_id = self.get_id_by_name(name=name, lang_code=lang_code, id_column_name=id_column_name, order_by=order_by)
        ml_table_id = self.get_ml_id_by_name(name=name, lang_code=lang_code, id_column_name=id_column_name,
                                             order_by=order_by)
        if not table_id:
            ...
            return self.update_value_by_id(data_ml_json=data_ml_json, ml_table_id=ml_table_id, table_id=table_id,
                                           lang_code=lang_code, is_main=is_main, data_json=data_json, table_name=table_name,
    ...
    def get_values_tuple(self, table_id: int, lang_code: LangCode = None,
        ...
        lang_code_str = self._get_lang_code_str(lang_code)
        id_column_name = GenericCRUD.generate_id_column_name(id_column_name, self.default_table_name)
    ...
    def get_ml_id_by_name(self, name: str, lang_code: LangCode = None,
        ...
        lang_code_str = self._get_lang_code_str(lang_code)
        ml_id_column_name = GenericCRUD.generate_id_column_name(id_column_name, self.default_ml_table_name)
        try:
    ...
    def _update_old_main_value_to_zero(self, table_id: int, table_name: str) -> None:
        ...
        id_column_name = GenericCRUD.generate_id_column_name(None, table_name)
