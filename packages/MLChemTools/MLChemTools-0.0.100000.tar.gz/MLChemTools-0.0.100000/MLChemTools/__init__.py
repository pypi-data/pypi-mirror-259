...
def calculate_pubchem_fingerprint(df_unique, smiles_column):
...
def cal_morgan_fingerprint(data):
    Morgan_fpts = []
    for i in data:
...
def explore_and_visualize_regression_data(csv_file_path, target_column_name):
    # Read the CSV file
    df = pd.read_csv(csv_file_path)
