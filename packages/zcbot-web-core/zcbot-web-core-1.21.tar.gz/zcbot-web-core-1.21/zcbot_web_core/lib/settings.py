...
class DynamicSettings(object):
    ...
    def __init__(self, collection: str, primary_field: str, group_field: str = None, value_field: str = None, mongo: Mongo = None, name: str = None):
        self.name = name or '配置'
    ...
    def get_value(self, key):
        ...
        if row:
            return row.get(self.value_field, None)
