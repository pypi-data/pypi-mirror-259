...
class ShapeKind(enum.Enum):
	...
	CYLINDER : ShapeKind 
	BOX : ShapeKind
	ROTATED_BOX : ShapeKind 
	TORUS : ShapeKind
	CONE : ShapeKind 
	POLYHEDRON : ShapeKind 
	SOLID : ShapeKind
	SPHERE2D : ShapeKind
	CYLINDER2D : ShapeKind
	TORUS2D : ShapeKind
	CONE2D : ShapeKind
	DISK_CIRCLE : ShapeKind
	DISK_ELLIPSE : ShapeKind
	POLYGON : ShapeKind
	PLANE : ShapeKind
	PLANAR : ShapeKind
	FACE : ShapeKind 
	CIRCLE : ShapeKind
	ARC_CIRCLE : ShapeKind
	ELLIPSE : ShapeKind
	ARC_ELLIPSE : ShapeKind
	LINE : ShapeKind
	SEGMENT : ShapeKind
	EDGE : ShapeKind
	VERTEX : ShapeKind
...
class ColourSelection(enum.Enum):
	DEFAULT : Colour
	RED : Colour
	LIME : Colour
	BLUE : Colour
...
class Palette(object):
	@staticmethod
	def get_colour(selection: ColourSelection) -> Colour: ...
	@staticmethod
	def get_specific_colour(red: int, green: int, blue: int) -> Colour: ...
	@staticmethod
	def are_same(c1: Colour, c2: Colour) -> bool: ...

class DocumentBuilder:
	def __init__(self, engine: GEOMImpl_Gen): ...
	def save_document_to(self, path: str) -> bool: ...
	...
	def add_to_document(self, geom_object: GEOM_Object, publish_under_name: str, tmp_folder_path: str) -> int: ...
	def add_to_document_under(self, geom_object: GEOM_Object, parent_id: int, publish_under_name: str, tmp_folder_path: str) -> int: ...
	...
	def remove_from_document(self, item_id: int) -> bool: ...
	def get_object_name(self, item_id: int) -> str: ...
	def get_geom_object_by_id(self, item_id: int) -> GEOM_Object: ...
	def open_new_document(self, model_name: str) -> None: ...
	def get_added_component_ids(self) -> list[int]: ...
	def set_object_colour(self, item_id: int, colour: Colour) -> bool: ...
	def get_object_colour(self, item_id: int) -> Colour: ...
...
class GeometryBasicOperations:
	...
	def make_plane_lcs(self,  the_face: GEOM_Object, the_size: float, the_orientation: i) -> GEOM_Object: ... 
...
class GeometryHealingOperations:
	...
	def get_shape_process_parameters(self,  the_operations: list,  the_params: list,  the_values: list) -> void: ... 
