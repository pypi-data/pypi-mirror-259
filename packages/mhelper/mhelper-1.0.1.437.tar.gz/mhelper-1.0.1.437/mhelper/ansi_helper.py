"""
Using a string containing ANSI colour codes is problematic in that __len__, 
[slice] etc. use the raw text, including the codes.

This class provides a class `AnsiStr`, which duck-types `str`, but accounts
for colour codes when calculating lengths and offsets.
"""
# !EXPORT_TO_README
