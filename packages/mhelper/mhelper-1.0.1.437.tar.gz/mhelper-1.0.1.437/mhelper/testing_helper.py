"""
Very simple testing framework using decorators to mark functions as part of a test suite.
"""
# !EXPORT_TO_README
import argparse
import inspect
...
class Testing:
    ...
    def IS_INSTANCE( self, expected_type ):
        assert isinstance( self.value, expected_type )
