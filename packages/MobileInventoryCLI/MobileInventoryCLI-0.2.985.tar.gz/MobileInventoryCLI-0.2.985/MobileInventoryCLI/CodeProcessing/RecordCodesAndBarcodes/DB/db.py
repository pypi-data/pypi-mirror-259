...
class Entry(BASE):
    ...
    def __init__(self,Barcode,Code,upce2upca='',Name='',InList=False,Price=0.0,Note='',Size='',CaseCount=0,Shelf=0,BackRoom=0,Display_1=0,Display_2=0,Display_3=0,Display_4=0,Display_5=0,Display_6=0,Stock_Total=0,Timestamp=datetime.now().timestamp(),EntryId=None,Location='///',ListQty=0.0,Image=''):
        ...
        self.Image=Image
        #proposed fields
        #smle,s|search|? - calls a prompt to search for InList==True with CODE|BARCODE instead of direct search waits for b for back, q for quit, for next CODE|BARCODE
        #callable from ExtendedOptionsClass which will be accessed from Unified with ?e|e?
        #optional fields
        #self.alt_barcode
        #self.duplicate_code
