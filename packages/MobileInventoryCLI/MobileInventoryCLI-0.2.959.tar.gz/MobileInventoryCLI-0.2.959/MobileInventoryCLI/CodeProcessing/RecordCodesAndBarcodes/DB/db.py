...
class Entry(BASE):
    ...
    def save_code(self):
    	...
    	try:
    		...
    		for code in codes:
    			try:
    				if code == QRCode:
    					code(self.Code).make_image().save(filename)
    					break
    				else:
    					code(self.Code,writer=ImageWriter()).write(filename)
    					break
    				pass
    			except Exception as e:
    				print(e)
    ...
    def save_barcode(self):
    	...
    	try:
    		...
    		for code in codes:
    			try:
    				if code == QRCode:
    					code(self.Barcode,version=50).make_image().save(filename)
    					break
    				else:
    ...
    def saveItemData(self,num=None):
        ...
        renderImageFromText(fname,data)
