...
from MobileInventoryCLI.CodeProcessing.RecordCodesAndBarcodes.RecordMyCodes import Main 
import random
...
class TasksMode:
    ...
    def __init__(self,engine,parent):
        ...
        while True:
            ...
            if self.parent != None and Main.Unified(self.parent,line=command.lower()):
