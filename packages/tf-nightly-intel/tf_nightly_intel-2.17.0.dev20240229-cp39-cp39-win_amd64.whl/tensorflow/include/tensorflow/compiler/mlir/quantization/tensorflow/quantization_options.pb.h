...
struct DebuggerOptionsDefaultTypeInternal;
extern DebuggerOptionsDefaultTypeInternal _DebuggerOptions_default_instance_;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::tensorflow::quantization::CalibrationOptions* Arena::CreateMaybeMessage<::tensorflow::quantization::CalibrationOptions>(Arena*);
template<> ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* Arena::CreateMaybeMessage<::tensorflow::quantization::CalibrationOptions_CalibrationParameters>(Arena*);
template<> ::tensorflow::quantization::DebuggerOptions* Arena::CreateMaybeMessage<::tensorflow::quantization::DebuggerOptions>(Arena*);
...
class CalibrationOptions_CalibrationParameters final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.quantization.CalibrationOptions.CalibrationParameters) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.quantization.CalibrationOptions.CalibrationParameters";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:tensorflow.quantization.CalibrationOptions.CalibrationParameters)
 private:
  class _Internal;
...
class CalibrationOptions final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.quantization.CalibrationOptions) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.quantization.CalibrationOptions";
  }
  protected:
  ...
  // .tensorflow.quantization.CalibrationOptions.CalibrationParameters calibration_parameters = 2;
  bool has_calibration_parameters() const;
  private:
  bool _internal_has_calibration_parameters() const;
  public:
  void clear_calibration_parameters();
  const ::tensorflow::quantization::CalibrationOptions_CalibrationParameters& calibration_parameters() const;
  PROTOBUF_NODISCARD ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* release_calibration_parameters();
  ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* mutable_calibration_parameters();
  void set_allocated_calibration_parameters(::tensorflow::quantization::CalibrationOptions_CalibrationParameters* calibration_parameters);
  private:
  const ::tensorflow::quantization::CalibrationOptions_CalibrationParameters& _internal_calibration_parameters() const;
  ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* _internal_mutable_calibration_parameters();
  public:
  void unsafe_arena_set_allocated_calibration_parameters(
      ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* calibration_parameters);
  ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* unsafe_arena_release_calibration_parameters();

  // .tensorflow.quantization.CalibrationOptions.CalibrationMethod calibration_method = 1;
  void clear_calibration_method();
  ::tensorflow::quantization::CalibrationOptions_CalibrationMethod calibration_method() const;
  void set_calibration_method(::tensorflow::quantization::CalibrationOptions_CalibrationMethod value);
  private:
  ::tensorflow::quantization::CalibrationOptions_CalibrationMethod _internal_calibration_method() const;
  void _internal_set_calibration_method(::tensorflow::quantization::CalibrationOptions_CalibrationMethod value);
  public:

  // @@protoc_insertion_point(class_scope:tensorflow.quantization.CalibrationOptions)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* calibration_parameters_;
...
class DebuggerOptions final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.quantization.DebuggerOptions) */ {
 public:
  inline DebuggerOptions() : DebuggerOptions(nullptr) {}
  ~DebuggerOptions() override;
  explicit PROTOBUF_CONSTEXPR DebuggerOptions(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  DebuggerOptions(const DebuggerOptions& from);
  DebuggerOptions(DebuggerOptions&& from) noexcept
    : DebuggerOptions() {
    *this = ::std::move(from);
  }

  inline DebuggerOptions& operator=(const DebuggerOptions& from) {
    CopyFrom(from);
    return *this;
  }
  inline DebuggerOptions& operator=(DebuggerOptions&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const DebuggerOptions& default_instance() {
    return *internal_default_instance();
  }
  static inline const DebuggerOptions* internal_default_instance() {
    return reinterpret_cast<const DebuggerOptions*>(
               &_DebuggerOptions_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    9;

  friend void swap(DebuggerOptions& a, DebuggerOptions& b) {
    a.Swap(&b);
  }
  inline void Swap(DebuggerOptions* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(DebuggerOptions* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  DebuggerOptions* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<DebuggerOptions>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const DebuggerOptions& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const DebuggerOptions& from) {
    DebuggerOptions::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DebuggerOptions* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.quantization.DebuggerOptions";
  }
  protected:
  explicit DebuggerOptions(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:tensorflow.quantization.DebuggerOptions)
 private:
  class _Internal;
...
class QuantizationOptions final :
 ...
 public:
  ...
  enum : int {
    ...
    kDebuggerOptionsFieldNumber = 16,
  ...
  // .tensorflow.quantization.CalibrationOptions calibration_options = 15;
  bool has_calibration_options() const;
  private:
  bool _internal_has_calibration_options() const;
  public:
  void clear_calibration_options();
  const ::tensorflow::quantization::CalibrationOptions& calibration_options() const;
  PROTOBUF_NODISCARD ::tensorflow::quantization::CalibrationOptions* release_calibration_options();
  ::tensorflow::quantization::CalibrationOptions* mutable_calibration_options();
  void set_allocated_calibration_options(::tensorflow::quantization::CalibrationOptions* calibration_options);
  private:
  const ::tensorflow::quantization::CalibrationOptions& _internal_calibration_options() const;
  ::tensorflow::quantization::CalibrationOptions* _internal_mutable_calibration_options();
  public:
  void unsafe_arena_set_allocated_calibration_options(
      ::tensorflow::quantization::CalibrationOptions* calibration_options);
  ::tensorflow::quantization::CalibrationOptions* unsafe_arena_release_calibration_options();

  // .tensorflow.quantization.DebuggerOptions debugger_options = 16;
  bool has_debugger_options() const;
  private:
  bool _internal_has_debugger_options() const;
  public:
  void clear_debugger_options();
  const ::tensorflow::quantization::DebuggerOptions& debugger_options() const;
  PROTOBUF_NODISCARD ::tensorflow::quantization::DebuggerOptions* release_debugger_options();
  ::tensorflow::quantization::DebuggerOptions* mutable_debugger_options();
  void set_allocated_debugger_options(::tensorflow::quantization::DebuggerOptions* debugger_options);
  private:
  const ::tensorflow::quantization::DebuggerOptions& _internal_debugger_options() const;
  ::tensorflow::quantization::DebuggerOptions* _internal_mutable_debugger_options();
  public:
  void unsafe_arena_set_allocated_debugger_options(
      ::tensorflow::quantization::DebuggerOptions* debugger_options);
  ::tensorflow::quantization::DebuggerOptions* unsafe_arena_release_debugger_options();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::tensorflow::quantization::DebuggerOptions* debugger_options_;
...
inline int32_t CalibrationOptions_CalibrationParameters::initial_num_bins() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.CalibrationOptions.CalibrationParameters.initial_num_bins)
...
inline void CalibrationOptions_CalibrationParameters::set_initial_num_bins(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:tensorflow.quantization.CalibrationOptions.CalibrationParameters.initial_num_bins)
}
...
inline float CalibrationOptions_CalibrationParameters::min_percentile() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.CalibrationOptions.CalibrationParameters.min_percentile)
...
inline void CalibrationOptions_CalibrationParameters::set_min_percentile(float value) {
  ...
  // @@protoc_insertion_point(field_set:tensorflow.quantization.CalibrationOptions.CalibrationParameters.min_percentile)
}
...
inline float CalibrationOptions_CalibrationParameters::max_percentile() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.CalibrationOptions.CalibrationParameters.max_percentile)
...
inline void CalibrationOptions_CalibrationParameters::set_max_percentile(float value) {
  ...
  // @@protoc_insertion_point(field_set:tensorflow.quantization.CalibrationOptions.CalibrationParameters.max_percentile)
}
...
inline ::tensorflow::quantization::CalibrationOptions_CalibrationMethod CalibrationOptions::_internal_calibration_method() const {
  return static_cast< ::tensorflow::quantization::CalibrationOptions_CalibrationMethod >(_impl_.calibration_method_);
}
inline ::tensorflow::quantization::CalibrationOptions_CalibrationMethod CalibrationOptions::calibration_method() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.CalibrationOptions.calibration_method)
  return _internal_calibration_method();
}
inline void CalibrationOptions::_internal_set_calibration_method(::tensorflow::quantization::CalibrationOptions_CalibrationMethod value) {
  
  _impl_.calibration_method_ = value;
}
inline void CalibrationOptions::set_calibration_method(::tensorflow::quantization::CalibrationOptions_CalibrationMethod value) {
  _internal_set_calibration_method(value);
  // @@protoc_insertion_point(field_set:tensorflow.quantization.CalibrationOptions.calibration_method)
}
...
inline const ::tensorflow::quantization::CalibrationOptions_CalibrationParameters& CalibrationOptions::_internal_calibration_parameters() const {
  const ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* p = _impl_.calibration_parameters_;
  return p != nullptr ? *p : reinterpret_cast<const ::tensorflow::quantization::CalibrationOptions_CalibrationParameters&>(
      ::tensorflow::quantization::_CalibrationOptions_CalibrationParameters_default_instance_);
}
inline const ::tensorflow::quantization::CalibrationOptions_CalibrationParameters& CalibrationOptions::calibration_parameters() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.CalibrationOptions.calibration_parameters)
...
inline void CalibrationOptions::unsafe_arena_set_allocated_calibration_parameters(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:tensorflow.quantization.CalibrationOptions.calibration_parameters)
}
inline ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* CalibrationOptions::release_calibration_parameters() {
  
  ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* temp = _impl_.calibration_parameters_;
  _impl_.calibration_parameters_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* CalibrationOptions::unsafe_arena_release_calibration_parameters() {
  // @@protoc_insertion_point(field_release:tensorflow.quantization.CalibrationOptions.calibration_parameters)
  
  ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* temp = _impl_.calibration_parameters_;
  _impl_.calibration_parameters_ = nullptr;
  return temp;
}
inline ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* CalibrationOptions::_internal_mutable_calibration_parameters() {
  
  if (_impl_.calibration_parameters_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::quantization::CalibrationOptions_CalibrationParameters>(GetArenaForAllocation());
    _impl_.calibration_parameters_ = p;
  }
  return _impl_.calibration_parameters_;
}
inline ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* CalibrationOptions::mutable_calibration_parameters() {
  ::tensorflow::quantization::CalibrationOptions_CalibrationParameters* _msg = _internal_mutable_calibration_parameters();
  // @@protoc_insertion_point(field_mutable:tensorflow.quantization.CalibrationOptions.calibration_parameters)
  return _msg;
}
inline void CalibrationOptions::set_allocated_calibration_parameters(::tensorflow::quantization::CalibrationOptions_CalibrationParameters* calibration_parameters) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.calibration_parameters_;
  }
  ...
  _impl_.calibration_parameters_ = calibration_parameters;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.quantization.CalibrationOptions.calibration_parameters)
}
...
// .stablehlo.quantization.DebuggerConfig.DebuggerType debugger_type = 1;
inline void DebuggerOptions::clear_debugger_type() {
  _impl_.debugger_type_ = 0;
}
inline ::stablehlo::quantization::DebuggerConfig_DebuggerType DebuggerOptions::_internal_debugger_type() const {
  return static_cast< ::stablehlo::quantization::DebuggerConfig_DebuggerType >(_impl_.debugger_type_);
}
inline ::stablehlo::quantization::DebuggerConfig_DebuggerType DebuggerOptions::debugger_type() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.DebuggerOptions.debugger_type)
  return _internal_debugger_type();
}
inline void DebuggerOptions::_internal_set_debugger_type(::stablehlo::quantization::DebuggerConfig_DebuggerType value) {
  
  _impl_.debugger_type_ = value;
}
inline void DebuggerOptions::set_debugger_type(::stablehlo::quantization::DebuggerConfig_DebuggerType value) {
  _internal_set_debugger_type(value);
  // @@protoc_insertion_point(field_set:tensorflow.quantization.DebuggerOptions.debugger_type)
}

// string unquantized_dump_model_path = 2;
inline void DebuggerOptions::clear_unquantized_dump_model_path() {
  _impl_.unquantized_dump_model_path_.ClearToEmpty();
}
inline const std::string& DebuggerOptions::unquantized_dump_model_path() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.DebuggerOptions.unquantized_dump_model_path)
  return _internal_unquantized_dump_model_path();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DebuggerOptions::set_unquantized_dump_model_path(ArgT0&& arg0, ArgT... args) {
 
 _impl_.unquantized_dump_model_path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:tensorflow.quantization.DebuggerOptions.unquantized_dump_model_path)
}
inline std::string* DebuggerOptions::mutable_unquantized_dump_model_path() {
  std::string* _s = _internal_mutable_unquantized_dump_model_path();
  // @@protoc_insertion_point(field_mutable:tensorflow.quantization.DebuggerOptions.unquantized_dump_model_path)
  return _s;
}
inline const std::string& DebuggerOptions::_internal_unquantized_dump_model_path() const {
  return _impl_.unquantized_dump_model_path_.Get();
}
inline void DebuggerOptions::_internal_set_unquantized_dump_model_path(const std::string& value) {
  
  _impl_.unquantized_dump_model_path_.Set(value, GetArenaForAllocation());
}
inline std::string* DebuggerOptions::_internal_mutable_unquantized_dump_model_path() {
  
  return _impl_.unquantized_dump_model_path_.Mutable(GetArenaForAllocation());
}
inline std::string* DebuggerOptions::release_unquantized_dump_model_path() {
  // @@protoc_insertion_point(field_release:tensorflow.quantization.DebuggerOptions.unquantized_dump_model_path)
  return _impl_.unquantized_dump_model_path_.Release();
}
inline void DebuggerOptions::set_allocated_unquantized_dump_model_path(std::string* unquantized_dump_model_path) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:tensorflow.quantization.DebuggerOptions.unquantized_dump_model_path)
}

// string log_dir_path = 3;
inline void DebuggerOptions::clear_log_dir_path() {
  _impl_.log_dir_path_.ClearToEmpty();
}
inline const std::string& DebuggerOptions::log_dir_path() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.DebuggerOptions.log_dir_path)
  return _internal_log_dir_path();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void DebuggerOptions::set_log_dir_path(ArgT0&& arg0, ArgT... args) {
 
 _impl_.log_dir_path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:tensorflow.quantization.DebuggerOptions.log_dir_path)
}
inline std::string* DebuggerOptions::mutable_log_dir_path() {
  std::string* _s = _internal_mutable_log_dir_path();
  // @@protoc_insertion_point(field_mutable:tensorflow.quantization.DebuggerOptions.log_dir_path)
  return _s;
}
inline const std::string& DebuggerOptions::_internal_log_dir_path() const {
  return _impl_.log_dir_path_.Get();
}
inline void DebuggerOptions::_internal_set_log_dir_path(const std::string& value) {
  
  _impl_.log_dir_path_.Set(value, GetArenaForAllocation());
}
inline std::string* DebuggerOptions::_internal_mutable_log_dir_path() {
  
  return _impl_.log_dir_path_.Mutable(GetArenaForAllocation());
}
inline std::string* DebuggerOptions::release_log_dir_path() {
  // @@protoc_insertion_point(field_release:tensorflow.quantization.DebuggerOptions.log_dir_path)
  return _impl_.log_dir_path_.Release();
}
inline void DebuggerOptions::set_allocated_log_dir_path(std::string* log_dir_path) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:tensorflow.quantization.DebuggerOptions.log_dir_path)
}
...
inline void QuantizationOptions::clear_calibration_options() {
...
inline const ::tensorflow::quantization::CalibrationOptions& QuantizationOptions::_internal_calibration_options() const {
  const ::tensorflow::quantization::CalibrationOptions* p = _impl_.calibration_options_;
  return p != nullptr ? *p : reinterpret_cast<const ::tensorflow::quantization::CalibrationOptions&>(
      ::tensorflow::quantization::_CalibrationOptions_default_instance_);
}
inline const ::tensorflow::quantization::CalibrationOptions& QuantizationOptions::calibration_options() const {
...
inline ::tensorflow::quantization::CalibrationOptions* QuantizationOptions::release_calibration_options() {
  
  ::tensorflow::quantization::CalibrationOptions* temp = _impl_.calibration_options_;
  _impl_.calibration_options_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::tensorflow::quantization::CalibrationOptions* QuantizationOptions::unsafe_arena_release_calibration_options() {
...
inline ::tensorflow::quantization::CalibrationOptions* QuantizationOptions::_internal_mutable_calibration_options() {
  
  if (_impl_.calibration_options_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::quantization::CalibrationOptions>(GetArenaForAllocation());
    _impl_.calibration_options_ = p;
  }
  return _impl_.calibration_options_;
}
inline ::tensorflow::quantization::CalibrationOptions* QuantizationOptions::mutable_calibration_options() {
  ::tensorflow::quantization::CalibrationOptions* _msg = _internal_mutable_calibration_options();
  // @@protoc_insertion_point(field_mutable:tensorflow.quantization.QuantizationOptions.calibration_options)
  return _msg;
}
inline void QuantizationOptions::set_allocated_calibration_options(::tensorflow::quantization::CalibrationOptions* calibration_options) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.calibration_options_;
  }
...
// .tensorflow.quantization.DebuggerOptions debugger_options = 16;
inline bool QuantizationOptions::_internal_has_debugger_options() const {
  return this != internal_default_instance() && _impl_.debugger_options_ != nullptr;
}
inline bool QuantizationOptions::has_debugger_options() const {
  return _internal_has_debugger_options();
}
inline void QuantizationOptions::clear_debugger_options() {
  if (GetArenaForAllocation() == nullptr && _impl_.debugger_options_ != nullptr) {
    delete _impl_.debugger_options_;
  }
  _impl_.debugger_options_ = nullptr;
}
inline const ::tensorflow::quantization::DebuggerOptions& QuantizationOptions::_internal_debugger_options() const {
  const ::tensorflow::quantization::DebuggerOptions* p = _impl_.debugger_options_;
  return p != nullptr ? *p : reinterpret_cast<const ::tensorflow::quantization::DebuggerOptions&>(
      ::tensorflow::quantization::_DebuggerOptions_default_instance_);
}
inline const ::tensorflow::quantization::DebuggerOptions& QuantizationOptions::debugger_options() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.QuantizationOptions.debugger_options)
  return _internal_debugger_options();
}
inline void QuantizationOptions::unsafe_arena_set_allocated_debugger_options(
    ::tensorflow::quantization::DebuggerOptions* debugger_options) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.debugger_options_);
  }
  _impl_.debugger_options_ = debugger_options;
  if (debugger_options) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:tensorflow.quantization.QuantizationOptions.debugger_options)
}
inline ::tensorflow::quantization::DebuggerOptions* QuantizationOptions::release_debugger_options() {
  
  ::tensorflow::quantization::DebuggerOptions* temp = _impl_.debugger_options_;
  _impl_.debugger_options_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::tensorflow::quantization::DebuggerOptions* QuantizationOptions::unsafe_arena_release_debugger_options() {
  // @@protoc_insertion_point(field_release:tensorflow.quantization.QuantizationOptions.debugger_options)
  
  ::tensorflow::quantization::DebuggerOptions* temp = _impl_.debugger_options_;
  _impl_.debugger_options_ = nullptr;
  return temp;
}
inline ::tensorflow::quantization::DebuggerOptions* QuantizationOptions::_internal_mutable_debugger_options() {
  
  if (_impl_.debugger_options_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::quantization::DebuggerOptions>(GetArenaForAllocation());
    _impl_.debugger_options_ = p;
  }
  return _impl_.debugger_options_;
}
inline ::tensorflow::quantization::DebuggerOptions* QuantizationOptions::mutable_debugger_options() {
  ::tensorflow::quantization::DebuggerOptions* _msg = _internal_mutable_debugger_options();
  // @@protoc_insertion_point(field_mutable:tensorflow.quantization.QuantizationOptions.debugger_options)
  return _msg;
}
inline void QuantizationOptions::set_allocated_debugger_options(::tensorflow::quantization::DebuggerOptions* debugger_options) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.debugger_options_;
  }
  if (debugger_options) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(debugger_options);
    if (message_arena != submessage_arena) {
      debugger_options = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, debugger_options, submessage_arena);
    }
  ...
  _impl_.debugger_options_ = debugger_options;
  // @@protoc_insertion_point(field_set_allocated:tensorflow.quantization.QuantizationOptions.debugger_options)
}
...
template <> struct is_proto_enum< ::tensorflow::quantization::CalibrationOptions_CalibrationMethod> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tensorflow::quantization::CalibrationOptions_CalibrationMethod>() {
  return ::tensorflow::quantization::CalibrationOptions_CalibrationMethod_descriptor();
}
