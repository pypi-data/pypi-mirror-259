...
class BarplotSeries(BaseSeries):
    def __init__(self, x, y, xticks, label="", width: Union[float, Iterable] = 0.8, **kwargs):
        super().__init__(**kwargs)
...
def boxplot(data, groups=None, label="", **kwargs):
    """
...
def plot_sum(data, groups=None, label="", **kwargs):
    """
