...
class PrimiPlotterBase:
    ...
    def set_color_function(self, colors):
        ...
        if isinstance(colors, collections.abc.Callable):
    ...
    def set_invisibility_function(self, invfunc):
        ...
        if isinstance(invfunc, collections.abc.Callable):
    ...
    def _stoptimer(self):
        ...
        print("plotting time {} sec (total {} sec)".format(elapsedtime,
                                                       self.totaltime))
...
class PrimiPlotter(PrimiPlotterBase):
    ...
    def _computevisibility(self, coords, rad, invisible, id, zoom = 1):
        ...
        if typradius < 4.0:
            ...
            self.log(f"Visibility(r_typ = {typradius:.1f} pixels)")
