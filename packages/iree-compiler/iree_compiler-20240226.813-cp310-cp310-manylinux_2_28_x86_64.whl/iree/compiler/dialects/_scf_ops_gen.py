...
def execute_region(result, *, loc=None, ip=None) -> _SubClassValueT:
...
def for_(results_, lower_bound, upper_bound, step, init_args, *, loc=None, ip=None) -> _SubClassValueT:
...
class ForallOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, dynamicLowerBound, dynamicUpperBound, dynamicStep, staticLowerBound, staticUpperBound, staticStep, outputs, *, mapping=None, loc=None, ip=None):
    ...
    issubclass(type(staticLowerBound), _ods_ir.Attribute) or
...
def forall(results_, dynamic_lower_bound, dynamic_upper_bound, dynamic_step, static_lower_bound, static_upper_bound, static_step, outputs, *, mapping=None, loc=None, ip=None) -> _SubClassValueT:
...
def if_(results_, condition, *, loc=None, ip=None) -> _SubClassValueT:
...
def index_switch(results_, arg, cases, num_case_regions, *, loc=None, ip=None) -> _SubClassValueT:
...
def parallel(results_, lower_bound, upper_bound, step, init_vals, *, loc=None, ip=None) -> _SubClassValueT:
...
def while_(results_, inits, *, loc=None, ip=None) -> _SubClassValueT:
