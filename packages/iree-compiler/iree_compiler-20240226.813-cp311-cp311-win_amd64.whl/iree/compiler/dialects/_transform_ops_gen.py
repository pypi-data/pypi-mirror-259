...
class CollectMatchingOp(_ods_ir.OpView):
  ...
  def __init__(self, results_, root, matcher, *, loc=None, ip=None):
    ...
    issubclass(type(matcher), _ods_ir.Attribute) or
...
def collect_matching(results_, root, matcher, *, loc=None, ip=None) -> _SubClassValueT:
...
class GetOperandOp(_ods_ir.OpView):
  ...
  def __init__(self, result, target, raw_position_list, *, is_inverted=None, is_all=None, loc=None, ip=None):
    ...
    issubclass(type(raw_position_list), _ods_ir.Attribute) or
...
def get_operand(result, target, raw_position_list, *, is_inverted=None, is_all=None, loc=None, ip=None) -> _SubClassValueT:
...
def get_result(result, target, raw_position_list, *, is_inverted=None, is_all=None, loc=None, ip=None) -> _SubClassValueT:
...
def num_associations(num, handle, *, loc=None, ip=None) -> _SubClassValueT:
