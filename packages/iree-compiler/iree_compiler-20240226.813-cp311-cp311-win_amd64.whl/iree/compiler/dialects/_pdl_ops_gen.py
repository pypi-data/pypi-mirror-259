...
class ApplyNativeConstraintOp(_ods_ir.OpView):
  ...
  def __init__(self, name, args, *, isNegated=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if isNegated is not None: attributes["isNegated"] = (isNegated if (
        issubclass(type(isNegated), _ods_ir.Attribute) or
...
def apply_native_constraint(name, args, *, is_negated=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyNativeConstraintOp(name=name, args=args, isNegated=is_negated, loc=loc, ip=ip))
...
def apply_native_rewrite(results_, name, args, *, loc=None, ip=None) -> _SubClassValueT:
...
def attribute(attr, *, value_type=None, value=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AttributeOp(attr=attr, valueType=value_type, value=value, loc=loc, ip=ip))
...
def erase(op_value, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(EraseOp(opValue=op_value, loc=loc, ip=ip))
...
def operand(value, *, value_type=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(OperandOp(value=value, valueType=value_type, loc=loc, ip=ip))
...
def operands_(value, *, value_type=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(OperandsOp(value=value, valueType=value_type, loc=loc, ip=ip))
...
def operation_(op, operand_values, attribute_values, attribute_value_names, type_values, *, op_name=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(OperationOp(op=op, operandValues=operand_values, attributeValues=attribute_values, attributeValueNames=attribute_value_names, typeValues=type_values, opName=op_name, loc=loc, ip=ip))
...
def pattern(benefit, *, sym_name=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(PatternOp(benefit=benefit, sym_name=sym_name, loc=loc, ip=ip))
...
def range(result, arguments, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(RangeOp(result=result, arguments=arguments, loc=loc, ip=ip))
...
def replace(op_value, repl_values, *, repl_operation=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ReplaceOp(opValue=op_value, replValues=repl_values, replOperation=repl_operation, loc=loc, ip=ip))
...
def result(val, parent, index, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ResultOp(val=val, parent=parent, index=index, loc=loc, ip=ip))
...
def results_(val, parent, *, index=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ResultsOp(val=val, parent=parent, index=index, loc=loc, ip=ip))
...
def rewrite(external_args, *, root=None, name=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(RewriteOp(externalArgs=external_args, root=root, name=name, loc=loc, ip=ip))
...
def type_(result, *, constant_type=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TypeOp(result=result, constantType=constant_type, loc=loc, ip=ip))
...
def types(result, *, constant_types=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TypesOp(result=result, constantTypes=constant_types, loc=loc, ip=ip))
