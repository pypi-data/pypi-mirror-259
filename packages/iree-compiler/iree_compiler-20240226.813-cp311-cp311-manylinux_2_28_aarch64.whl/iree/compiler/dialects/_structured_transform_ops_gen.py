...
def structured_convert_to_loops(target, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ConvertToLoopsOp(target=target, loc=loc, ip=ip))
  ...
  def __init__(self, padded, pad, copy, target, *, padding_values=None, padding_dimensions=None, pad_to_multiple_of=None, pack_paddings=None, transpose_paddings=None, copy_back_op=None, loc=None, ip=None):
    ...
    if transpose_paddings is not None: attributes["transpose_paddings"] = (transpose_paddings if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_463')) else
          _ods_ir.AttrBuilder.get('anonymous_463')(transpose_paddings, context=_ods_context))
