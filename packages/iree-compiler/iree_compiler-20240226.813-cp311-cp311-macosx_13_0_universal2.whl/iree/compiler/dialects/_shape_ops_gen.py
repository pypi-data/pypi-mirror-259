...
def any(result, inputs, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AnyOp(result=result, inputs=inputs, loc=loc, ip=ip))
...
def assuming_all(inputs, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(AssumingAllOp(inputs=inputs, loc=loc, ip=ip))
...
def assuming(results_, witness, *, loc=None, ip=None) -> _SubClassValueT:
...
def assuming_yield(operands_, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(AssumingYieldOp(operands_=operands_, loc=loc, ip=ip))
...
def broadcast(result, shapes, *, error=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BroadcastOp(result=result, shapes=shapes, error=error, loc=loc, ip=ip))
...
def concat(result, lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ConcatOp(result=result, lhs=lhs, rhs=rhs, loc=loc, ip=ip))
...
def const_shape(shape, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ConstShapeOp(shape=shape, loc=loc, ip=ip))
...
def const_size(value, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ConstSizeOp(value=value, loc=loc, ip=ip))
...
def const_witness(passing, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ConstWitnessOp(passing=passing, loc=loc, ip=ip))
...
def cstr_broadcastable(shapes, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CstrBroadcastableOp(shapes=shapes, loc=loc, ip=ip))
...
def cstr_eq(shapes, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CstrEqOp(shapes=shapes, loc=loc, ip=ip))
...
def cstr_require(pred, msg, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(CstrRequireOp(pred=pred, msg=msg, loc=loc, ip=ip))
...
def debug_print(output, input, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DebugPrintOp(output=output, input=input, loc=loc, ip=ip))
...
def dim(value, index, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(DimOp(value=value, index=index, loc=loc, ip=ip))
...
def div(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def from_extent_tensor(input, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FromExtentTensorOp(input=input, loc=loc, ip=ip))
...
def from_extents(extents, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(FromExtentsOp(extents=extents, loc=loc, ip=ip))
...
class FuncOp(_ods_ir.OpView):
  ...
  def __init__(self, sym_name, function_type, *, arg_attrs=None, res_attrs=None, sym_visibility=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_442')) else
      _ods_ir.AttrBuilder.get('anonymous_442')(function_type, context=_ods_context))
...
def func(sym_name, function_type, *, arg_attrs=None, res_attrs=None, sym_visibility=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FuncOp(sym_name=sym_name, function_type=function_type, arg_attrs=arg_attrs, res_attrs=res_attrs, sym_visibility=sym_visibility, loc=loc, ip=ip))
...
def function_library(sym_name, mapping, *, sym_visibility=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(FunctionLibraryOp(sym_name=sym_name, mapping=mapping, sym_visibility=sym_visibility, loc=loc, ip=ip))
...
def get_extent(shape, dim, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(GetExtentOp(shape=shape, dim=dim, loc=loc, ip=ip))
...
def index_to_size(arg, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(IndexToSizeOp(arg=arg, loc=loc, ip=ip))
...
def is_broadcastable(shapes, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(IsBroadcastableOp(shapes=shapes, loc=loc, ip=ip))
...
def max(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def meet(arg0, arg1, *, error=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(MeetOp(arg0=arg0, arg1=arg1, error=error, loc=loc, ip=ip))
...
def min(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def mul(lhs, rhs, *, loc=None, ip=None) -> _SubClassValueT:
...
def num_elements(shape, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(NumElementsOp(shape=shape, loc=loc, ip=ip))
...
def rank(shape, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(RankOp(shape=shape, loc=loc, ip=ip))
...
def reduce(result, shape, init_vals, *, loc=None, ip=None) -> _SubClassValueT:
...
def shape_eq(shapes, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ShapeEqOp(shapes=shapes, loc=loc, ip=ip))
...
def shape_of(arg, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ShapeOfOp(arg=arg, loc=loc, ip=ip))
...
def size_to_index(arg, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(SizeToIndexOp(arg=arg, loc=loc, ip=ip))
...
def split_at(head, tail, operand, index, *, loc=None, ip=None) -> _Sequence[_SubClassValueT]:
  return _get_op_result_or_op_results(SplitAtOp(head=head, tail=tail, operand=operand, index=index, loc=loc, ip=ip))
...
def to_extent_tensor(result, input, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ToExtentTensorOp(result=result, input=input, loc=loc, ip=ip))
...
def value_as_shape(result, arg, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ValueAsShapeOp(result=result, arg=arg, loc=loc, ip=ip))
...
def value_of(result, arg, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ValueOfOp(result=result, arg=arg, loc=loc, ip=ip))
...
def with_shape(operand, shape, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(WithOp(operand=operand, shape=shape, loc=loc, ip=ip))
