...
def buffer_subspan(source_buffer, source_offset, length, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferSubspanOp(source_buffer=source_buffer, source_offset=source_offset, length=length, loc=loc, ip=ip))
...
def buffer_view_create(source_buffer, source_offset, source_length, element_type, encoding_type, shape, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferViewCreateOp(source_buffer=source_buffer, source_offset=source_offset, source_length=source_length, element_type=element_type, encoding_type=encoding_type, shape=shape, loc=loc, ip=ip))
...
def buffer_view_dim(buffer_view, index, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferViewDimOp(buffer_view=buffer_view, index=index, loc=loc, ip=ip))
...
def buffer_view_rank(buffer_view, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(BufferViewRankOp(buffer_view=buffer_view, loc=loc, ip=ip))
...
def byte_buffer_constant(value, *, name=None, alignment=None, mime_type=None, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ByteBufferConstantOp(value=value, name=name, alignment=alignment, mime_type=mime_type, loc=loc, ip=ip))
...
def dispatch(results_, workload, entry_point, arguments, argument_dims, result_dims, *, tied_operands=None, loc=None, ip=None) -> _SubClassValueT:
...
def global_(sym_name, type_, *, sym_visibility=None, is_mutable=None, initializer=None, initial_value=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(GlobalOp(sym_name=sym_name, type_=type_, sym_visibility=sym_visibility, is_mutable=is_mutable, initializer=initializer, initial_value=initial_value, loc=loc, ip=ip))
...
def tensor_clone(operand, operand_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorCloneOp(operand=operand, operand_dims=operand_dims, loc=loc, ip=ip))
...
def tensor_export(target, source, source_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorExportOp(target=target, source=source, source_dims=source_dims, loc=loc, ip=ip))
...
def tensor_import(target, source, target_dims, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(TensorImportOp(target=target, source=source, target_dims=target_dims, loc=loc, ip=ip))
