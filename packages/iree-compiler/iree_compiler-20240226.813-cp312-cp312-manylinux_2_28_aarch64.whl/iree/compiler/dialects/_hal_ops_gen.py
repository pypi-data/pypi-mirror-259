...
class ExecutableConditionOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_763')) else
      _ods_ir.AttrBuilder.get('anonymous_763')(function_type, context=_ods_context))
...
class ExecutableExportOrdinalOp(_ods_ir.OpView):
  ...
  def __init__(self, result, entry_point, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def executable_export_ordinal(result, entry_point, *, loc=None, ip=None) -> _SubClassValueT:
  return _get_op_result_or_op_results(ExecutableExportOrdinalOp(result=result, entry_point=entry_point, loc=loc, ip=ip))
