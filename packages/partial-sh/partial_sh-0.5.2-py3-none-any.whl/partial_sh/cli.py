...
main_app.add_typer(functions_app, name="functions", no_args_is_help=False, help="Functions")
main_app.add_typer(shapes_app, name="shapes", no_args_is_help=False, help="Shapes")
main_app.add_typer(show_app, name="show", no_args_is_help=True, help="Show the content of a shape")
