...
# %% auto 0
__all__ = ['detect_encoding', 'read_html_file', 'remove_query_params_from_url', 'update_env', 'upsert_folder',
           'get_all_files_and_folders', 'ImageBlockConverter', 'md', 'convert_html_to_markdown', 'download_zip',
           'download_pptx', 'convert_str_to_snake_case', 'convert_str_remove_accents', 'convert_str_keep_alphanumeric',
