...
UserDefinedMap v_one_trigger_fields_map({
	{Field_v_one_trigger::v_one_triggerA__Ztrigger_meta, "v_one_triggerA__Ztrigger_meta"},
	{Field_v_one_trigger::v_one_triggerA__Zn_primitives, "v_one_triggerA__Zn_primitives"},
	{Field_v_one_trigger::v_one_triggerA__Zpacked, "v_one_triggerA__Zpacked"},
	{Field_v_one_trigger::v_one_triggerA__Zn_detectors, "v_one_triggerA__Zn_detectors"},
	{Field_v_one_trigger::v_one_triggerA__Zdetectors_in_event, "v_one_triggerA__Zdetectors_in_event"},
	{Field_v_one_trigger::v_one_triggerA__Zdet_header, "v_one_triggerA__Zdet_header"}});

UserDefinedMap v_one_trig_meta_fields_map({
	{Field_v_one_trig_meta::v_one_trig_metaA__Zpacked_1, "v_one_trig_metaA__Zpacked_1"},
	{Field_v_one_trig_meta::v_one_trig_metaA__Ztrigger_id, "v_one_trig_metaA__Ztrigger_id"},
	{Field_v_one_trig_meta::v_one_trig_metaA__Ztrigger_type, "v_one_trig_metaA__Ztrigger_type"},
	{Field_v_one_trig_meta::v_one_trig_metaA__Zglobal_timestamp_low, "v_one_trig_metaA__Zglobal_timestamp_low"},
	{Field_v_one_trig_meta::v_one_trig_metaA__Zglobal_timestamp_high, "v_one_trig_metaA__Zglobal_timestamp_high"},
	{Field_v_one_trig_meta::v_one_trig_metaA__Zpacked_2, "v_one_trig_metaA__Zpacked_2"},
	{Field_v_one_trig_meta::v_one_trig_metaA__Zlength_of_entry, "v_one_trig_metaA__Zlength_of_entry"},
	{Field_v_one_trig_meta::v_one_trig_metaA__Zevent_size, "v_one_trig_metaA__Zevent_size"},
	{Field_v_one_trig_meta::v_one_trig_metaA__Ztrig_header, "v_one_trig_metaA__Ztrig_header"},
	{Field_v_one_trig_meta::v_one_trig_metaA__Znum_primitives, "v_one_trig_metaA__Znum_primitives"},
	{Field_v_one_trig_meta::v_one_trig_metaA__Zprim_header, "v_one_trig_metaA__Zprim_header"}});
...
void scdms_t::_read() {
    ...
    m_n_triggers = new std::vector<kaitai::kstruct*>();
    ...
    for (int i = 0; i < l_n_triggers; i++) {
        auto& n_triggers_unionbuilder = n_triggers_listoffsetbuilder.content();
        switch (scdms_hdr()->format_version()) {
        case 1: {
            n_triggers_unionbuilder.append_content<0>();
            auto& v_one_trigger_recordbuilder = scdms_builder.content<Field_scdms::scdmsA__Zn_triggers>().content().content<0>();
            m_n_triggers->push_back(new v_one_trigger_t(v_one_trigger_recordbuilder, m__io, this, m__root));
            break;
        }
        case 2: {
            n_triggers_unionbuilder.append_content<1>();
            auto& v_two_trigger_recordbuilder = scdms_builder.content<Field_scdms::scdmsA__Zn_triggers>().content().content<1>();
...
void scdms_t::_clean_up() {
    ...
    if (m_n_triggers) {
        for (std::vector<kaitai::kstruct*>::iterator it = m_n_triggers->begin(); it != m_n_triggers->end(); ++it) {
            delete *it;
        }
...
scdms_t::v_one_trig_meta_t::v_one_trig_meta_t(V_one_trig_metaBuilderType builder, kaitai::kstream* p__io, scdms_t::v_one_trigger_t* p__parent, scdms_t* p__root) : kaitai::kstruct(p__io),
	v_one_trig_meta_builder(builder) {
    m__parent = p__parent;
    m__root = p__root;
    f_event_size = false;
    f_trig_header = false;
    ...
    v_one_trig_meta_builder.set_fields(v_one_trig_meta_fields_map);
...
void scdms_t::v_one_trig_meta_t::_read() {
    m_packed_1 = m__io->read_u4le();
    auto& packed_1_builder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Zpacked_1>();
    packed_1_builder.append(m_packed_1);
    m_trigger_id = m__io->read_u4le();
    auto& trigger_id_builder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Ztrigger_id>();
    trigger_id_builder.append(m_trigger_id);
    m_trigger_type = static_cast<scdms_t::trigger_types_t>(m__io->read_u4le());
    auto& trigger_type_indexbuilder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Ztrigger_type>();
    auto& trigger_type_listoffsetbuilder = trigger_type_indexbuilder.append_index();
    trigger_type_listoffsetbuilder.begin_list();
    auto& trigger_type_builder = trigger_type_listoffsetbuilder.content();
    trigger_type_indexbuilder.set_parameters("\"__array__\": \"categorical\"");
    trigger_type_listoffsetbuilder.set_parameters("\"__array__\": \"string\"");
    trigger_type_builder.set_parameters("\"__array__\" : \"char\"");
    for (int i = 0; i < m_trigger_type.length(); i++) {
        trigger_type_builder.append(m_trigger_type[i]);
    }
    trigger_type_listoffsetbuilder.end_list();
    m_global_timestamp_low = m__io->read_u4le();
    auto& global_timestamp_low_builder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Zglobal_timestamp_low>();
    global_timestamp_low_builder.append(m_global_timestamp_low);
    m_global_timestamp_high = m__io->read_u4le();
    auto& global_timestamp_high_builder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Zglobal_timestamp_high>();
    global_timestamp_high_builder.append(m_global_timestamp_high);
    m_packed_2 = m__io->read_u4le();
    auto& packed_2_builder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Zpacked_2>();
    packed_2_builder.append(m_packed_2);
    m_length_of_entry = m__io->read_u4le();
    auto& length_of_entry_builder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Zlength_of_entry>();
    length_of_entry_builder.append(m_length_of_entry);
    auto& event_size_instancebuilder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Zevent_size>();
    event_size_instancebuilder.append(event_size());
    auto& num_primitives_instancebuilder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Znum_primitives>();
    num_primitives_instancebuilder.append(num_primitives());
    auto& prim_header_instancebuilder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Zprim_header>();
    prim_header_instancebuilder.append(prim_header());
    auto& trig_header_instancebuilder = v_one_trig_meta_builder.content<Field_v_one_trig_meta::v_one_trig_metaA__Ztrig_header>();
    trig_header_instancebuilder.append(trig_header());
}

scdms_t::v_one_trig_meta_t::~v_one_trig_meta_t() {
    _clean_up();
}

void scdms_t::v_one_trig_meta_t::_clean_up() {
}

int32_t scdms_t::v_one_trig_meta_t::event_size() {
    if (f_event_size) {
        return m_event_size;
    }
...
scdms_t::headers_t scdms_t::v_one_trig_meta_t::trig_header() {
    if (f_trig_header) {
...
int32_t scdms_t::v_one_trig_meta_t::num_primitives() {
    if (f_num_primitives) {
        return m_num_primitives;
    }
    m_num_primitives = (packed_2() & 268435455);
    f_num_primitives = true;
    return m_num_primitives;
}

scdms_t::headers_t scdms_t::v_one_trig_meta_t::prim_header() {
    if (f_prim_header) {
        return m_prim_header;
    }
    m_prim_header = static_cast<scdms_t::headers_t>(((packed_1() & 4026531840UL) >> 28));
    f_prim_header = true;
    return m_prim_header;
}

scdms_t::detector_t::detector_t(DetectorBuilderType builder, kaitai::kstream* p__io, kaitai::kstruct* p__parent, scdms_t* p__root) : kaitai::kstruct(p__io),
...
scdms_t::primitive_t::primitive_t(PrimitiveBuilderType builder, kaitai::kstream* p__io, kaitai::kstruct* p__parent, scdms_t* p__root) : kaitai::kstruct(p__io),
...
scdms_t::v_one_trigger_t::v_one_trigger_t(V_one_triggerBuilderType builder, kaitai::kstream* p__io, scdms_t* p__parent, scdms_t* p__root) : kaitai::kstruct(p__io),
	v_one_trigger_builder(builder) {
    m__parent = p__parent;
    m__root = p__root;
    m_trigger_meta = 0;
    m_n_primitives = 0;
    ...
    v_one_trigger_builder.set_fields(v_one_trigger_fields_map);
...
void scdms_t::v_one_trigger_t::_read() {
    auto& v_one_trig_meta_recordbuilder = v_one_trigger_builder.content<Field_v_one_trigger::v_one_triggerA__Ztrigger_meta>();
    m_trigger_meta = new v_one_trig_meta_t(v_one_trig_meta_recordbuilder, m__io, this, m__root);
    m_n_primitives = new std::vector<primitive_t*>();
    const int l_n_primitives = trigger_meta()->num_primitives();
    auto& n_primitives_listoffsetbuilder = v_one_trigger_builder.content<Field_v_one_trigger::v_one_triggerA__Zn_primitives>();
    n_primitives_listoffsetbuilder.begin_list();
    for (int i = 0; i < l_n_primitives; i++) {
        auto& primitive_recordbuilder = v_one_trigger_builder.content<Field_v_one_trigger::v_one_triggerA__Zn_primitives>().content();
        m_n_primitives->push_back(new primitive_t(primitive_recordbuilder, m__io, this, m__root));
    }
    n_primitives_listoffsetbuilder.end_list();
    m_packed = m__io->read_u4le();
    auto& packed_builder = v_one_trigger_builder.content<Field_v_one_trigger::v_one_triggerA__Zpacked>();
    packed_builder.append(m_packed);
    m_n_detectors = new std::vector<detector_t*>();
    const int l_n_detectors = detectors_in_event();
    auto& n_detectors_listoffsetbuilder = v_one_trigger_builder.content<Field_v_one_trigger::v_one_triggerA__Zn_detectors>();
    n_detectors_listoffsetbuilder.begin_list();
    for (int i = 0; i < l_n_detectors; i++) {
        auto& detector_recordbuilder = v_one_trigger_builder.content<Field_v_one_trigger::v_one_triggerA__Zn_detectors>().content();
        m_n_detectors->push_back(new detector_t(detector_recordbuilder, m__io, this, m__root));
    }
    n_detectors_listoffsetbuilder.end_list();
    auto& det_header_instancebuilder = v_one_trigger_builder.content<Field_v_one_trigger::v_one_triggerA__Zdet_header>();
    det_header_instancebuilder.append(det_header());
    auto& detectors_in_event_instancebuilder = v_one_trigger_builder.content<Field_v_one_trigger::v_one_triggerA__Zdetectors_in_event>();
    detectors_in_event_instancebuilder.append(detectors_in_event());
}

scdms_t::v_one_trigger_t::~v_one_trigger_t() {
    _clean_up();
}

void scdms_t::v_one_trigger_t::_clean_up() {
    if (m_trigger_meta) {
        delete m_trigger_meta; m_trigger_meta = 0;
    }
    if (m_n_primitives) {
...
int32_t scdms_t::v_one_trigger_t::detectors_in_event() {
    if (f_detectors_in_event) {
        return m_detectors_in_event;
    }
    m_detectors_in_event = (packed() & 268435455);
...
scdms_t::headers_t scdms_t::v_one_trigger_t::det_header() {
    if (f_det_header) {
        return m_det_header;
    }
    m_det_header = static_cast<scdms_t::headers_t>(((packed() & 4026531840UL) >> 28));
