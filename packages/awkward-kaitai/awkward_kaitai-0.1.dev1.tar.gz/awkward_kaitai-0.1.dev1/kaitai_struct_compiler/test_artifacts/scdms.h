...
enum Field_v_one_trigger : std::size_t {v_one_triggerA__Ztrigger_meta, v_one_triggerA__Zn_primitives, v_one_triggerA__Zpacked, v_one_triggerA__Zn_detectors, v_one_triggerA__Zdetectors_in_event, v_one_triggerA__Zdet_header};
enum Field_v_one_trig_meta : std::size_t {v_one_trig_metaA__Zpacked_1, v_one_trig_metaA__Ztrigger_id, v_one_trig_metaA__Ztrigger_type, v_one_trig_metaA__Zglobal_timestamp_low, v_one_trig_metaA__Zglobal_timestamp_high, v_one_trig_metaA__Zpacked_2, v_one_trig_metaA__Zlength_of_entry, v_one_trig_metaA__Zevent_size, v_one_trig_metaA__Ztrig_header, v_one_trig_metaA__Znum_primitives, v_one_trig_metaA__Zprim_header};
...
using ScdmsBuilderType =
	RecordBuilder<
		RecordField<Field_scdms::scdmsA__Zscdms_hdr, RecordBuilder<
			...
			RecordField<Field_scdms_header::scdms_headerA__Zoverall_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>,
		...
		>>,
		RecordField<Field_scdms::scdmsA__Zn_triggers, ListOffsetBuilder<int64_t, UnionBuilder<
			RecordBuilder<
				RecordField<Field_v_one_trigger::v_one_triggerA__Ztrigger_meta, RecordBuilder<
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Zpacked_1, NumpyBuilder<uint32_t>>,
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Ztrigger_id, NumpyBuilder<uint32_t>>,
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Ztrigger_type, IndexedBuilder<uint32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>,
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Zglobal_timestamp_low, NumpyBuilder<uint32_t>>,
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Zglobal_timestamp_high, NumpyBuilder<uint32_t>>,
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Zpacked_2, NumpyBuilder<uint32_t>>,
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Zlength_of_entry, NumpyBuilder<uint32_t>>,
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Zevent_size, NumpyBuilder<int32_t>>,
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Ztrig_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>,
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Znum_primitives, NumpyBuilder<int32_t>>,
					RecordField<Field_v_one_trig_meta::v_one_trig_metaA__Zprim_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>
				>>,
				RecordField<Field_v_one_trigger::v_one_triggerA__Zn_primitives, ListOffsetBuilder<int64_t, RecordBuilder<
					...
					RecordField<Field_primitive::primitiveA__Zprim_dcrc_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>
				>>>,
				RecordField<Field_v_one_trigger::v_one_triggerA__Zpacked, NumpyBuilder<uint32_t>>,
				RecordField<Field_v_one_trigger::v_one_triggerA__Zn_detectors, ListOffsetBuilder<int64_t, RecordBuilder<
					RecordField<Field_detector::detectorA__Zdetector_meta, RecordBuilder<
						...
						RecordField<Field_det_meta::det_metaA__Zreadout_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>,
						...
						RecordField<Field_det_meta::det_metaA__Zdcrc_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>,
						RecordField<Field_det_meta::det_metaA__Zchannel_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>,
					...
					RecordField<Field_detector::detectorA__Zn_channels, ListOffsetBuilder<int64_t, RecordBuilder<
						...
						RecordField<Field_channel::channelA__Zchnl_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>
					>>>
				>>>,
				RecordField<Field_v_one_trigger::v_one_triggerA__Zdetectors_in_event, NumpyBuilder<int32_t>>,
				RecordField<Field_v_one_trigger::v_one_triggerA__Zdet_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>
			>,
			RecordBuilder<
				RecordField<Field_v_two_trigger::v_two_triggerA__Ztrigger_meta, RecordBuilder<
					...
					RecordField<Field_v_two_trig_meta::v_two_trig_metaA__Zprim_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>,
					RecordField<Field_v_two_trig_meta::v_two_trig_metaA__Znum_primitives, NumpyBuilder<int32_t>>,
					RecordField<Field_v_two_trig_meta::v_two_trig_metaA__Ztrigger_type, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>,
					...
					RecordField<Field_v_two_trig_meta::v_two_trig_metaA__Ztrig_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>
				>>,
				...
				RecordField<Field_v_two_trigger::v_two_triggerA__Zdet_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>
			>
		>>>,
		RecordField<Field_scdms::scdmsA__Zscdms_footer, RecordBuilder<
			...
			RecordField<Field_trailer::trailerA__Ztrailer_header, IndexedBuilder<int32_t, ListOffsetBuilder<int64_t, NumpyBuilder<uint8_t>>>>
		>>
	>;
...
using V_two_triggerBuilderType = decltype(std::declval<ScdmsBuilderType>().content<Field_scdms::scdmsA__Zn_triggers>().content().content<1>());
...
using V_one_triggerBuilderType = decltype(std::declval<ScdmsBuilderType>().content<Field_scdms::scdmsA__Zn_triggers>().content().content<0>());
using PrimitiveBuilderType = decltype(std::declval<V_one_triggerBuilderType>().content<Field_v_one_trigger::v_one_triggerA__Zn_primitives>().content());
using V_one_trig_metaBuilderType = decltype(std::declval<V_one_triggerBuilderType>().content<Field_v_one_trigger::v_one_triggerA__Ztrigger_meta>());
using DetectorBuilderType = decltype(std::declval<V_one_triggerBuilderType>().content<Field_v_one_trigger::v_one_triggerA__Zn_detectors>().content());
...
public:
    ...
    public:
        ...
        v_one_trig_meta_t(V_one_trig_metaBuilderType builder, kaitai::kstream* p__io, scdms_t::v_one_trigger_t* p__parent = 0, scdms_t* p__root = 0);
    ...
    private:
        ...
        scdms_t* m__root;
        scdms_t::v_one_trigger_t* m__parent;
    ...
    public:
        ...
        scdms_t* _root() const { return m__root; }
        scdms_t::v_one_trigger_t* _parent() const { return m__parent; }
    ...
    public:
        ...
        detector_t(DetectorBuilderType builder, kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, scdms_t* p__root = 0);
    ...
    public:
        ...
        primitive_t(PrimitiveBuilderType builder, kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, scdms_t* p__root = 0);
    ...
    class v_one_trigger_t : public kaitai::kstruct {

    public:

        v_one_trigger_t(V_one_triggerBuilderType builder, kaitai::kstream* p__io, scdms_t* p__parent = 0, scdms_t* p__root = 0);
    ...
    private:
        v_one_trig_meta_t* m_trigger_meta;
        std::vector<primitive_t*>* m_n_primitives;
        uint32_t m_packed;
        std::vector<detector_t*>* m_n_detectors;
        scdms_t* m__root;
    ...
    public:
        v_one_trig_meta_t* trigger_meta() const { return m_trigger_meta; }
        std::vector<primitive_t*>* n_primitives() const { return m_n_primitives; }
        uint32_t packed() const { return m_packed; }
        std::vector<detector_t*>* n_detectors() const { return m_n_detectors; }
        scdms_t* _root() const { return m__root; }
        scdms_t* _parent() const { return m__parent; }
        V_one_triggerBuilderType v_one_trigger_builder;
    };
...
private:
    ...
    std::vector<kaitai::kstruct*>* m_n_triggers;
...
public:
    ...
    std::vector<kaitai::kstruct*>* n_triggers() const { return m_n_triggers; }
