...
from ...models.external_login_request import ExternalLoginRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: ExternalLoginRequest,
) -> Dict[str, Any]:
    url = "{}/auth/login-sso".format(client.base_url)
