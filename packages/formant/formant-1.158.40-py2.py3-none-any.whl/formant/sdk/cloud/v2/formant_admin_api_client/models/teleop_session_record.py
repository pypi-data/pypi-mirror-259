...
if TYPE_CHECKING:
    from ..models.teleop_session_record_metadata import TeleopSessionRecordMetadata
...
class TeleopSessionRecord:
    ...
    Attributes:
        ...
        tags (Union[Unset, TeleopSessionRecordTags]):
        organization_id (Union[Unset, str]):
        end_time (Union[Unset, None, datetime.datetime]):
        parent_id (Union[Unset, str]):
        metadata (Union[Unset, TeleopSessionRecordMetadata]):
    ...
    tags: Union[Unset, "TeleopSessionRecordTags"] = UNSET
    organization_id: Union[Unset, str] = UNSET
    end_time: Union[Unset, None, datetime.datetime] = UNSET
    parent_id: Union[Unset, str] = UNSET
    metadata: Union[Unset, "TeleopSessionRecordMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = TeleopSessionRecordMetadata.from_dict(_metadata)
