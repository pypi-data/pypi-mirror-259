...
if TYPE_CHECKING:
    from ..models.intervention_request_metadata import InterventionRequestMetadata
...
class InterventionRequest:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_data(
            data: object,
        ) -> Union["LabelingRequestData", "PhysicalRequestData", "SelectionRequestData", "TeleopRequestData"]:
            try:
