...
from ..models.port_forwarding_session_record_stream_type import PortForwardingSessionRecordStreamType
from ..models.port_forwarding_session_record_type import PortForwardingSessionRecordType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.port_forwarding_session_record_metadata import PortForwardingSessionRecordMetadata
    from ..models.port_forwarding_session_record_tags import PortForwardingSessionRecordTags
