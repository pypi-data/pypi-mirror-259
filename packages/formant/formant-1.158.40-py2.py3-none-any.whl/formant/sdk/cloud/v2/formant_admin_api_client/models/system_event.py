...
from ..models.system_event_stream_type import SystemEventStreamType
from ..models.system_event_type import SystemEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.system_event_metadata import SystemEventMetadata
    from ..models.system_event_tags import SystemEventTags
...
class SystemEvent:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_tags, Unset):
            ...
            tags = SystemEventTags.from_dict(_tags)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SystemEventMetadata.from_dict(_metadata)
        ...
        if _stream_type is None:
            ...
            stream_type = SystemEventStreamType(_stream_type)
        ...
        system_event.additional_properties = d
        return system_event
