...
from ..models.comment_stream_type import CommentStreamType
from ..models.comment_type import CommentType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.comment_metadata import CommentMetadata
    from ..models.comment_tags import CommentTags
...
class Comment:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_tags, Unset):
            ...
            tags = CommentTags.from_dict(_tags)
        ...
        if _stream_type is None:
            ...
            stream_type = CommentStreamType(_stream_type)
