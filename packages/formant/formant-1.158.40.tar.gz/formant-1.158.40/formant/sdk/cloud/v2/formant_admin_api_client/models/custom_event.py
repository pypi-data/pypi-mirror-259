...
from ..models.custom_event_severity import CustomEventSeverity
from ..models.custom_event_stream_type import CustomEventStreamType
from ..models.custom_event_type import CustomEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.custom_event_metadata import CustomEventMetadata
    from ..models.custom_event_tags import CustomEventTags


T = TypeVar("T", bound="CustomEvent")
...
class CustomEvent:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_severity, Unset):
            ...
            severity = CustomEventSeverity(_severity)
        ...
        if isinstance(_tags, Unset):
            ...
            tags = CustomEventTags.from_dict(_tags)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = CustomEventMetadata.from_dict(_metadata)
        ...
        if _stream_type is None:
            ...
            stream_type = CustomEventStreamType(_stream_type)
        ...
        custom_event.additional_properties = d
        return custom_event
