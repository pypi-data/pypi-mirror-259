...
from ..models.datapoint_event_severity import DatapointEventSeverity
from ..models.datapoint_event_stream_type import DatapointEventStreamType
from ..models.datapoint_event_type import DatapointEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.datapoint_event_metadata import DatapointEventMetadata
    from ..models.datapoint_event_tags import DatapointEventTags


T = TypeVar("T", bound="DatapointEvent")
...
class DatapointEvent:
    ...
    Attributes:
        ...
        severity (DatapointEventSeverity):
        interval (int):
        type (Union[Unset, DatapointEventType]):
        id (Union[Unset, str]):
        created_at (Union[Unset, datetime.datetime]):
        updated_at (Union[Unset, datetime.datetime]):
        tags (Union[Unset, DatapointEventTags]):
        organization_id (Union[Unset, str]):
        end_time (Union[Unset, None, datetime.datetime]):
        parent_id (Union[Unset, str]):
        metadata (Union[Unset, DatapointEventMetadata]):
        message (Union[Unset, str]):
        viewed (Union[Unset, bool]):
        device_id (Union[Unset, None, str]):
        stream_name (Union[Unset, None, str]):
        stream_type (Union[Unset, None, DatapointEventStreamType]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        severity = DatapointEventSeverity(d.pop("severity"))
        ...
        if isinstance(_tags, Unset):
            ...
            tags = DatapointEventTags.from_dict(_tags)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = DatapointEventMetadata.from_dict(_metadata)
        ...
        if _stream_type is None:
            ...
            stream_type = DatapointEventStreamType(_stream_type)
        ...
        datapoint_event.additional_properties = d
