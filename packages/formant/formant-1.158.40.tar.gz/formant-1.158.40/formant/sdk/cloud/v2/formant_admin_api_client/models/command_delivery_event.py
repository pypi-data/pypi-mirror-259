...
from ..models.command_delivery_event_stream_type import CommandDeliveryEventStreamType
from ..models.command_delivery_event_type import CommandDeliveryEventType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.command_delivery_event_metadata import CommandDeliveryEventMetadata
    from ..models.command_delivery_event_tags import CommandDeliveryEventTags


T = TypeVar("T", bound="CommandDeliveryEvent")


@attr.s(auto_attribs=True)
class CommandDeliveryEvent:
    """
    Attributes:
        time (datetime.datetime):
        command_id (str):
        type (Union[Unset, CommandDeliveryEventType]):
        id (Union[Unset, str]):
        created_at (Union[Unset, datetime.datetime]):
        updated_at (Union[Unset, datetime.datetime]):
        tags (Union[Unset, CommandDeliveryEventTags]):
        organization_id (Union[Unset, str]):
        end_time (Union[Unset, None, datetime.datetime]):
        parent_id (Union[Unset, str]):
        metadata (Union[Unset, CommandDeliveryEventMetadata]):
        message (Union[Unset, str]):
        viewed (Union[Unset, bool]):
        device_id (Union[Unset, None, str]):
        stream_name (Union[Unset, None, str]):
        stream_type (Union[Unset, None, CommandDeliveryEventStreamType]):
    ...
    time: datetime.datetime
    command_id: str
    type: Union[Unset, CommandDeliveryEventType] = UNSET
    id: Union[Unset, str] = UNSET
    created_at: Union[Unset, datetime.datetime] = UNSET
    updated_at: Union[Unset, datetime.datetime] = UNSET
    tags: Union[Unset, "CommandDeliveryEventTags"] = UNSET
    organization_id: Union[Unset, str] = UNSET
    end_time: Union[Unset, None, datetime.datetime] = UNSET
    parent_id: Union[Unset, str] = UNSET
    metadata: Union[Unset, "CommandDeliveryEventMetadata"] = UNSET
    message: Union[Unset, str] = UNSET
    viewed: Union[Unset, bool] = UNSET
    device_id: Union[Unset, None, str] = UNSET
    stream_name: Union[Unset, None, str] = UNSET
    stream_type: Union[Unset, None, CommandDeliveryEventStreamType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_type, Unset):
            ...
            type = CommandDeliveryEventType(_type)
        ...
        if isinstance(_tags, Unset):
            ...
            tags = CommandDeliveryEventTags.from_dict(_tags)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = CommandDeliveryEventMetadata.from_dict(_metadata)
        ...
        command_delivery_event.additional_properties = d
        return command_delivery_event
