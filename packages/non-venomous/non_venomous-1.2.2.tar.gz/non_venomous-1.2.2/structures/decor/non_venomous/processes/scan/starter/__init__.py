...
'''
	import non_venomous.processes.scan.starter as scan
	[ status ] = scan.start (		
		path = "",
		module_paths = [],
		relative_path = "",
...
import non_venomous.processes.scan.starter.path as scan_process_path
import non_venomous.processes.scan.starter.keg as keg_starter
import non_venomous.processes.scan.starter.ask as ask
