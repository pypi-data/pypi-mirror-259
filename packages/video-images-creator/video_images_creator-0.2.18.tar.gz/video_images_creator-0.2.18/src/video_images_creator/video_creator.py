...
def create_feature_set_frames_v2(current_index, directory_name, feature_images_urls): 
    ...
    current_index = add_images_in_single_frame(feature_images_urls[0], directory_name, current_index, 0.1, 12)

    current_index = add_images_in_single_frame(feature_images_urls[0], directory_name, current_index, 0.5,12)

    current_index = add_images_in_single_frame(feature_images_urls[0], directory_name, current_index, 1,45)   
    ...
    current_index = add_images_in_frameset(temp_feature_images_urls, directory_name, current_index,12, 0.1) 

    current_index = add_images_in_frameset(temp_feature_images_urls, directory_name, current_index,12, 0.5) 

    current_index = add_images_in_frameset(temp_feature_images_urls, directory_name, current_index,45, 1) 
    ...
    current_index = add_images_in_frameset(temp_feature_images_urls, directory_name, current_index,180, 1)
...
def create_starting_frames(current_index, directory_name, ending_page_image, total_frames):
...
def build_v2(feature_images_urls, feature_names):
    ...
    run_ffmpeg_v2(directory_name, folder_name) 
