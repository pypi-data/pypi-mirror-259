...
{
    "distutils": {
        "name": "myframe.service.__init__",
        "sources": [
            "src/myframe/service/__init__.py"
        ]
    },
    "module_name": "myframe.service.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__myframe__service
#define __PYX_HAVE_API__myframe__service
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "myframe.service" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "myframe.service.__init__"
extern int __pyx_module_is_main_myframe__service____init__;
int __pyx_module_is_main_myframe__service____init__ = 0;

/* Implementation of "myframe.service" */
...
static const char __pyx_k_myframe_service___init[] = "myframe.service.__init__";
/* #### Code section: decls ### */
...
typedef struct {
  ...
  PyObject *__pyx_kp_u_myframe_service___init;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_u_myframe_service___init);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_u_myframe_service___init);
...
#define __pyx_kp_u_myframe_service___init __pyx_mstate_global->__pyx_kp_u_myframe_service___init
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_kp_u_myframe_service___init, __pyx_k_myframe_service___init, sizeof(__pyx_k_myframe_service___init), 0, 1, 0, 0},
...
__Pyx_PyMODINIT_FUNC init__init__(void) { initservice(); }
#endif
__Pyx_PyMODINIT_FUNC initservice(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_service(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_service(); }
#endif
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_myframe__service____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_kp_u_myframe_service___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "myframe.service")) {
      if (unlikely((PyDict_SetItemString(modules, "myframe.service", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init myframe.service", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init myframe.service");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
