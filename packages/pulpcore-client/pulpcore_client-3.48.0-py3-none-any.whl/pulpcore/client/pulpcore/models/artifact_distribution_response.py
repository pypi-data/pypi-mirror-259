...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, pulp_last_updated=None, content_guard=None, pulp_href=None, hidden=False, base_url=None, name=None, pulp_labels=None, base_path=None, local_vars_configuration=None):  # noqa: E501
