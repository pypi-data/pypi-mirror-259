...
class PretrainConfig(BaseSubmissionConfig):
    ...
    Required args:
        ...
        train_data_path: The full remote directory of your training data (eg 's3://my-bucket/my-data'). For
    ...
    Optional args:
        tokenizer: The name of the tokenizer to use. If not provided, the default tokenizer for the model will be used.
