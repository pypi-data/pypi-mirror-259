...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi host-insights summarize-disk-statistics' = 'analysis-time-interval compartment-id from-json help host-id id statistic time-interval-end time-interval-start'
