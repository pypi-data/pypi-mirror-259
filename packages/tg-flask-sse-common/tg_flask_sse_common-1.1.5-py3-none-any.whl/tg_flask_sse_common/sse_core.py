...
from .sse_constant import RedisConfig, SseBusinessEventType, SseSystemEventType
from .sse_clients import SseClients
from .sse_redis_pub_sub import SseRedisPubSub


class Sse(object):
    def __init__(self, redis_config, sse_clients_config, business=SseBusinessEventType.DEFAULT):
        ...
        sse_clients = SseClients(
            sse_clients_config=sse_clients_config, business=business
        )
    ...
    def publish_business_message(self, channel, data, _id=None, retry=None):
        """
    ...
    def publish_end_message(self, channel, data, _id=None, retry=None):
        """
    ...
    def publish_connect_message(self, channel, data, _id=None, retry=None):
        """
        推送sse-end系统消息, 添加信息到redis频道
        """
        return self.sse_redis_pub_sub.publish_message(
    ...
    def publish_error_message(self, channel, data, _id=None, retry=None):
        """
        推送sse-error系统消息, 添加信息到redis频道
        """
        return self.sse_redis_pub_sub.publish_message(
            channel=channel,
            data=data,
...
business_event_type = SseBusinessEventType
