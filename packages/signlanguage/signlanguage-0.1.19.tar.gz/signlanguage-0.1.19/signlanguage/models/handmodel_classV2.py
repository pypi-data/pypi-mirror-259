        ...
        try:
            ...
            if (face_relation) and not body_relation and len(points_body)>0:
                ...
                if len(hand_Left)>0:
                    ...
                    points_face_XLeft = [
                        #thumb 
                        [(1/((hands_x[4]-body_x[2])*(hands_x[4]-body_x[0])*(hands_x[4]-body_x[7])*(hands_x[4]-body_x[9])))*(1/((hands_x[3]-body_x[2])*(hands_x[3]-body_x[0])*(hands_x[3]-body_x[7])*(hands_x[3]-body_x[9])))*(1/((hands_x[2]-body_x[2])*(hands_x[2]-body_x[0])*(hands_x[2]-body_x[7])*(hands_x[2]-body_x[9]))),     100],
                        #index
                        [(1/((hands_x[8]-body_x[2])*(hands_x[8]-body_x[0])*(hands_x[8]-body_x[7])*(hands_x[8]-body_x[9])))*(1/((hands_x[7]-body_x[2])*(hands_x[7]-body_x[0])*(hands_x[7]-body_x[7])*(hands_x[7]-body_x[9])))*(1/((hands_x[6]-body_x[2])*(hands_x[6]-body_x[0])*(hands_x[6]-body_x[7])*(hands_x[6]-body_x[9]))),     101],
                        #middle
                        [(1/((hands_x[12]-body_x[2])*(hands_x[12]-body_x[0])*(hands_x[12]-body_x[7])*(hands_x[12]-body_x[9])))*(1/((hands_x[11]-body_x[2])*(hands_x[11]-body_x[0])*(hands_x[11]-body_x[7])*(hands_x[11]-body_x[9])))*(1/((hands_x[10]-body_x[2])*(hands_x[10]-body_x[0])*(hands_x[10]-body_x[7])*(hands_x[10]-body_x[9]))),   102],
                        #ring
                        [(1/((hands_x[16]-body_x[2])*(hands_x[16]-body_x[0])*(hands_x[16]-body_x[7])*(hands_x[16]-body_x[9])))*(1/((hands_x[15]-body_x[2])*(hands_x[15]-body_x[0])*(hands_x[15]-body_x[7])*(hands_x[15]-body_x[9])))*(1/((hands_x[14]-body_x[2])*(hands_x[14]-body_x[0])*(hands_x[14]-body_x[7])*(hands_x[14]-body_x[9]))),   103],
                        #pinky
                        [(1/((hands_x[20]-body_x[2])*(hands_x[20]-body_x[0])*(hands_x[20]-body_x[7])*(hands_x[20]-body_x[9])))*(1/((hands_x[19]-body_x[2])*(hands_x[19]-body_x[0])*(hands_x[19]-body_x[7])*(hands_x[19]-body_x[9])))*(1/((hands_x[18]-body_x[2])*(hands_x[18]-body_x[0])*(hands_x[18]-body_x[7])*(hands_x[18]-body_x[9]))),   104]
                    ]
                    
                    points_face_YLeft = [
                        #thumb 
                        [(1/((hands_y[4]-body_y[2])*(hands_y[4]-body_y[0])*(hands_y[4]-body_y[7])*(hands_y[4]-body_y[9])))*(1/((hands_y[3]-body_y[2])*(hands_y[3]-body_y[0])*(hands_y[3]-body_y[7])*(hands_y[3]-body_y[9])))*(1/((hands_y[2]-body_y[2])*(hands_y[2]-body_y[0])*(hands_y[2]-body_y[7])*(hands_y[2]-body_y[9]))),     100],
                        #index
                        [(1/((hands_y[8]-body_y[2])*(hands_y[8]-body_y[0])*(hands_y[8]-body_y[7])*(hands_y[8]-body_y[9])))*(1/((hands_y[7]-body_y[2])*(hands_y[7]-body_y[0])*(hands_y[7]-body_y[7])*(hands_y[7]-body_y[9])))*(1/((hands_y[6]-body_y[2])*(hands_y[6]-body_y[0])*(hands_y[6]-body_y[7])*(hands_y[6]-body_y[9]))),     101],
                        #middle
                        [(1/((hands_y[12]-body_y[2])*(hands_y[12]-body_y[0])*(hands_y[12]-body_y[7])*(hands_y[12]-body_y[9])))*(1/((hands_y[11]-body_y[2])*(hands_y[11]-body_y[0])*(hands_y[11]-body_y[7])*(hands_y[11]-body_y[9])))*(1/((hands_y[10]-body_y[2])*(hands_y[10]-body_y[0])*(hands_y[10]-body_y[7])*(hands_y[10]-body_y[9]))),   102],
                        #ring
                        [(1/((hands_y[16]-body_y[2])*(hands_y[16]-body_y[0])*(hands_y[16]-body_y[7])*(hands_y[16]-body_y[9])))*(1/((hands_y[15]-body_y[2])*(hands_y[15]-body_y[0])*(hands_y[15]-body_y[7])*(hands_y[15]-body_y[9])))*(1/((hands_y[14]-body_y[2])*(hands_y[14]-body_y[0])*(hands_y[14]-body_y[7])*(hands_y[14]-body_y[9]))),   103],
                        #pinky
                        [(1/((hands_y[20]-body_y[2])*(hands_y[20]-body_y[0])*(hands_y[20]-body_y[7])*(hands_y[20]-body_y[9])))*(1/((hands_y[19]-body_y[2])*(hands_y[19]-body_y[0])*(hands_y[19]-body_y[7])*(hands_y[19]-body_y[9])))*(1/((hands_y[18]-body_y[2])*(hands_y[18]-body_y[0])*(hands_y[18]-body_y[7])*(hands_y[18]-body_y[9]))),   104]
                    ]
                    
                    points_face_ZLeft = [
                        #thumb 
                        [(1/((hands_z[4]-body_z[2])*(hands_z[4]-body_z[0])*(hands_z[4]-body_z[7])*(hands_z[4]-body_z[9])))*(1/((hands_z[3]-body_z[2])*(hands_z[3]-body_z[0])*(hands_z[3]-body_z[7])*(hands_z[3]-body_z[9])))*(1/((hands_z[2]-body_z[2])*(hands_z[2]-body_z[0])*(hands_z[2]-body_z[7])*(hands_z[2]-body_z[9]))),     100],
                        #index
                        [(1/((hands_z[8]-body_z[2])*(hands_z[8]-body_z[0])*(hands_z[8]-body_z[7])*(hands_z[8]-body_z[9])))*(1/((hands_z[7]-body_z[2])*(hands_z[7]-body_z[0])*(hands_z[7]-body_z[7])*(hands_z[7]-body_z[9])))*(1/((hands_z[6]-body_z[2])*(hands_z[6]-body_z[0])*(hands_z[6]-body_z[7])*(hands_z[6]-body_z[9]))),     101],
                        #middle
                        [(1/((hands_z[12]-body_z[2])*(hands_z[12]-body_z[0])*(hands_z[12]-body_z[7])*(hands_z[12]-body_z[9])))*(1/((hands_z[11]-body_z[2])*(hands_z[11]-body_z[0])*(hands_z[11]-body_z[7])*(hands_z[11]-body_z[9])))*(1/((hands_z[10]-body_z[2])*(hands_z[10]-body_z[0])*(hands_z[10]-body_z[7])*(hands_z[10]-body_z[9]))),   102],
                        #ring
                        [(1/((hands_z[16]-body_z[2])*(hands_z[16]-body_z[0])*(hands_z[16]-body_z[7])*(hands_z[16]-body_z[9])))*(1/((hands_z[15]-body_z[2])*(hands_z[15]-body_z[0])*(hands_z[15]-body_z[7])*(hands_z[15]-body_z[9])))*(1/((hands_z[14]-body_z[2])*(hands_z[14]-body_z[0])*(hands_z[14]-body_z[7])*(hands_z[14]-body_z[9]))),   103],
                        #pinky
                        [(1/((hands_z[20]-body_z[2])*(hands_z[20]-body_z[0])*(hands_z[20]-body_z[7])*(hands_z[20]-body_z[9])))*(1/((hands_z[19]-body_z[2])*(hands_z[19]-body_z[0])*(hands_z[19]-body_z[7])*(hands_z[19]-body_z[9])))*(1/((hands_z[18]-body_z[2])*(hands_z[18]-body_z[0])*(hands_z[18]-body_z[7])*(hands_z[18]-body_z[9]))),   104]
                    ]
                ...
                if hand_diff_relation:
                    if len(hand_Left) > 0:
                        ...
                        points_face_relation_diffXLeft = [
                            #thumb 
                            [(1/((hands_x[4]-body_x[5]) *(hands_x[4]-body_x[0]) *(hands_x[4]-body_x[8]) *(hands_x[4]-body_x[10])))*(1/((hands_x[3]-body_x[5]) *(hands_x[3]-body_x[0]) *(hands_x[3]-body_x[8]) *(hands_x[3]-body_x[10])))*(1/((hands_x[2]-body_x[5]) *(hands_x[2]-body_x[0]) *(hands_x[2]-body_x[8]) *(hands_x[2]-body_x[10]))),    100],
                            #index
                            [(1/((hands_x[8]-body_x[5]) *(hands_x[8]-body_x[0]) *(hands_x[8]-body_x[8]) *(hands_x[8]-body_x[10])))*(1/((hands_x[7]-body_x[5]) *(hands_x[7]-body_x[0]) *(hands_x[7]-body_x[8]) *(hands_x[7]-body_x[10])))*(1/((hands_x[6]-body_x[5]) *(hands_x[6]-body_x[0]) *(hands_x[6]-body_x[8]) *(hands_x[6]-body_x[10]))),    101],
                            #middle
                            [(1/((hands_x[12]-body_x[5])*(hands_x[12]-body_x[0])*(hands_x[12]-body_x[8])*(hands_x[12]-body_x[10])))*(1/((hands_x[11]-body_x[5])*(hands_x[11]-body_x[0])*(hands_x[11]-body_x[8])*(hands_x[11]-body_x[10])))*(1/((hands_x[10]-body_x[5])*(hands_x[10]-body_x[0])*(hands_x[10]-body_x[8])*(hands_x[10]-body_x[10]))),  102],
                            #ring
                            [(1/((hands_x[16]-body_x[5])*(hands_x[16]-body_x[0])*(hands_x[16]-body_x[8])*(hands_x[16]-body_x[10])))*(1/((hands_x[15]-body_x[5])*(hands_x[15]-body_x[0])*(hands_x[15]-body_x[8])*(hands_x[15]-body_x[10])))*(1/((hands_x[14]-body_x[5])*(hands_x[14]-body_x[0])*(hands_x[14]-body_x[8])*(hands_x[14]-body_x[10]))),  103],
                            #pinky
                            [(1/((hands_x[20]-body_x[5])*(hands_x[20]-body_x[0])*(hands_x[20]-body_x[8])*(hands_x[20]-body_x[10])))*(1/((hands_x[19]-body_x[5])*(hands_x[19]-body_x[0])*(hands_x[19]-body_x[8])*(hands_x[19]-body_x[10])))*(1/((hands_x[18]-body_x[5])*(hands_x[18]-body_x[0])*(hands_x[18]-body_x[8])*(hands_x[18]-body_x[10]))),  104]
                        ]
                        
                        points_face_relation_diffYLeft = [
                            #thumb 
                            [(1/((hands_y[4]-body_y[5]) *(hands_y[4]-body_y[0]) *(hands_y[4]-body_y[8]) *(hands_y[4]-body_y[10])))*(1/((hands_y[3]-body_y[5]) *(hands_y[3]-body_y[0]) *(hands_y[3]-body_y[8]) *(hands_y[3]-body_y[10])))*(1/((hands_y[2]-body_y[5]) *(hands_y[2]-body_y[0]) *(hands_y[2]-body_y[8]) *(hands_y[2]-body_y[10]))),    100],
                            #index
                            [(1/((hands_y[8]-body_y[5]) *(hands_y[8]-body_y[0]) *(hands_y[8]-body_y[8]) *(hands_y[8]-body_y[10])))*(1/((hands_y[7]-body_y[5]) *(hands_y[7]-body_y[0]) *(hands_y[7]-body_y[8]) *(hands_y[7]-body_y[10])))*(1/((hands_y[6]-body_y[5]) *(hands_y[6]-body_y[0]) *(hands_y[6]-body_y[8]) *(hands_y[6]-body_y[10]))),    101],
                            #middle
                            [(1/((hands_y[12]-body_y[5])*(hands_y[12]-body_y[0])*(hands_y[12]-body_y[8])*(hands_y[12]-body_y[10])))*(1/((hands_y[11]-body_y[5])*(hands_y[11]-body_y[0])*(hands_y[11]-body_y[8])*(hands_y[11]-body_y[10])))*(1/((hands_y[10]-body_y[5])*(hands_y[10]-body_y[0])*(hands_y[10]-body_y[8])*(hands_y[10]-body_y[10]))),  102],
                            #ring
                            [(1/((hands_y[16]-body_y[5])*(hands_y[16]-body_y[0])*(hands_y[16]-body_y[8])*(hands_y[16]-body_y[10])))*(1/((hands_y[15]-body_y[5])*(hands_y[15]-body_y[0])*(hands_y[15]-body_y[8])*(hands_y[15]-body_y[10])))*(1/((hands_y[14]-body_y[5])*(hands_y[14]-body_y[0])*(hands_y[14]-body_y[8])*(hands_y[14]-body_y[10]))),  103],
                            #pinky
                            [(1/((hands_y[20]-body_y[5])*(hands_y[20]-body_y[0])*(hands_y[20]-body_y[8])*(hands_y[20]-body_y[10])))*(1/((hands_y[19]-body_y[5])*(hands_y[19]-body_y[0])*(hands_y[19]-body_y[8])*(hands_y[19]-body_y[10])))*(1/((hands_y[18]-body_y[5])*(hands_y[18]-body_y[0])*(hands_y[18]-body_y[8])*(hands_y[18]-body_y[10]))),  104]
                        ]
                        
                        points_face_relation_diffZLeft = [
                            #thumb 
                            [(1/((hands_z[4]-body_z[5]) *(hands_z[4]-body_z[0]) *(hands_z[4]-body_z[8]) *(hands_z[4]-body_z[10])))*(1/((hands_z[3]-body_z[5]) *(hands_z[3]-body_z[0]) *(hands_z[3]-body_z[8]) *(hands_z[3]-body_z[10])))*(1/((hands_z[2]-body_z[5]) *(hands_z[2]-body_z[0]) *(hands_z[2]-body_z[8]) *(hands_z[2]-body_z[10]))),    100],
                            #index
                            [(1/((hands_z[8]-body_z[5]) *(hands_z[8]-body_z[0]) *(hands_z[8]-body_z[8]) *(hands_z[8]-body_z[10])))*(1/((hands_z[7]-body_z[5]) *(hands_z[7]-body_z[0]) *(hands_z[7]-body_z[8]) *(hands_z[7]-body_z[10])))*(1/((hands_z[6]-body_z[5]) *(hands_z[6]-body_z[0]) *(hands_z[6]-body_z[8]) *(hands_z[6]-body_z[10]))),    101],
                            #middle
                            [(1/((hands_z[12]-body_z[5])*(hands_z[12]-body_z[0])*(hands_z[12]-body_z[8])*(hands_z[12]-body_z[10])))*(1/((hands_z[11]-body_z[5])*(hands_z[11]-body_z[0])*(hands_z[11]-body_z[8])*(hands_z[11]-body_z[10])))*(1/((hands_z[10]-body_z[5])*(hands_z[10]-body_z[0])*(hands_z[10]-body_z[8])*(hands_z[10]-body_z[10]))),  102],
                            #ring
                            [(1/((hands_z[16]-body_z[5])*(hands_z[16]-body_z[0])*(hands_z[16]-body_z[8])*(hands_z[16]-body_z[10])))*(1/((hands_z[15]-body_z[5])*(hands_z[15]-body_z[0])*(hands_z[15]-body_z[8])*(hands_z[15]-body_z[10])))*(1/((hands_z[14]-body_z[5])*(hands_z[14]-body_z[0])*(hands_z[14]-body_z[8])*(hands_z[14]-body_z[10]))),  103],
                            #pinky
                            [(1/((hands_z[20]-body_z[5])*(hands_z[20]-body_z[0])*(hands_z[20]-body_z[8])*(hands_z[20]-body_z[10])))*(1/((hands_z[19]-body_z[5])*(hands_z[19]-body_z[0])*(hands_z[19]-body_z[8])*(hands_z[19]-body_z[10])))*(1/((hands_z[18]-body_z[5])*(hands_z[18]-body_z[0])*(hands_z[18]-body_z[8])*(hands_z[18]-body_z[10]))),  104]
                        ]
