        ...
        try:
            ...
            if len(hand_Right) > 0:
                ...
                points_hand_Right_diffX = [
                    ...
                    #diff-between TIP
                    [(hands_x[4]-hands_x[8]),    4], [(hands_x[8]-hands_x[12]),   8], [(hands_x[12]-hands_x[16]), 12],  [(hands_x[16]-hands_x[20]), 16],
                    #diff-between IP
                    [(hands_x[3]-hands_x[7]),    3], [(hands_x[7]-hands_x[11]),   7], [(hands_x[11]-hands_x[15]), 11],  [(hands_x[15]-hands_x[19]), 15],
                    #diff-between 
                    [(hands_x[4]-hands_x[6]) * (hands_x[4]-hands_x[10]) * (hands_x[4]-hands_x[14]) * (hands_x[4]-hands_x[18]),                       4],
                    [(hands_x[8]-hands_x[2]) * (hands_x[8]-hands_x[10]),          8], 
                    [(hands_x[12]-hands_x[2])* (hands_x[12]-hands_x[6]),         12], 
                    [(hands_x[16]-hands_x[2])* (hands_x[16]-hands_x[6]),         16], 
                    [(hands_x[20]-hands_x[2])* (hands_x[20]-hands_x[6]),         20], 
                    #diff-between 
                    [(hands_x[4]-hands_x[7]) * (hands_x[4]-hands_x[11]) * (hands_x[4]-hands_x[15]) * (hands_x[4]-hands_x[19]),                      4],
                    [(hands_x[8]-hands_x[3]) * (hands_x[8]-hands_x[11]),          8], 
                    [(hands_x[12]-hands_x[3])* (hands_x[12]-hands_x[7]),         12], 
                    [(hands_x[16]-hands_x[3])* (hands_x[16]-hands_x[7]),         16], 
                    [(hands_x[20]-hands_x[3])* (hands_x[20]-hands_x[7]),         20], 
                    #diff-between 
                    [(hands_x[4]-hands_x[8]) * (hands_x[4]-hands_x[12]) * (hands_x[4]-hands_x[16]) * (hands_x[4]-hands_x[20]),                     4],
                    [(hands_x[8]-hands_x[4]) * (hands_x[8]-hands_x[12]),          8], 
                    [(hands_x[12]-hands_x[4])* (hands_x[12]-hands_x[8]),         12], 
                    [(hands_x[16]-hands_x[4])* (hands_x[16]-hands_x[8]),         16], 
                    [(hands_x[20]-hands_x[4])* (hands_x[20]-hands_x[8]),         20]
                ]
                ...
                points_hand_Right_diffY = [
                    ...
                    #diff-between TIP
                    [(hands_y[4]-hands_y[8]),    4], [(hands_y[8]-hands_y[12]),   8], [(hands_y[12]-hands_y[16]), 12],  [(hands_y[16]-hands_y[20]), 16],
                    #diff-between IP
                    [(hands_y[3]-hands_y[7]),    3], [(hands_y[7]-hands_y[11]),   7], [(hands_y[11]-hands_y[15]), 11],  [(hands_y[15]-hands_y[19]), 15],
                    #diff-between 
                    [(hands_y[4]-hands_y[6]) * (hands_y[4]-hands_y[10]) * (hands_y[4]-hands_y[14]) * (hands_y[4]-hands_y[18]),                       4],
                    [(hands_y[8]-hands_y[2]) * (hands_y[8]-hands_y[10]),          8], 
                    [(hands_y[12]-hands_y[2])* (hands_y[12]-hands_y[6]),         12], 
                    [(hands_y[16]-hands_y[2])* (hands_y[16]-hands_y[6]),         16], 
                    [(hands_y[20]-hands_y[2])* (hands_y[20]-hands_y[6]),         20], 
                    #diff-between 
                    [(hands_y[4]-hands_y[7]) * (hands_y[4]-hands_y[11]) * (hands_y[4]-hands_y[15]) * (hands_y[4]-hands_y[19]),                      4],
                    [(hands_y[8]-hands_y[3]) * (hands_y[8]-hands_y[11]),          8], 
                    [(hands_y[12]-hands_y[3])* (hands_y[12]-hands_y[7]),         12], 
                    [(hands_y[16]-hands_y[3])* (hands_y[16]-hands_y[7]),         16], 
                    [(hands_y[20]-hands_y[3])* (hands_y[20]-hands_y[7]),         20], 
                    #diff-between 
                    [(hands_y[4]-hands_y[8]) * (hands_y[4]-hands_y[12]) * (hands_y[4]-hands_y[16]) * (hands_y[4]-hands_y[20]),                     4],
                    [(hands_y[8]-hands_y[4]) * (hands_y[8]-hands_y[12]),          8], 
                    [(hands_y[12]-hands_y[4])* (hands_y[12]-hands_y[8]),         12], 
                    [(hands_y[16]-hands_y[4])* (hands_y[16]-hands_y[8]),         16], 
                    [(hands_y[20]-hands_y[4])* (hands_y[20]-hands_y[8]),         20]
                ]
                ...
                points_hand_Right_diffZ = [
                    ...
                    #diff-between TIP
                    [(hands_z[4]-hands_z[8]),    4], [(hands_z[8]-hands_z[12]),   8], [(hands_z[12]-hands_z[16]), 12],  [(hands_z[16]-hands_z[20]), 16],
                    #diff-between IP
                    [(hands_z[3]-hands_z[7]),    3], [(hands_z[7]-hands_z[11]),   7], [(hands_z[11]-hands_z[15]), 11],  [(hands_z[15]-hands_z[19]), 15],
                    #diff-between 
                    [(hands_z[4]-hands_z[6]) * (hands_z[4]-hands_z[10]) * (hands_z[4]-hands_z[14]) * (hands_z[4]-hands_z[18]),                       4],
                    [(hands_z[8]-hands_z[2]) * (hands_z[8]-hands_z[10]),          8], 
                    [(hands_z[12]-hands_z[2])* (hands_z[12]-hands_z[6]),         12], 
                    [(hands_z[16]-hands_z[2])* (hands_z[16]-hands_z[6]),         16], 
                    [(hands_z[20]-hands_z[2])* (hands_z[20]-hands_z[6]),         20], 
                    #diff-between 
                    [(hands_z[4]-hands_z[7]) * (hands_z[4]-hands_z[11]) * (hands_z[4]-hands_z[15]) * (hands_z[4]-hands_z[19]),                      4],
                    [(hands_z[8]-hands_z[3]) * (hands_z[8]-hands_z[11]),          8], 
                    [(hands_z[12]-hands_z[3])* (hands_z[12]-hands_z[7]),         12], 
                    [(hands_z[16]-hands_z[3])* (hands_z[16]-hands_z[7]),         16], 
                    [(hands_z[20]-hands_z[3])* (hands_z[20]-hands_z[7]),         20], 
                    #diff-between 
                    [(hands_z[4]-hands_z[8]) * (hands_z[4]-hands_z[12]) * (hands_z[4]-hands_z[16]) * (hands_z[4]-hands_z[20]),                     4],
                    [(hands_z[8]-hands_z[4]) * (hands_z[8]-hands_z[12]),          8], 
                    [(hands_z[12]-hands_z[4])* (hands_z[12]-hands_z[8]),         12], 
                    [(hands_z[16]-hands_z[4])* (hands_z[16]-hands_z[8]),         16], 
                    [(hands_z[20]-hands_z[4])* (hands_z[20]-hands_z[8]),         20]
                ]
            ...
            if len(hand_Left) > 0:
                ...
                points_hand_Left_diffZ = [
                    ...
                    #diff-between
                    [(hands_z[4]-hands_z[6]) * (hands_z[4]-hands_z[10]) * (hands_z[4]-hands_z[14]) * (hands_z[4]-hands_z[18]),                       4],
                    [(hands_z[8]-hands_z[3]) * (hands_z[8]-hands_z[10]),          8], 
                    [(hands_z[12]-hands_z[2])* (hands_z[12]-hands_z[6]),         12], 
                    [(hands_z[16]-hands_z[2])* (hands_z[16]-hands_z[6]),         16], 
                    [(hands_z[20]-hands_z[2])* (hands_z[20]-hands_z[6]),         20], 
                    #diff-between
