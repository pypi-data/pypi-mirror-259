        ...
        try:
            ...
            if len(hand_Right) > 0:
                ...
                points_hand_Right_diffX = [
                    ...
                    #diff-between TIP
                    [((hands_x[4]-hands_x[8]))*(1/(hands_x[8]-hands_x[12]))*(1/(hands_x[12]-hands_x[16]))*(1/(hands_x[16]-hands_x[20])), 101],
                    #diff-between IP
                    [((hands_x[3]-hands_x[7]))*(1/(hands_x[7]-hands_x[11]))*(1/(hands_x[11]-hands_x[15]))*(1/(hands_x[15]-hands_x[19])), 102],
                    #diff-between 
                ...
                points_hand_Right_diffY = [
                    ...
                    #diff-between TIP
                    [((hands_y[4]-hands_y[8]))*(1/(hands_y[8]-hands_y[12]))*(1/(hands_y[12]-hands_y[16]))*(1/(hands_y[16]-hands_y[20])), 101],
                    #diff-between IP
                    [((hands_y[3]-hands_y[7]))*(1/(hands_y[7]-hands_y[11]))*(1/(hands_y[11]-hands_y[15]))*(1/(hands_y[15]-hands_y[19])), 102],
                    #diff-between 
                ...
                points_hand_Right_diffZ = [
                    ...
                    #diff-between TIP
                    [((hands_z[4]-hands_z[8]))*(1/(hands_z[8]-hands_z[12]))*(1/(hands_z[12]-hands_z[16]))*(1/(hands_z[16]-hands_z[20])), 101],
                    #diff-between IP
                    [((hands_z[3]-hands_z[7]))*(1/(hands_z[7]-hands_z[11]))*(1/(hands_z[11]-hands_z[15]))*(1/(hands_z[15]-hands_z[19])), 102],
                    #diff-between 
