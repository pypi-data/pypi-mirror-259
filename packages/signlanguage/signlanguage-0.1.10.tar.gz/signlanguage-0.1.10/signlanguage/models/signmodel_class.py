...
class SignTrace(ITrace):
    ...
    async def exec_model_async(self, data=None, executionModelpool : em.ExecutionModelPool =None):
        try:
            if None in (data, executionModelpool):
    ...
    def train_model(self, trainModelpool: tm.TrainModelPool=None, data=None):
        try:
