        ...
        try:
            ...
            if len(hand_Right) > 0:
                ...
                points_hand_Right_diffX = [
                    #thumb
                    [(hands_x[4]-hands_x[3])*(hands_x[3]-hands_x[2])*(hands_x[2]-hands_x[1]),    4],
                    #index
                    [(hands_x[8]-hands_x[7])*(hands_x[7]-hands_x[6])*(hands_x[6]-hands_x[5]),    8],
                    #middle
                    [(hands_x[12]-hands_x[11])*(hands_x[11]-hands_x[10])*(hands_x[10]-hands_x[9]),  12],
                    #ring
                    [(hands_x[16]-hands_x[15])*(hands_x[15]-hands_x[14])*(hands_x[14]-hands_x[13]), 16],
                    #pinky
                    [(hands_x[20]-hands_x[19])*(hands_x[19]-hands_x[18])*(hands_x[18]-hands_x[17]), 20],
                    #to->wirst
                    [(hands_x[4]-hands_x[0])*(hands_x[8]-hands_x[0])*(hands_x[12]-hands_x[0])*(hands_x[16]-hands_x[0])*(hands_x[20]-hands_x[0]), 0],
                    #diff-between TIP
                    [(hands_x[4]-hands_x[8])*(hands_x[8]-hands_x[12])*(hands_x[12]-hands_x[16])*(hands_x[16]-hands_x[20]), 8],
                    #diff-between IP
                    [(hands_x[3]-hands_x[7])*(hands_x[7]-hands_x[11])*(hands_x[11]-hands_x[15])*(hands_x[15]-hands_x[19]), 7],
                    #diff-between 
                    [(hands_x[4]-hands_x[6])*(hands_x[4]-hands_x[10])*(hands_x[4]-hands_x[14])*(hands_x[4]-hands_x[18])*(hands_x[4]-hands_x[7])*(hands_x[4]-hands_x[11])*(hands_x[4]-hands_x[15])*(hands_x[4]-hands_x[19])*(hands_x[4]-hands_x[8])*(hands_x[4]-hands_x[12])*(hands_x[4]-hands_x[16])*(hands_x[4]-hands_x[20]),                       4],
                    [(hands_x[8]-hands_x[2])*(hands_x[8]-hands_x[10])*(hands_x[8]-hands_x[3])*(hands_x[8]-hands_x[11])*(hands_x[8]-hands_x[4])*(hands_x[8]-hands_x[12]),          8], 
                    [(hands_x[12]-hands_x[2])*(hands_x[12]-hands_x[6])*(hands_x[12]-hands_x[3])*(hands_x[12]-hands_x[7])*(hands_x[12]-hands_x[4])*(hands_x[12]-hands_x[8]),         12], 
                    [(hands_x[16]-hands_x[2])*(hands_x[16]-hands_x[6])*(hands_x[16]-hands_x[3])*(hands_x[16]-hands_x[7])*(hands_x[16]-hands_x[4])*(hands_x[16]-hands_x[8]),         16], 
                    [(hands_x[20]-hands_x[2])*(hands_x[20]-hands_x[6])*(hands_x[20]-hands_x[3])*(hands_x[20]-hands_x[7])*(hands_x[20]-hands_x[4])*(hands_x[20]-hands_x[8]),         20]
                ]
                
                points_hand_Right_diffY = [
                    #thumb
                    [(hands_y[4]-hands_y[3])*(hands_y[3]-hands_y[2])*(hands_y[2]-hands_y[1]),    4],
                    #index
                    [(hands_y[8]-hands_y[7])*(hands_y[7]-hands_y[6])*(hands_y[6]-hands_y[5]),    8],
                    #middle
                    [(hands_y[12]-hands_y[11])*(hands_y[11]-hands_y[10])*(hands_y[10]-hands_y[9]),  12],
                    #ring
                    [(hands_y[16]-hands_y[15])*(hands_y[15]-hands_y[14])*(hands_y[14]-hands_y[13]), 16],
                    #pinky
                    [(hands_y[20]-hands_y[19])*(hands_y[19]-hands_y[18])*(hands_y[18]-hands_y[17]), 20],
                    #to->wirst
                    [(hands_y[4]-hands_y[0])*(hands_y[8]-hands_y[0])*(hands_y[12]-hands_y[0])*(hands_y[16]-hands_y[0])*(hands_y[20]-hands_y[0]), 0],
                    #diff-between TIP
                    [(hands_y[4]-hands_y[8])*(hands_y[8]-hands_y[12])*(hands_y[12]-hands_y[16])*(hands_y[16]-hands_y[20]), 8],
                    #diff-between IP
                    [(hands_y[3]-hands_y[7])*(hands_y[7]-hands_y[11])*(hands_y[11]-hands_y[15])*(hands_y[15]-hands_y[19]), 7],
                    #diff-between 
                    [(hands_y[4]-hands_y[6])*(hands_y[4]-hands_y[10])*(hands_y[4]-hands_y[14])*(hands_y[4]-hands_y[18])*(hands_y[4]-hands_y[7])*(hands_y[4]-hands_y[11])*(hands_y[4]-hands_y[15])*(hands_y[4]-hands_y[19])*(hands_y[4]-hands_y[8])*(hands_y[4]-hands_y[12])*(hands_y[4]-hands_y[16])*(hands_y[4]-hands_y[20]),                       4],
                    [(hands_y[8]-hands_y[2])*(hands_y[8]-hands_y[10])*(hands_y[8]-hands_y[3])*(hands_y[8]-hands_y[11])*(hands_y[8]-hands_y[4])*(hands_y[8]-hands_y[12]),          8], 
                    [(hands_y[12]-hands_y[2])*(hands_y[12]-hands_y[6])*(hands_y[12]-hands_y[3])*(hands_y[12]-hands_y[7])*(hands_y[12]-hands_y[4])*(hands_y[12]-hands_y[8]),         12], 
                    [(hands_y[16]-hands_y[2])*(hands_y[16]-hands_y[6])*(hands_y[16]-hands_y[3])*(hands_y[16]-hands_y[7])*(hands_y[16]-hands_y[4])*(hands_y[16]-hands_y[8]),         16], 
                    [(hands_y[20]-hands_y[2])*(hands_y[20]-hands_y[6])*(hands_y[20]-hands_y[3])*(hands_y[20]-hands_y[7])*(hands_y[20]-hands_y[4])*(hands_y[20]-hands_y[8]),         20]
                ]
                
                points_hand_Right_diffZ = [
                    #thumb
                    [(hands_z[4]-hands_z[3])*(hands_z[3]-hands_z[2])*(hands_z[2]-hands_z[1]),    4],
                    #index
                    [(hands_z[8]-hands_z[7])*(hands_z[7]-hands_z[6])*(hands_z[6]-hands_z[5]),    8],
                    #middle
                    [(hands_z[12]-hands_z[11])*(hands_z[11]-hands_z[10])*(hands_z[10]-hands_z[9]),  12],
                    #ring
                    [(hands_z[16]-hands_z[15])*(hands_z[15]-hands_z[14])*(hands_z[14]-hands_z[13]), 16],
                    #pinky
                    [(hands_z[20]-hands_z[19])*(hands_z[19]-hands_z[18])*(hands_z[18]-hands_z[17]), 20],
                    #to->wirst
                    [(hands_z[4]-hands_z[0])*(hands_z[8]-hands_z[0])*(hands_z[12]-hands_z[0])*(hands_z[16]-hands_z[0])*(hands_z[20]-hands_z[0]), 0],
                    #diff-between TIP
                    [(hands_z[4]-hands_z[8])*(hands_z[8]-hands_z[12])*(hands_z[12]-hands_z[16])*(hands_z[16]-hands_z[20]), 8],
                    #diff-between IP
                    [(hands_z[3]-hands_z[7])*(hands_z[7]-hands_z[11])*(hands_z[11]-hands_z[15])*(hands_z[15]-hands_z[19]), 7],
                    #diff-between 
                    [(hands_z[4]-hands_z[6])*(hands_z[4]-hands_z[10])*(hands_z[4]-hands_z[14])*(hands_z[4]-hands_z[18])*(hands_z[4]-hands_z[7])*(hands_z[4]-hands_z[11])*(hands_z[4]-hands_z[15])*(hands_z[4]-hands_z[19])*(hands_z[4]-hands_z[8])*(hands_z[4]-hands_z[12])*(hands_z[4]-hands_z[16])*(hands_z[4]-hands_z[20]),                       4],
                    [(hands_z[8]-hands_z[2])*(hands_z[8]-hands_z[10])*(hands_z[8]-hands_z[3])*(hands_z[8]-hands_z[11])*(hands_z[8]-hands_z[4])*(hands_z[8]-hands_z[12]),          8], 
                    [(hands_z[12]-hands_z[2])*(hands_z[12]-hands_z[6])*(hands_z[12]-hands_z[3])*(hands_z[12]-hands_z[7])*(hands_z[12]-hands_z[4])*(hands_z[12]-hands_z[8]),         12], 
                    [(hands_z[16]-hands_z[2])*(hands_z[16]-hands_z[6])*(hands_z[16]-hands_z[3])*(hands_z[16]-hands_z[7])*(hands_z[16]-hands_z[4])*(hands_z[16]-hands_z[8]),         16], 
                    [(hands_z[20]-hands_z[2])*(hands_z[20]-hands_z[6])*(hands_z[20]-hands_z[3])*(hands_z[20]-hands_z[7])*(hands_z[20]-hands_z[4])*(hands_z[20]-hands_z[8]),         20]
                ]
            ...
            if (face_relation) and not body_relation and len(points_body)>0:
                ...
                if len(hand_Right)>0:
                    ...
                    points_face_XRight = [
                        #thumb 
                        [(hands_x[4]-body_x[5]) *(hands_x[4]-body_x[0]) *(hands_x[4]-body_x[8]) *(hands_x[4]-body_x[10]),    4],
                        [(hands_x[3]-body_x[5]) *(hands_x[3]-body_x[0]) *(hands_x[3]-body_x[8]) *(hands_x[3]-body_x[10]),    3],
                        [(hands_x[2]-body_x[5]) *(hands_x[2]-body_x[0]) *(hands_x[2]-body_x[8]) *(hands_x[2]-body_x[10]),    2],
                        #index
                        [(hands_x[8]-body_x[5]) *(hands_x[8]-body_x[0]) *(hands_x[8]-body_x[8]) *(hands_x[8]-body_x[10]),    8],
                        [(hands_x[7]-body_x[5]) *(hands_x[7]-body_x[0]) *(hands_x[7]-body_x[8]) *(hands_x[7]-body_x[10]),    7],
                        [(hands_x[6]-body_x[5]) *(hands_x[6]-body_x[0]) *(hands_x[6]-body_x[8]) *(hands_x[6]-body_x[10]),    6],
                        #middle
                        [(hands_x[12]-body_x[5])*(hands_x[12]-body_x[0])*(hands_x[12]-body_x[8])*(hands_x[12]-body_x[10]),  12],
                        [(hands_x[11]-body_x[5])*(hands_x[11]-body_x[0])*(hands_x[11]-body_x[8])*(hands_x[11]-body_x[10]),  11],
                        [(hands_x[10]-body_x[5])*(hands_x[10]-body_x[0])*(hands_x[10]-body_x[8])*(hands_x[10]-body_x[10]),  10],
                        #ring
                        [(hands_x[16]-body_x[5])*(hands_x[16]-body_x[0])*(hands_x[16]-body_x[8])*(hands_x[16]-body_x[10]),  16],
                        [(hands_x[15]-body_x[5])*(hands_x[15]-body_x[0])*(hands_x[15]-body_x[8])*(hands_x[15]-body_x[10]),  15],
                        [(hands_x[14]-body_x[5])*(hands_x[14]-body_x[0])*(hands_x[14]-body_x[8])*(hands_x[14]-body_x[10]),  14],
                        #pinky
                        [(hands_x[20]-body_x[5])*(hands_x[20]-body_x[0])*(hands_x[20]-body_x[8])*(hands_x[20]-body_x[10]),  20],
                        [(hands_x[19]-body_x[5])*(hands_x[19]-body_x[0])*(hands_x[19]-body_x[8])*(hands_x[19]-body_x[10]),  19],
                        [(hands_x[18]-body_x[5])*(hands_x[18]-body_x[0])*(hands_x[18]-body_x[8])*(hands_x[18]-body_x[10]),  18]
                    ]
                    
                    points_face_YRight = [
                        #thumb 
                        [(hands_y[4]-body_y[5]) *(hands_y[4]-body_y[0]) *(hands_y[4]-body_y[8]) *(hands_y[4]-body_y[10]),    4],
                        [(hands_y[3]-body_y[5]) *(hands_y[3]-body_y[0]) *(hands_y[3]-body_y[8]) *(hands_y[3]-body_y[10]),    3],
                        [(hands_y[2]-body_y[5]) *(hands_y[2]-body_y[0]) *(hands_y[2]-body_y[8]) *(hands_y[2]-body_y[10]),    2],
                        #index
                        [(hands_y[8]-body_y[5]) *(hands_y[8]-body_y[0]) *(hands_y[8]-body_y[8]) *(hands_y[8]-body_y[10]),    8],
                        [(hands_y[7]-body_y[5]) *(hands_y[7]-body_y[0]) *(hands_y[7]-body_y[8]) *(hands_y[7]-body_y[10]),    7],
                        [(hands_y[6]-body_y[5]) *(hands_y[6]-body_y[0]) *(hands_y[6]-body_y[8]) *(hands_y[6]-body_y[10]),    6],
                        #middle
                        [(hands_y[12]-body_y[5])*(hands_y[12]-body_y[0])*(hands_y[12]-body_y[8])*(hands_y[12]-body_y[10]),  12],
                        [(hands_y[11]-body_y[5])*(hands_y[11]-body_y[0])*(hands_y[11]-body_y[8])*(hands_y[11]-body_y[10]),  11],
                        [(hands_y[10]-body_y[5])*(hands_y[10]-body_y[0])*(hands_y[10]-body_y[8])*(hands_y[10]-body_y[10]),  10],
                        #ring
                        [(hands_y[16]-body_y[5])*(hands_y[16]-body_y[0])*(hands_y[16]-body_y[8])*(hands_y[16]-body_y[10]),  16],
                        [(hands_y[15]-body_y[5])*(hands_y[15]-body_y[0])*(hands_y[15]-body_y[8])*(hands_y[15]-body_y[10]),  15],
                        [(hands_y[14]-body_y[5])*(hands_y[14]-body_y[0])*(hands_y[14]-body_y[8])*(hands_y[14]-body_y[10]),  14],
                        #pinky
                        [(hands_y[20]-body_y[5])*(hands_y[20]-body_y[0])*(hands_y[20]-body_y[8])*(hands_y[20]-body_y[10]),  20],
                        [(hands_y[19]-body_y[5])*(hands_y[19]-body_y[0])*(hands_y[19]-body_y[8])*(hands_y[19]-body_y[10]),  19],
                        [(hands_y[18]-body_y[5])*(hands_y[18]-body_y[0])*(hands_y[18]-body_y[8])*(hands_y[18]-body_y[10]),  18]
                    ]
                    
                    points_face_ZRight = [
                        #thumb 
                        [(hands_z[4]-body_z[5]) *(hands_z[4]-body_z[0]) *(hands_z[4]-body_z[8]) *(hands_z[4]-body_z[10]),    4],
                        [(hands_z[3]-body_z[5]) *(hands_z[3]-body_z[0]) *(hands_z[3]-body_z[8]) *(hands_z[3]-body_z[10]),    3],
                        [(hands_z[2]-body_z[5]) *(hands_z[2]-body_z[0]) *(hands_z[2]-body_z[8]) *(hands_z[2]-body_z[10]),    2],
                        #index
                        [(hands_z[8]-body_z[5]) *(hands_z[8]-body_z[0]) *(hands_z[8]-body_z[8]) *(hands_z[8]-body_z[10]),    8],
                        [(hands_z[7]-body_z[5]) *(hands_z[7]-body_z[0]) *(hands_z[7]-body_z[8]) *(hands_z[7]-body_z[10]),    7],
                        [(hands_z[6]-body_z[5]) *(hands_z[6]-body_z[0]) *(hands_z[6]-body_z[8]) *(hands_z[6]-body_z[10]),    6],
                        #middle
                        [(hands_z[12]-body_z[5])*(hands_z[12]-body_z[0])*(hands_z[12]-body_z[8])*(hands_z[12]-body_z[10]),  12],
                        [(hands_z[11]-body_z[5])*(hands_z[11]-body_z[0])*(hands_z[11]-body_z[8])*(hands_z[11]-body_z[10]),  11],
                        [(hands_z[10]-body_z[5])*(hands_z[10]-body_z[0])*(hands_z[10]-body_z[8])*(hands_z[10]-body_z[10]),  10],
                        #ring
                        [(hands_z[16]-body_z[5])*(hands_z[16]-body_z[0])*(hands_z[16]-body_z[8])*(hands_z[16]-body_z[10]),  16],
                        [(hands_z[15]-body_z[5])*(hands_z[15]-body_z[0])*(hands_z[15]-body_z[8])*(hands_z[15]-body_z[10]),  15],
                        [(hands_z[14]-body_z[5])*(hands_z[14]-body_z[0])*(hands_z[14]-body_z[8])*(hands_z[14]-body_z[10]),  14],
                        #pinky
                        [(hands_z[20]-body_z[5])*(hands_z[20]-body_z[0])*(hands_z[20]-body_z[8])*(hands_z[20]-body_z[10]),  20],
                        [(hands_z[19]-body_z[5])*(hands_z[19]-body_z[0])*(hands_z[19]-body_z[8])*(hands_z[19]-body_z[10]),  19],
                        [(hands_z[18]-body_z[5])*(hands_z[18]-body_z[0])*(hands_z[18]-body_z[8])*(hands_z[18]-body_z[10]),  18]
                    ]
