...
class RosRobotClient:
    ...
    class SequenceBuilder(ISequenceBuilder):
        ...
        def __exit__(
            ...
            if self.robot is not None:
                self.robot.execute_sequence(self)
    ...
    def _call_service(
        ...
        timeout: Union[int, float] = 180,  # 3 minutes.
    ) -> Any:
    ...
    def _call_service_async(
        ...
        service_name: str,
        service_type: str,
        callback: Callable[[Any, Any], None],  # callback: fn (result, error) -> None
        request: Any = roslibpy.ServiceRequest(),
    ) -> Any:
        service = roslibpy.Service(self.client, service_name, service_type)
        return service.call(
            request,
            (lambda result: callback(result, None)),
            (lambda error: callback(None, error)),
        )
    ...
    def on_state_change(
        ...
        def _handler(data: Dict):
            callback(
                RobotOperationalState(data["operational_state"]), data["safety_state"]
            )
    ...
    def reset(self) -> Dict:
        ...
        return self._call_service(
            ...
            "robot_commands_api/ResetRobotState",
            dict(),
            timeout=15,
        )
    ...
    def set_tcp_offset(self, tcp_offset, order="XYZ") -> Any:
        ...
        return self._call_service(
            ...
            "generic_robot_type_commands/SetTCPOffset",
    ...
    def get_joint_positions(self) -> JointAnglesDegrees:
        lRadPosition: List[float] = self._call_service(
            ...
            "robot_commands_api/GetCurrentPosJ",
        )["position"]
    ...
    def get_cartesian_position(self) -> CartesianPose:
        lPosition = self._call_service(
            ...
            "robot_commands_api/GetCurrentPosX",
        )["position"]
    ...
    def start_teach_mode(self):
        return self._call_service(
            ...
            "robot_commands_api/SetManualMode",
        )
    ...
    def _move_sequence(self, move_messages: List[Dict]):
        return self._call_service(
            PublicAPI.Service.MoveSequence,
            "generic_robot_type_commands/MoveSequence",
    ...
    def forward_kinematics(
        ...
        fk_result = self._call_service(
            ...
            "generic_robot_type_commands/ForwardKinematics",
    ...
    def inverse_kinematics(
        ...
        ik_result = self._call_service(
            ...
            "generic_robot_type_commands/InverseKinematics",
    ...
    def get_cartesian_velocity_limit(self) -> MillimetersPerSecond:
        ...
        return (
            self._call_service(
                ...
                "generic_robot_type_commands/GetCartesianLimit",
            )["cartesian_limit"]
            * 1000.0
        )
    ...
    def get_joint_velocity_limit(self) -> DegreesPerSecondVector:
        ...
        return Utils.to_degrees(
            self._call_service(
                ...
                "generic_robot_type_commands/GetJointLimits",
            )["joint_limits"]
        )
    ...
    def set_tool_digital_output(self, pin: int, value: int):
        return self._call_service(
            ...
            "specific_robot_type_commands/SetDigitalIO",
    ...
    def get_tool_digital_input(self, pin: int) -> bool:
        return (
            self._call_service(
                ...
                "specific_robot_type_commands/GetDigitalIO",
                dict(index=pin),
            )["value"]
            == 1
        )
    ...
    def move_stop(self) -> bool:
        response = self._call_service(
            PublicAPI.Service.MoveStop, "robot_commands_api/MoveControl"
        )
