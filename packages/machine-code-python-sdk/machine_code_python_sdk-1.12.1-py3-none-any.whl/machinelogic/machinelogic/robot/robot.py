...
class RosRobotSingleton:
    ...
    def get_instance(
        ...
        if RosRobotSingleton.__instance is None:
            ...
            RosRobotSingleton.__instance = RosRobot(
...
class RobotState(IRobotState):
    def __init__(self, ros_robot: RosRobot):
        self._ros_robot: RosRobot = ros_robot
...
class Robot(IRobot):
    ...
    def __init__(self, configuration: RobotConfiguration, api: Api):
        ...
        self._robot: RosRobot = RosRobotSingleton.get_instance(
    ...
    def create_sequence(self) -> RosRobot.SequenceBuilder:
