...
class NumericalOrbitalTransferRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["missionDateTime", "maximumDuration", "propagationType", "spacecraft", "initialOrbit", "targetOrbit", "ephemerides", "meanEphemerides", "osculatingEphemerides"]
