...
class UpdatesToolSessionEventToolSessionElementUpdatedElementElement(BaseModel):
    ...
    id: str
    name: str
    graph_context: "UpdatesToolSessionEventToolSessionElementUpdatedElementElementGraphContext" = Field(
        alias="graphContext"
    )
...
class UpdatesToolSessionEventToolSessionElementUpdatedElementButton(ButtonValue):
    ...
    id: str
    name: str
    graph_context: "UpdatesToolSessionEventToolSessionElementUpdatedElementButtonGraphContext" = Field(
        alias="graphContext"
    )
...
class UpdatesToolSessionEventToolSessionElementUpdatedElementHTMLElement(HTMLValue):
    ...
    id: str
    name: str
    graph_context: "UpdatesToolSessionEventToolSessionElementUpdatedElementHTMLElementGraphContext" = Field(
        alias="graphContext"
    )
...
class UpdatesToolSessionEventToolSessionElementUpdatedElementNumberField(
    ...
    id: str
    name: str
    graph_context: "UpdatesToolSessionEventToolSessionElementUpdatedElementNumberFieldGraphContext" = Field(
        alias="graphContext"
    )
...
class UpdatesToolSessionEventToolSessionElementUpdatedElementSliderElement(SliderValue):
    ...
    id: str
    name: str
    graph_context: "UpdatesToolSessionEventToolSessionElementUpdatedElementSliderElementGraphContext" = Field(
        alias="graphContext"
    )
...
class UpdatesToolSessionEventToolSessionElementUpdatedElementTextField(TextFieldValue):
    ...
    id: str
    name: str
    graph_context: "UpdatesToolSessionEventToolSessionElementUpdatedElementTextFieldGraphContext" = Field(
        alias="graphContext"
    )
