...
def run(
    ...
    **parameters,
    ...
    Args:
        ...
        udf_name: The name of the UDF to execute, if specifying by email.
        ...
        udf_email: The email associated with the UDF, if specifying by name.
    ...
    dispatch: dict[
        tuple[
            Literal["sync", "async"],
            Literal["tile", "file"],
            Literal["saved", "token", "local_udf", "local_job_step"],
        ...
        ("sync", "tile", "local_job_step", "local"): None,
        ("async", "tile", "local_job_step", "local"): None,
