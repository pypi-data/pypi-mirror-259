...
PROD_DEFAULT_BASE_URL = "https://app.fused.io/server/v1"
PREVIEW_DEFAULT_BASE_URL = "https://app-preview.fused.io/server/v1"
STAGING_DEFAULT_BASE_URL = "https://app-staging.fused.io/server/v1"
...
class Options(OptionsBaseModel):
    ...
    request_timeout: Union[Tuple[float, float], float, None] = 60
    """Request timeout for the Fused service

    May be set to a tuple of connection timeout and read timeout"""

    skip_import_validation: StrictBool = False
    """Always skip validating imports when validating UDFs before
    `run_local` or `run_remote`."""
