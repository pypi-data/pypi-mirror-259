...
from azureml.metrics.common.exceptions import OAIClientException, MissingDependencies
...
class StreamingGPTEndpoint(LLM[Iterable[str]]):
    ...
    def set_timeout(self, timeout_sec: float):
        raise Exception("Streaming endpoint does not support timeout")
...
def setup_llm(api_base: str,
    ...
    if api_base != "" and api_version != "":
        ...
        raise Exception("Please provide a valid api_base, api_version and deployment_id")
