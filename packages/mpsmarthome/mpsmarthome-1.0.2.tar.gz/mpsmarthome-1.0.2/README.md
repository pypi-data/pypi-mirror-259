...
import time
import mpsmarthome
from mpsmarthome.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to http://localhost
# See configuration.py for a list of all supported configuration parameters.
configuration = mpsmarthome.Configuration(
    host = "http://localhost"
)
...
async with mpsmarthome.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = mpsmarthome.HomeAssistantApi(api_client)
    auth_request = mpsmarthome.AuthRequest() # AuthRequest |  (optional)
