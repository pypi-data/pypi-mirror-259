...
import mpsmarthome.models
from mpsmarthome import rest
from mpsmarthome.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mpsmarthome.models, klass)
