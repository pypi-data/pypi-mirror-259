...
class concat:
    ...
    def __call__(
        ...
        schema = {
            "vis": {
                "type": "cReqPathVec",
                "coerce": [_coerce.to_list, _coerce.expand_pathvec],
            },
            "concatvis": {"type": "cStr", "coerce": _coerce.to_str},
            "freqtol": {"type": "cVariant", "coerce": [_coerce.to_variant]},
            "dirtol": {"type": "cVariant", "coerce": [_coerce.to_variant]},
            "respectname": {"type": "cBool"},
            "timesort": {"type": "cBool"},
            "copypointing": {"type": "cBool"},
            "visweightscale": {
                "type": "cFloatVec",
        ...
        _logging_state_ = _start_log(
            ...
            [
                ...
                "concatvis=" + repr(_pc.document["concatvis"]),
                "freqtol=" + repr(_pc.document["freqtol"]),
                "dirtol=" + repr(_pc.document["dirtol"]),
                "respectname=" + repr(_pc.document["respectname"]),
        ...
        task_result = None
        try:
            task_result = _concat_t(
                _pc.document["vis"],
                _pc.document["concatvis"],
                _pc.document["freqtol"],
                _pc.document["dirtol"],
                _pc.document["respectname"],
                _pc.document["timesort"],
                _pc.document["copypointing"],
                _pc.document["visweightscale"],
                _pc.document["forcesingleephemfield"],
            )
        except Exception as exc:
            _except_log("concat", exc)
            raise
        finally:
