...
def list_columns(
    ...
    if extended:
        ...
        df = df[[
            'Table Name', 'Column Name', 'Description', 'Type', 'Data Type',
            'Hidden', 'Format String', 'Source', 'Data Category', 'Display Folder',
            'Key', 'Unique', 'Sort By Column', 'Summarize By', 'Is Available in MDX',
            'Encoding Hint', 'State', 'Error Message', 'Modified Time',
