...
def plot_relationship_metadata(
    ...
    for r in metadata_df.to_dict(orient="records"):
        ...
        if include_columns == 'none':
            ...
            g.edge(f'{from_table}', f'{to_table}', color='black', colorscheme="accent8", **attrs)
        else:
            ...
            g.edge(f'{from_table}:{from_column}', f'{to_table}:{to_column}', color='black', colorscheme="accent8", **attrs)
