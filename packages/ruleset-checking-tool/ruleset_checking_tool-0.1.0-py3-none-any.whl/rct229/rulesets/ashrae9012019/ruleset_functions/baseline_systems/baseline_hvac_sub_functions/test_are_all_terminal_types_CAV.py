                    ...
                    "zones": [
                        {
                            "id": "zone 1",
                            "terminals": [
                                {"id": "terminal_1", "type": "CONSTANT_AIR_VOLUME"},
                                {"id": "terminal_2", "type": "VARIABLE_AIR_VOLUME"},
                                {"id": "terminal_3"},
                            ],
                        },
                    ],
...
def test__all_terminal_type_CAV():
    assert are_all_terminal_types_cav(TEST_RMD, ["terminal_1"]) == True


def test__not_all_terminal_type_CAV():
    assert are_all_terminal_types_cav(TEST_RMD, ["terminal_2"]) == False
