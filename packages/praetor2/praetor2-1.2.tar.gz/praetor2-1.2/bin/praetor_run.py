...
try:
    ...
    from praetor2 import praetor_settings
...
def generate_pipeline_id():
    ...
    '''
    try:
        proc1 = subprocess.Popen(['pip', 'show', 'praetor2'], stdout=subprocess.PIPE)
    except FileNotFoundError:
        try:
            proc1 = subprocess.Popen(['pip3', 'show', 'praetor2'], stdout=subprocess.PIPE)
        except FileNotFoundError:
            proc1 = subprocess.Popen(['pip2', 'show', 'praetor2'], stdout=subprocess.PIPE)
