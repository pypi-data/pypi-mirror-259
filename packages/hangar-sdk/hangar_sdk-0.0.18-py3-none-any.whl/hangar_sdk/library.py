...
class HangarGraph:
    ...
    def add(self, resource):
        ...
        for parent in resource._parents:
            self.graph.add_edge(parent.name, resource.name)
    ...
    def get_layers(self):
        #  Each node represents a resource. Each edge represents a dependency. 
        #  Return list of lists of resources such that they can be processed in parallel
        #  Each layer is a list of resources that can be processed in parallel
    ...
    def run_node_in_parallel(self,scope):

        #  Each node represents a resource. Each edge represents a dependency.
        #  get list of layers
        #  for each layer, run in parallel
        #  if mode is create, then use scope to create resources
        #  if mode is delete, then use scope to delete resources
        #  if mode is invoke, ignore
