...
from the headword page (eg, for German nouns, a user might be interested in
the plural form, which should always be learned with the noun), or users
...
2. Creation of a flag to indicate whether the audio file is probably a
pronunciation of the headword and not, say, an example expression (again
