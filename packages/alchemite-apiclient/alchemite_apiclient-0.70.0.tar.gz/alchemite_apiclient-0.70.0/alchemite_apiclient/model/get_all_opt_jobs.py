...
class GetAllOptJobs(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([bool, date, datetime, dict, float, int, list, str, none_type]): Array of job IDs.  # noqa: E501

        Keyword Args:
            value ([bool, date, datetime, dict, float, int, list, str, none_type]): Array of job IDs.  # noqa: E501
