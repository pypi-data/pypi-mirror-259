...
from .shared_defs import SegmentProperty, SegmentSpecLabel, \
    SegmentDataSpecLabel, SpecIdentifier
...
class SegmentSeriesSpecProtocol(Copyable, Protocol):
    ...
    @property
    def identifier(self) -> SegmentSpecLabel:
...
class SegmentDataSpecProtocol(SeriesSpecProtocol[SegmentDataSpecLabel, SegmentDataSpec], Protocol):
    """
    ...
    @property
    @abstractmethod
    def label(self) -> SegmentDataSpecLabel:
...
class SegmentSeriesContainerProtocol(Protocol[SSSpec]):
    ...
    @classmethod
    def of(cls, segment_specs: Mapping[SegmentSpecLabel, SSSpec], df: pd.DataFrame) -> Self: ...
    ...
    @abstractmethod
    def gen_interval_index(self, segment_label: SegmentSpecLabel, obj: StrIndexer) -> pd.MultiIndex: ...
    ...
    @abstractmethod
    def segment(self, df: TSContainer, by: SegmentSpecLabel, objs: StrIndexer = None) -> TSContainer: ...
