...
from mdata.core.shared_defs import SeriesFeatureLabel, ObservationTypeValue, \
    ObservationType, SpecLabel, ObservationSpecIdentifier, EventSpecLabel, MeasurementSpecLabel, Extension
...
class EventSpecific(Protocol):
    E: ObservationType = ObservationType.E
    observation_type: ClassVar[ObservationType] = E


@runtime_checkable
class MeasurementSpecific(Protocol):
    M: ObservationType = ObservationType.M
    observation_type: ClassVar[ObservationType] = M


class TimeseriesSpecProtocol(ObservationTypeSpecific, SeriesSpecProtocol[ObservationSpecIdentifier, ObservationSpec],
                             Protocol):
    """
...
class TimeseriesViewProtocol(ObservationTypeSpecific, SeriesViewProtocol[TSSpec], Protocol[TSSpec]):
    @abstractmethod
...
class TimeseriesContainerProtocol(ObservationTypeSpecific, SeriesContainerProtocol[TSSpec, TSView],
...
class MachineDataProtocol(SlimMapping[ObservationSpecIdentifier, ETSC | MTSC], Copyable,
    ...
    def create_observation_index_view(self,
        ...
        :param labels: one, or a selection of, observation labels
        """
        ...
