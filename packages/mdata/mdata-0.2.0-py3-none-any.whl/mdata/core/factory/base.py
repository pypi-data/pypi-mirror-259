...
from mdata.core.shared_defs import SpecLabel
...
class SpecFac(Generic[RawSpec, Spec]):
    constructors: dict[type, Callable[[SpecLabel, RawSpec], Spec]]
    ...
    def make(self, label: SpecLabel, base_spec: RawSpec) -> Spec:
