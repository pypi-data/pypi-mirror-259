...
class TestDataforseoLabsBingRankedKeywordsLiveResultInfo(unittest.TestCase):
    """DataforseoLabsBingRankedKeywordsLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsBingRankedKeywordsLiveResultInfo:
        """Test DataforseoLabsBingRankedKeywordsLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsBingRankedKeywordsLiveResultInfo`
        """
        model = DataforseoLabsBingRankedKeywordsLiveResultInfo()
        if include_optional:
            return DataforseoLabsBingRankedKeywordsLiveResultInfo(
                se_type = '',
                target = '',
                location_code = 56,
                language_code = '',
    ...
    def testDataforseoLabsBingRankedKeywordsLiveResultInfo(self):
        """Test DataforseoLabsBingRankedKeywordsLiveResultInfo"""
