...
class TestDataforseoLabsBingPageIntersectionLiveTaskInfo(unittest.TestCase):
    """DataforseoLabsBingPageIntersectionLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsBingPageIntersectionLiveTaskInfo:
        """Test DataforseoLabsBingPageIntersectionLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsBingPageIntersectionLiveTaskInfo`
        """
        model = DataforseoLabsBingPageIntersectionLiveTaskInfo()
        if include_optional:
            return DataforseoLabsBingPageIntersectionLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_bing_page_intersection_live_result_info.DataforseoLabsBingPageIntersectionLiveResultInfo(
                        se_type = '', 
                        pages = {
                            'key' : ''
                            }, 
                            ...
                            dataforseo_client.models.dataforseo_labs_page_intersection_live_item.DataforseoLabsPageIntersectionLiveItem(
                                ...
                                keyword_data = dataforseo_client.models.keyword_data.KeywordData(
                                    ...
                                    search_intent_info = dataforseo_client.models.search_intent_info.SearchIntentInfo(
                                        ...
                                        last_updated_time = '', ), ), 
                                intersection_result = {
                                    'key' : dataforseo_client.models.dataforseo_labs_base_serp_element_item.DataforseoLabsBaseSerpElementItem()
                                    }, )
                            ], )
                    ]
            )
    ...
    def testDataforseoLabsBingPageIntersectionLiveTaskInfo(self):
        """Test DataforseoLabsBingPageIntersectionLiveTaskInfo"""
