...
class TestDataforseoLabsAmazonRankedKeywordsLiveTaskInfo(unittest.TestCase):
    """DataforseoLabsAmazonRankedKeywordsLiveTaskInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsAmazonRankedKeywordsLiveTaskInfo:
        """Test DataforseoLabsAmazonRankedKeywordsLiveTaskInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsAmazonRankedKeywordsLiveTaskInfo`
        """
        model = DataforseoLabsAmazonRankedKeywordsLiveTaskInfo()
        if include_optional:
            return DataforseoLabsAmazonRankedKeywordsLiveTaskInfo(
                id = '',
                status_code = 56,
                status_message = '',
                time = '',
                ...
                result = [
                    dataforseo_client.models.dataforseo_labs_amazon_ranked_keywords_live_result_info.DataforseoLabsAmazonRankedKeywordsLiveResultInfo(
                        se_type = '', 
                        asin = '', 
                        location_code = 56, 
                        language_code = '', 
    ...
    def testDataforseoLabsAmazonRankedKeywordsLiveTaskInfo(self):
        """Test DataforseoLabsAmazonRankedKeywordsLiveTaskInfo"""
