...
class TestDataforseoLabsAmazonRankedKeywordsLiveResultInfo(unittest.TestCase):
    """DataforseoLabsAmazonRankedKeywordsLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsAmazonRankedKeywordsLiveResultInfo:
        """Test DataforseoLabsAmazonRankedKeywordsLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsAmazonRankedKeywordsLiveResultInfo`
        """
        model = DataforseoLabsAmazonRankedKeywordsLiveResultInfo()
        if include_optional:
            return DataforseoLabsAmazonRankedKeywordsLiveResultInfo(
                se_type = '',
                asin = '',
                location_code = 56,
                language_code = '',
    ...
    def testDataforseoLabsAmazonRankedKeywordsLiveResultInfo(self):
        """Test DataforseoLabsAmazonRankedKeywordsLiveResultInfo"""
