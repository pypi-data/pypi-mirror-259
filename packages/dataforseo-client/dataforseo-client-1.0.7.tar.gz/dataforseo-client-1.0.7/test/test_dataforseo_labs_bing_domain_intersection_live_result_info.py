...
class TestDataforseoLabsBingDomainIntersectionLiveResultInfo(unittest.TestCase):
    """DataforseoLabsBingDomainIntersectionLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataforseoLabsBingDomainIntersectionLiveResultInfo:
        """Test DataforseoLabsBingDomainIntersectionLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DataforseoLabsBingDomainIntersectionLiveResultInfo`
        """
        model = DataforseoLabsBingDomainIntersectionLiveResultInfo()
        if include_optional:
            return DataforseoLabsBingDomainIntersectionLiveResultInfo(
                se_type = '',
                target1 = '',
                target2 = '',
                location_code = 56,
    ...
    def testDataforseoLabsBingDomainIntersectionLiveResultInfo(self):
        """Test DataforseoLabsBingDomainIntersectionLiveResultInfo"""
