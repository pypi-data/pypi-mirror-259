...
class MerchantGoogleProductInfoTaskGetAdvancedResultInfo(BaseModel):
    ...
    items: Optional[List[MerchantBaseSerpElementItem]] = Field(default=None, description="items on the product page contains all product attributes and related data listed on the product page")
