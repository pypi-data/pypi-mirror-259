...
class AppDataGoogleAppReviewsTaskGetAdvancedResultInfo(BaseModel):
    ...
    items: Optional[List[AppDataBaseSerpElementItem]] = Field(default=None, description="found reviews you can get more results by using the depth parameter when setting a task")
