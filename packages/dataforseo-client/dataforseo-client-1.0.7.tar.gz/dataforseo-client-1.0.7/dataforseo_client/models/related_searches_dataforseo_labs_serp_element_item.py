...
class RelatedSearchesDataforseoLabsSerpElementItem(DataforseoLabsBaseSerpElementItem):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "se_type", "rank_group", "rank_absolute", "position", "xpath", "items"]
