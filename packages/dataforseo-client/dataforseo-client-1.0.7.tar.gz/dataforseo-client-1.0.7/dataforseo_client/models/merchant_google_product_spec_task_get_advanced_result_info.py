...
class MerchantGoogleProductSpecTaskGetAdvancedResultInfo(BaseModel):
    ...
    items: Optional[List[MerchantBaseSerpElementItem]] = Field(default=None, description="items on the product specification page contains all product attributes and related data listed on the product specification page")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [MerchantBaseSerpElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
