...
from dataforseo_client.models.business_data_base_serp_element_item import BusinessDataBaseSerpElementItem
from typing import Optional, Set
from typing_extensions import Self

class BusinessDataYelpSearchTaskGetResultInfo(BaseModel):
    """
    ...
    item_types: Optional[List[Optional[StrictStr]]] = Field(default=None, description="item types encountered in the result possible item types: yelp_search_organic, yelp_search_paid")
    ...
    items: Optional[List[BusinessDataBaseSerpElementItem]] = Field(default=None, description="Yelp search listing results you can get more results by using the depth parameter when setting a task")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [BusinessDataBaseSerpElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
