...
class BusinessDataBaseSerpElementItem(BaseModel):
    """
    BusinessDataBaseSerpElementItem
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]]:
        """Create an instance of BusinessDataBaseSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[Self, Self, Self, Self, Self, Self, Self, Self, Self, Self, Self]]:
        """Create an instance of BusinessDataBaseSerpElementItem from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("BusinessDataBaseSerpElementItem failed to lookup discriminator value from " +
...
BusinessDataBaseSerpElementItem.model_rebuild(raise_errors=False)
