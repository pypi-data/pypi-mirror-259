...
class BusinessDataYelpReviewsTaskGetResultInfo(BaseModel):
    """
    ...
    items: Optional[List[BusinessDataBaseSerpElementItem]] = Field(default=None, description="found reviews you can get more results by using the depth parameter when setting a task")
