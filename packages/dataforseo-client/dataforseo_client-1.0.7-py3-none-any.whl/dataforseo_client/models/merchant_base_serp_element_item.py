...
class MerchantBaseSerpElementItem(BaseModel):
    """
    MerchantBaseSerpElementItem
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Union[Self, Self, Self, Self, Self, Self, Self, Self]]:
        """Create an instance of MerchantBaseSerpElementItem from a JSON string"""
    ...
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[Self, Self, Self, Self, Self, Self, Self, Self]]:
        """Create an instance of MerchantBaseSerpElementItem from a dict"""
        ...
        if object_type:
            ...
            raise ValueError("MerchantBaseSerpElementItem failed to lookup discriminator value from " +
...
MerchantBaseSerpElementItem.model_rebuild(raise_errors=False)
