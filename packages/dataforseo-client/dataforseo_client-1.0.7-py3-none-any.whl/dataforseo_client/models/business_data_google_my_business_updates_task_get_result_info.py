...
class BusinessDataGoogleMyBusinessUpdatesTaskGetResultInfo(BaseModel):
    ...
    items: Optional[List[BusinessDataBaseSerpElementItem]] = Field(default=None, description="encountered item types types of search engine results encountered in the items array; possible item types: google_business_info")
