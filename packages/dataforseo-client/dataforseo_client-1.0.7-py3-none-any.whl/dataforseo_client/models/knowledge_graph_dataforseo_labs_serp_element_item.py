...
class KnowledgeGraphDataforseoLabsSerpElementItem(DataforseoLabsBaseSerpElementItem):
    """
    ...
    items: Optional[List[DataforseoLabsBaseSerpElementItem]] = Field(default=None, description="elements of search results found in SERP")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cid": obj.get("cid"),
            "items": [DataforseoLabsBaseSerpElementItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
