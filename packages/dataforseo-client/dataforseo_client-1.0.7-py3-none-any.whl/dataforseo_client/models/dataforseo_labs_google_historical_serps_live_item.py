...
class DataforseoLabsGoogleHistoricalSerpsLiveItem(BaseModel):
    ...
    items: Optional[List[DataforseoLabsBaseSerpElementItem]] = Field(default=None, description="additional items present in the element if there are none, equals null")
