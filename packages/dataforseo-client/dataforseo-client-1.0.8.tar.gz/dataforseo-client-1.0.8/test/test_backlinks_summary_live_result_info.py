...
class TestBacklinksSummaryLiveResultInfo(unittest.TestCase):
    """BacklinksSummaryLiveResultInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BacklinksSummaryLiveResultInfo:
        """Test BacklinksSummaryLiveResultInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BacklinksSummaryLiveResultInfo`
        """
        model = BacklinksSummaryLiveResultInfo()
        if include_optional:
            return BacklinksSummaryLiveResultInfo(
                target = '',
                first_seen = '',
                lost_date = '',
                rank = 56,
    ...
    def testBacklinksSummaryLiveResultInfo(self):
        """Test BacklinksSummaryLiveResultInfo"""
