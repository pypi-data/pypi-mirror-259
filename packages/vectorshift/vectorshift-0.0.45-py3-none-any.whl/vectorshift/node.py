...
class VectorStoreNode(NodeTemplate):
    ...
    def set_vectorstore(self, vectorstore_id:str, vectorstore_name:str, 
    ...
    def _to_json_rep(self, generic:bool=False):
        ...
        if (self.vectorstore_id or self.vectorstore_name) and not generic:
            if self._public_key is None or self._private_key is None:
                raise ValueError('VectorStoreNode: API key required to fetch Vector Store.')
            response = requests.get(
    ...
    def _from_json_rep(json_data:dict) -> 'VectorStoreNode':
        ...
        return VectorStoreNode(
            query_input=None,
            vectorstore_id=vectorstore_json.get('id', None),
            vectorstore_name=vectorstore_json.get('name', None),
