...
def open3d_draw_scenes(points, gt_boxes=None, gt_labels=None, pred_boxes=None, pred_labels=None, pred_scores=None, point_size=1, background_color=None, create_plane=True,
                       point_colors=None, create_coordinate=True):
    ...
    if gt_boxes is not None:
        gt_boxes_lineset_list = draw_box(gt_boxes, (1, 0, 0),gt_labels)
        o3d_model_list.extend(gt_boxes_lineset_list)

    if pred_boxes is not None:
        pred_boxes_lineset_list = draw_box(pred_boxes, (0, 1, 0), pred_labels, pred_scores)
        o3d_model_list.extend(pred_boxes_lineset_list)
        
    show_o3d_model(o3d_model_list, point_size, background_color)
...
def draw_box(gt_boxes, color=(1, 0, 0), labels=None, score=None):
    box_model_list = []
...
def show_pcd_from_points_by_open3d(points, point_size=1, background_color=None, colors=None, create_coordinate=True, create_plane=True):
    o3d_model_list = []
