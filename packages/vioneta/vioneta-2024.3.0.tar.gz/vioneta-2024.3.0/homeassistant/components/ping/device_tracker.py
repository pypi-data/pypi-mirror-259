...
async def async_setup_scanner(
    ...
    async def _run_import(_: Event) -> None:
        ...
        _LOGGER.debug(
            "Vioneta Agro successfully started, importing ping device tracker config entries now"
        )
    ...
    # delay the import until after Vioneta Agro has started and everything has been initialized,
