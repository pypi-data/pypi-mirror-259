...
# This entity description is deprecated and will be removed in Vioneta Agro 2024.7.0.
...
class BlockValveSwitch(ShellyBlockAttributeEntity, SwitchEntity):
    ...
    This class is deprecated and will be removed in Vioneta Agro 2024.7.0.
    """
