...
class Controller:
    ...
    def start_jump_frame(self) -> bool: ...  # return False if already jumping
    def end_jump_frame(self) -> bool: ...  # return False if not jumping
    def get_p_board(self) -> tuple[bool, int]: ...  # return (is_new_board, p_board)
    def run_code(self, asm_bytes: bytes, /) -> bool: ...  # only available when connected
    ...
    # use ReadProcessMemory & WriteProcessMemory when not connected or having not used before()
