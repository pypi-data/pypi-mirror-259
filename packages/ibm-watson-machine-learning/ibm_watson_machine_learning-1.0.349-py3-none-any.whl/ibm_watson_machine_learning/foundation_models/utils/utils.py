...
from ibm_watson_machine_learning.wml_client_error import WMLClientError, InvalidMultipleArguments
...
def get_custom_model_specs(credentials: dict = None,
                           ...
                           verify=None) -> dict:
    """Get details on available custom models
