...
def test_prompt_tuning_c(prompt_tuning_step, universal_step):
    ...
    prompt_tuning_step.deployment_creation_in_project()
    universal_step.response_from_deployment_inference()
    prompt_tuning_step.delete_deployments()
...
def test_prompt_tuning_da(prompt_tuning_step, universal_step):
    ...
    universal_step.get_model_details()
    universal_step.list_repository()
    prompt_tuning_step.deployment_creation_with_prompted_asset()
    universal_step.response_from_deployment_inference()
    prompt_tuning_step.delete_deployments_da()
    universal_step.delete_experiment()
    universal_step.delete_models()
