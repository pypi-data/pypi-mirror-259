...
class TestTextGeneration:
    ...
    def test_02_create_gpt_neox_model(self, credentials, project_id):
    ...
    def test_03_create_mt0_model(self, credentials, project_id):
    ...
    def test_04_create_mpt_7b_model(self, credentials, project_id):
    ...
    def test_05_create_flan_t5_model(self, credentials, project_id):
    ...
    def test_06_create_starcoder_model(self, credentials, project_id):
    ...
    def test_07_create_llama2_70b_chat_model(self, credentials, project_id):
    ...
    def test_08_create_granite_13b_instruct_model(self, credentials, project_id):
    ...
    def test_09_create_granite_13b_chat_model(self, credentials, project_id):
    ...
    def test_10_generate_text_with_raw_response(self, credentials, project_id):
    ...
    def test_11_generate_text_stream(self, credentials, project_id):
    ...
    def test_12_create_flan_t5_xl_model(self, credentials, project_id):
        model_id = ModelTypes.FLAN_T5_XL
        flan_t5_xl = Model(
            model_id=model_id,
            credentials=credentials,
    ...
    def test_13_generate_text_stream_with_raw_response(self, credentials, project_id):
        raw_response = True
        text_params = {
            GenParams.DECODING_METHOD: DecodingMethods.GREEDY,
            GenParams.MIN_NEW_TOKENS: 0,
    ...
    def test_13b_generate_async(self, credentials, project_id):
        model_id = ModelTypes.FLAN_UL2
        text_params = {
            GenParams.DECODING_METHOD: DecodingMethods.GREEDY,
            GenParams.MIN_NEW_TOKENS: 0,
    ...
    def test_14_tokenize_without_return_tokens(self, model_id, credentials, project_id):
    ...
    @pytest.mark.parametrize('model_id', available_models)
    def test_15_tokenize_with_return_tokens(self, model_id, credentials, project_id):
    ...
    @pytest.mark.parametrize('model_id', available_models)
    def test_16_tokenize_input_token(self, model_id, credentials, project_id):
    ...
    def test_17_create_elyza_japanese_llama_2_7b_instruct_model(self, credentials, project_id):
    ...
    def test_18_create_mixtral_8x7b_instruct_v01_q_model(self, credentials, project_id):
