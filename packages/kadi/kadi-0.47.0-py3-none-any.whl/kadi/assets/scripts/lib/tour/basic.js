  ...
  tour.push({
    ...
    steps: [
      ...
      },
      {
        id: 'template',
        attach: true,
        content: $t('Note that it is also possible to select an existing template when creating a new record. Templates facilitate the creation of records and other resources via the web interface and can be created similarly to records.'),
      },
      {
        id: 'submit',
        attach: true,
