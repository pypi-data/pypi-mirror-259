                ...
                if r and r.ok:
                    ...
                    for row in reader:
                        ...
                        if station:
                            ...
                            self.decodeValueFloat(station['t'], data, 'tre200s0')
                            self.decodeValueFloat(station['r'], data, 'gre000z0')
                            self.decodeValueFloat(station['hr'], data, 'ure200s0')
                            self.decodeValueFloat(station['dewp'], data, 'tde200s0')
                            self.decodeValueFloat(station['wind'], data, 'fu3010z0', 1.0/3.6)
                            self.decodeValueFloat(station['rain'], data, 'rre150z0')
                else:
                    error=True
