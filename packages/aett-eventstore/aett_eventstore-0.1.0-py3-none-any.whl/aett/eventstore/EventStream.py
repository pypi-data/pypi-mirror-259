...
class EventStream:
    ...
    def load(bucket_id: str,
             ...
             min_version: int = 0,
             max_version: int = 4_000_000_000) -> 'EventStream':
        """
    ...
    def __update__(self, event_store: ICommitEvents):
        ...
        commits = event_store.get(self.bucket_id, self.stream_id, version + 1, 4_000_000_000)
        self.__populate_stream__(version + 1, 4_000_000_000, commits)
