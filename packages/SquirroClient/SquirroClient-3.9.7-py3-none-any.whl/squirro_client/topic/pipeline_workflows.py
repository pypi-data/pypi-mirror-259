...
class PipelineWorkflowMixin:
    ...
    def rerun_pipeline_workflow(
        ...
        The above example will invoke rerun from index for the worklflow with id
        `Or0UiK-qROeE1x8kVlBZkQ` of the project with id `EcKKf_dxRe-xrCB8g1fGCg`, using
        only the 2 provided steps identified by their ids (steps are alredy part of the
        ...
        only on the items of a specific configured source).
        """
        headers = {"Content-Type": "application/json"}
