...
def test_jira_object_access(
    ...
    **kwargs,
    ...
    """
    Determines whether we can access a particular class of objects within jira. In general, this returns True
    ...
    Args:
        ...
        is_sprint (bool, optional): whether we are looking for sprint data. Defaults to False.
        ...
        return_attr (str): attribute to return in a list from the accessed objects.

    Returns:
        bool: whether access to the specified object type is available.
    """

    def _get_return_list(objs):
        return [getattr(obj, return_attr) for obj in objs] if return_objs else []
