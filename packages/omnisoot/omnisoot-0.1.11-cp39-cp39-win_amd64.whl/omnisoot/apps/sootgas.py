...
class SootGas(CSootGas):
    ...
    def init_by_cantera(self, cantera_gas):
        ...
        if cantera_gas.transport_model == "None":
            self.transport_type = "sutherland_air";
            print("Cantera solution object has no transport info. Switching to Sutherland model");
        else:
            self.transport_type = "mix";
        self.update_transport();
