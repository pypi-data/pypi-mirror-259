# -*- coding: utf-8 -*-
#
# PyStack3D documentation build configuration file, created by
...
project = 'Fitspy'
copyright = f'2023-{datetime.today().year}, The Fitspy development team'
...
version = fitspy.VERSION
# The full version, including alpha/beta/rc tags.
release = fitspy.VERSION
...
# html_logo = 'https://cea-metrocarac.github.io/fitspy/logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
# html_favicon = '_static/fitspy.ico'
...
latex_documents = [
    ('index', 'Fitspy.tex', 'Fitspy Documentation',
     'The Fitspy Developers', 'manual'),
]
...
man_pages = [
    ('index', 'fitspy', 'Fitspy Documentation',
     ['The Fitspy developers'], 1)
]
...
# Add the fitspy website to the intersphinx domains
# intersphinx_mapping = {'cupy': ('https://docs.cupy.dev/en/stable', None),
#                        'python': ('https://docs.python.org/3', None),
#                        'h5py': ('https://docs.h5py.org/en/stable', None),
#                        'fitspyweb': ('https://fitspy.org/', None),
