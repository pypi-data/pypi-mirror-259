...
# Static methods
    def ModelIdFromIndex(model_index, workflow_name=Oasys.gRPC.defaultArg):
        ...
        int
            integer
        """
        return Oasys.THIS._connection.classMethod(__class__.__name__, "ModelIdFromIndex", model_index, workflow_name)
    ...
    def ModelUnitSystemFromIndex(model_index, workflow_name=Oasys.gRPC.defaultArg):
        ...
        int
            integer
        """
        return Oasys.THIS._connection.classMethod(__class__.__name__, "ModelUnitSystemFromIndex", model_index, workflow_name)
    ...
    def ModelUserDataBuildFromIndex(model_index, workflow_name=Oasys.gRPC.defaultArg):
        ...
        -------
        """
        return Oasys.THIS._connection.classMethod(__class__.__name__, "ModelUserDataBuildFromIndex", model_index, workflow_name)
    ...
    def ModelUserDataFromIndex(model_index, workflow_name=Oasys.gRPC.defaultArg):
        ...
        dict
            Dict
        """
        return Oasys.THIS._connection.classMethod(__class__.__name__, "ModelUserDataFromIndex", model_index, workflow_name)
    ...
    def ModelUserDataProgramFromIndex(model_index, workflow_name=Oasys.gRPC.defaultArg):
        ...
        str
            string
        """
        return Oasys.THIS._connection.classMethod(__class__.__name__, "ModelUserDataProgramFromIndex", model_index, workflow_name)
    ...
    def ModelUserDataVersionFromIndex(model_index, workflow_name=Oasys.gRPC.defaultArg):
        ...
        -------
        """
        return Oasys.THIS._connection.classMethod(__class__.__name__, "ModelUserDataVersionFromIndex", model_index, workflow_name)
    ...
    def NumberOfSelectedModels(workflow_name=Oasys.gRPC.defaultArg):
        ...
        int
            integer
        """
        return Oasys.THIS._connection.classMethod(__class__.__name__, "NumberOfSelectedModels", workflow_name)
    ...
    def Refresh():
        ...
        None
            No return value
        """
        return Oasys.THIS._connection.classMethod(__class__.__name__, "Refresh")
    ...
    def WorkflowDefinitionFilename(workflow_name=Oasys.gRPC.defaultArg):
        ...
        str
            string
        """
        return Oasys.THIS._connection.classMethod(__class__.__name__, "WorkflowDefinitionFilename", workflow_name)
    ...
    def WriteToFile(user_data, output_filename, workflow_definition_filename, extra=Oasys.gRPC.defaultArg):
        ...
        None
            No return value
        """
        return Oasys.THIS._connection.classMethod(__class__.__name__, "WriteToFile", user_data, output_filename, workflow_definition_filename, extra)
