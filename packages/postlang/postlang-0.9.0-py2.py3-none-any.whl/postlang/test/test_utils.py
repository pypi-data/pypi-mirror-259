...
from postlang import utils

TEST_HOST = os.environ.get("POSTLANG_TEST_HOST")
assert TEST_HOST, "Before running test export POSTLANG_TEST_HOST"
TEST_API_KEY = os.environ.get("POSTLANG_TEST_API_KEY")
assert TEST_API_KEY, "Before running test export POSTLANG_TEST_API_KEY"
...
class TestUtils(unittest.TestCase):
    ...
    def test_remove_slash(self):
        self.assertEqual("http://postlang.org", utils.remove_trailing_slash("http://postlang.org/"))
        self.assertEqual("http://postlang.org", utils.remove_trailing_slash("http://postlang.org"))
