...
class Environment(_base.ConfigObject):
    ...
    def _create_precommand_on_login_node(self) -> t.Optional[str]:
        ...
        joined_str = "; ".join(
            filter(None, [precommand, self._create_modules_command()])
        )
    ...
    def _create_excution_command_with_arguments(
    ...
    def to_unicore_job_description(self, arguments: str) -> t.Dict:
        ...
        return {
            **self.to_dict(),
            "Executable": self._create_excution_command_with_arguments(
                arguments
            ),
        }
        ...
        job_script = "\n".join(
            filter(
                ...
                [
                    ...
                    self._create_excution_command_with_arguments(
