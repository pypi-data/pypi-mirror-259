...
class GoogleSheetConnector(SisConnector):
    ...
    def __init__(
        ...
        self.__grades_names_mapping: dict[str, int] | None = None  # self.__fetch_grades_names_mapping_from_google_sheet(DEFAULT_GRADES_NAMES_MAPPING_SHEET_NAME)
        self.__languages_names_mapping: dict[str, Locale] | None = None  # self.__load_languages_names_mapping_from_default_csv_file()
        self.__nationalities_names_mapping: dict[str, Country] | None = None  # self.__load_nationalities_names_mapping_from_default_csv_file()
