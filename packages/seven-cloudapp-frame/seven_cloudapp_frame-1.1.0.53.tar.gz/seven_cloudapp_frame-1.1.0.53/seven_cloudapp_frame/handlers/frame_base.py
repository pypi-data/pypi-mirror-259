...
@LastEditTime: 2024-02-27 10:51:57
...
class FrameBaseHandler(FrameBaseApiHandler):
    ...
    def __decrypt_request_params(self, app_id, par, dv, encrypt_key):
        """
        :description: 解密请求参数
        :param app_id: app_id
        :param par: par
    ...
    def _convert_request_params(self):
        ...
        try:
            ...
            if self.is_api_encrypt() == True:
                ...
                invoke_result_data = self.__decrypt_request_params(app_id, self.request_params.get("par",""), self.request_params.get("dv",""), encrypt_key)
