...
class OutscraperClient:
    ...
    def webhook_url(self):
        return {
            "Staging": "https://api-staging.getreach.ai/webhooks/data-bridge/outscraper/scraper-completed",
            "Prod": "https://api.getreach.ai/webhooks/data-bridge/outscraper/scraper-completed",
        }.get(self.environment)
