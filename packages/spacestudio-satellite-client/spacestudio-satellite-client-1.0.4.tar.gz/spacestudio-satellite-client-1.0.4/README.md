...
# Defining the host is optional and defaults to https://app.beta.spacestudio.exotrail.space
# See configuration.py for a list of all supported configuration parameters.
configuration = spacestudio_satellite_client.Configuration(
    host = "https://app.beta.spacestudio.exotrail.space"
)
...
All URIs are relative to *https://app.beta.spacestudio.exotrail.space*
