...
class Orbit(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="The orbit type")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "scope", "type", "altitude", "inclination"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['CIRCULAR', 'CIRCULAR_SSO']):
            raise ValueError("must be one of enum values ('CIRCULAR', 'CIRCULAR_SSO')")
        return value
