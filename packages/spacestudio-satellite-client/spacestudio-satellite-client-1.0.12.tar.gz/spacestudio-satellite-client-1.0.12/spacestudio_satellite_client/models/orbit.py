...
class Orbit(BaseModel):
    ...
    is_sso: Optional[StrictBool] = Field(default=None, description="Is the orbit a Sun-Synchronous Orbit (SSO)", alias="isSSO")
    sso: Optional[StrictBool] = Field(default=None, description="Is the orbit a Sun-Synchronous Orbit (SSO)")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "scope", "isSSO", "sso", "inclination", "sma", "eccentricity", "parameters", "advancedParameters"]
