...
def get_skjema_by_id(self, *, skjema_id: int, context: SuvOperationContext = None) -> OperationResult:
    ...
    """
    try:
        content: str = client.get(path=f"{constants.SKJEMA_PATH}/{skjema_id}", context=context)
...
def create_skjema(
    ...
    try:
        ...
        content: str = client.post(path=constants.SKJEMA_PATH, body_json=body, context=context)
...
def delete_skjema(self, *, skjema_id: int, context: SuvOperationContext = None) -> OperationResult:
    ...
    """
    try:
        content: str = client.delete(path=f"{constants.SKJEMA_PATH}/{skjema_id}", context=context)
