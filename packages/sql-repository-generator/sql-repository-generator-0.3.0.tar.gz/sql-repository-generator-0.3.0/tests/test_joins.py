...
@pytest.mark.parametrize("source,destination,expected_joins", [
    ...
    (Webserver, Project, [Webserver.host, Host.project]),
    (Request, Project, [Request.webserver, Webserver.host, Host.project]),
    (VulnerabilityInstance, Project, [VulnerabilityInstance.request, Request.webserver, Webserver.host, Host.project]),
    (Request, VulnerabilityClass, [Request.vulnerabilities, VulnerabilityInstance.vulnerability_class]),
])
