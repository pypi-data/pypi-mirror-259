...
class OrganizationProfileLocal(GenericMapping):
    ...
    def insert_mapping_if_not_exists(self, organization_id: int, profile_id: int) -> int:
        logger.start(object={"organization_id": organization_id, "profile_id": profile_id})
        if self.is_link_exists(organization_id=organization_id, profile_id=profile_id):
            logger.info("The link already exists", extra={"organization_id": organization_id, "profile_id": profile_id})
    ...
    def is_link_exists(self, organization_id: int, profile_id: int) -> bool:
        logger.start(object={"organization_id": organization_id, "profile_id": profile_id})
        ...
        result = organization_profile_id_dict is not None
        logger.end(object={"result": result})
        return result
