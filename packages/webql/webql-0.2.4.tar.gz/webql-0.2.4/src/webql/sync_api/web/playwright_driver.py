...
from webql.sync_api.web.web_driver import WebDriver
...
class PlaywrightWebDriver(WebDriver[Locator, Page]):
    ...
    def get_user_session_state(self) -> StorageState:
    ...
    def _get_frame_accessibility_tree(
        ...
        content_frame_document_serialized = frame_context.evaluate(load_js("serialize_dom"))
    ...
    def _start_browser(
        ...
        self._context = self._browser.new_context(
            ...
            storage_state=user_session_extras,
        )
    ...
    def _determine_load_state(self, monitor: PageActivityMonitor, timeout_seconds=14):
        ...
        while True:
            try:
                last_updated_timestamp = self._current_page.evaluate(load_js("get_last_dom_change"))
