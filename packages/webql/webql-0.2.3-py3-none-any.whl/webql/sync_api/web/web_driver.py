...
from webql.async_api.web.web_driver import InteractiveItemTypeT, PageTypeT, ScrollDirection
...
class WebDriver(Protocol[InteractiveItemTypeT, PageTypeT]):
    ...
    def start_browser(self, user_session_extras=None):
        """Start the browser.
    ...
    def get_current_page(self) -> PageTypeT:
        ...
        Returns:
        PageItemTypeT: The current page.
        """
