...
class FHIRQuestionnaireRenderer extends StreamlitComponentBase {
  ...
  adjustFrameHeight() {
    const questionCount = this.props.args && this.props.args.questionaire && Array.isArray(this.props.args.questionaire.items) 
      ? this.props.args.questionaire.items.length 
      : 0;
    const questionHeight = 50; // Adjust this value based on your needs
    const submitButtonHeight = 50; // Adjust this value based on your needs
    const totalHeight = questionCount * questionHeight + submitButtonHeight;
