...
def my_NNSurrogate(my_Model, my_DesignSpace):
    return optimisation.NNSurrogate(my_Model, my_DesignSpace, set_id=0, debug=True)
...
def test_NNSurrogate_train_model_predict(my_NNSurrogate):
    ...
    expected_output = {
        "F": np.array(
            [[22.396518358255157], [19.882521893338144], [17.810392630436965]]
        ),
        "G": np.array(
            [
                [-22.78313438982879, 0.9745664293583953],
    ...
    x_in = np.array([[0.25, 0], [0.5, 0], [0.75, 0]])
    out_dict = {}
...
def test_NSSurrogate_reconstruct_recover_pts(my_NNSurrogate):
    ...
    expected_output = np.array(
        [
            [0.25000, 0.00000, 22.56250, 22.56250, 10.96875],
...
def my_KrigingSurrogate(my_Model, my_DesignSpace):
    return optimisation.KrigingSurrogate(
        my_Model, my_DesignSpace, set_id=0, kernel="rbf", debug=True
    )
...
def test_KrigingSurrogate_train_model_predict(my_KrigingSurrogate):
    ...
    expected_output = {
        "F": np.array(
            [[22.562512195037218], [20.250022440354236], [18.062502637980753]]
        ),
        "G": np.array(
            [
                [-22.5625121950372183, 0.9687476713857812],
...
def test_DirectOpt(my_Model, my_DirectOpt):
    ...
    expected_out = {
        ...
        "G": np.atleast_2d(
            (
                [
                    [0 - my_Model.run(*X)["con1"], my_Model.run(*X)["con2"] - 10]
                    for X in x_in
                ]
            )
        ),
            ...
            np.array(
                [
                    [
                        ...
                        4.9776166868405136e00,
                        0.0000000000000000e00,
                        5.0101270799563630e-04,
                        5.0101270799563630e-04,
                        -1.3883339405565653e00,
                    ],
                    [
                        4.0000000000000000e00,
                        5.0153314976974972e00,
                        0.0000000000000000e00,
                        2.3505482164836190e-04,
                        2.3505482164836190e-04,
                        -1.5767750158983098e00,
                    ],
                ]
            ),
        ),
        (
            ...
            np.array(
                [
                    [
                        2.0000000000000000e00,
                        4.9930717283301140e00,
                        0.0000000000000000e00,
                        4.8000948331744473e-05,
                        4.8000948331744473e-05,
                        -1.4653826421247356e00,
                    ],
                    [
                        4.0000000000000000e00,
                        5.0052569547100640e00,
                        0.0000000000000000e00,
                        2.7635572823664532e-05,
                        2.7635572823664532e-05,
                        -1.5262985913367313e00,
                    ],
                ]
            ),
        ),
        ...
        (
            ...
            np.array(
                [
                    [
                        2.0000000000000000e00,
                        4.9997891005059012e00,
                        0.0000000000000000e00,
                        4.4478596611131480e-08,
                        4.4478596611131480e-08,
                        -1.4989455247688035e00,
                    ],
                    [
                        4.0000000000000000e00,
                        5.0000005522770889e00,
                        0.0000000000000000e00,
                        3.0500998297896795e-13,
                        3.0500998297896795e-13,
                        -1.5000027613855966e00,
                    ],
                ]
            ),
        ),
...
def test_Optimisation_run(
    ...
    # to assert this precision
    assert (
        abs(my_DesignSpace.get_optimum_results().to_numpy() - expected_output) < 1e-2
    ).all()
