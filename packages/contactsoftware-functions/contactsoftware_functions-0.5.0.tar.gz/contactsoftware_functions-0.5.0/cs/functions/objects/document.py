...
class Document(BaseObject):
    ...
    # the execute handler (cs.functions.handler.execute) attaches the parts to the documents that reference them,
...
class CADDocument(Document):
    def __init__(self, object_type: str = ObjectType.CAD_DOCUMENT, **data):
        super().__init__(object_type=object_type, **data)
