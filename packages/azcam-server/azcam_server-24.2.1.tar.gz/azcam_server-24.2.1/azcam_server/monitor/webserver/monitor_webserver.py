...
class WebServer(object):
    ...
    def __init__(self):
        ...
        self.datafolder = azcam.db.monitor.datafolder
        ...
        # templates folder
        dd = "/azcam/azcam-server/azcam_server/monitor/webserver"  # flit exe changes folder!
    ...
    def web_command(self, command, qpars):
        ...
        try:
            ...
            print(e)
            reply = f"invalid API command: {command}"
