...
class EfsApi:
    ...
    @handler("CreateTags")
    def create_tags(
        self, context: RequestContext, file_system_id: FileSystemId, tags: Tags, **kwargs
    ) -> None:
    ...
    def delete_access_point(
        self, context: RequestContext, access_point_id: AccessPointId, **kwargs
    ) -> None:
    ...
    def delete_mount_target(
        self, context: RequestContext, mount_target_id: MountTargetId, **kwargs
    ) -> None:
    ...
    def delete_replication_configuration(
        self, context: RequestContext, source_file_system_id: FileSystemId, **kwargs
    ) -> None:
    ...
    @handler("DeleteTags")
    def delete_tags(
        self, context: RequestContext, file_system_id: FileSystemId, tag_keys: TagKeys, **kwargs
    ) -> None:
    ...
    def put_account_preferences(
        self, context: RequestContext, resource_id_type: ResourceIdType, **kwargs
    ...
    @handler("TagResource")
    def tag_resource(
        self, context: RequestContext, resource_id: ResourceId, tags: Tags, **kwargs
    ) -> None:
    ...
    def untag_resource(
        self, context: RequestContext, resource_id: ResourceId, tag_keys: TagKeys, **kwargs
    ) -> None:
