...
class CacheHealthMetricsConfig(str):
    ENABLED = "ENABLED"
    DISABLED = "DISABLED"
...
class OperationLevelMetricsConfig(str):
    ENABLED = "ENABLED"
    DISABLED = "DISABLED"
