...
class AssessmentReportType(str):
    pdf = "pdf"
    csv = "csv"
...
class CannedAclForObjectsValue(str):
    none = "none"
    private = "private"
...
class DataFormatValue(str):
    csv = "csv"
    parquet = "parquet"


class DatabaseMode(str):
    default = "default"
    babelfish = "babelfish"


class DatePartitionDelimiterValue(str):
    SLASH = "SLASH"
...
class DatePartitionSequenceValue(str):
    YYYYMMDD = "YYYYMMDD"
...
class EncodingTypeValue(str):
    plain = "plain"
    plain_dictionary = "plain-dictionary"
    rle_dictionary = "rle-dictionary"


class EncryptionModeValue(str):
    sse_s3 = "sse-s3"
    sse_kms = "sse-kms"


class EndpointSettingTypeValue(str):
    string = "string"
    boolean = "boolean"
    integer = "integer"
    enum = "enum"
...
class KafkaSaslMechanism(str):
    scram_sha_512 = "scram-sha-512"
    plain = "plain"


class KafkaSecurityProtocol(str):
    plaintext = "plaintext"
...
class KafkaSslEndpointIdentificationAlgorithm(str):
    none = "none"
    https = "https"


class LongVarcharMappingType(str):
    wstring = "wstring"
    clob = "clob"
    nclob = "nclob"


class MessageFormatValue(str):
    json = "json"
...
class OriginTypeValue(str):
    SOURCE = "SOURCE"
    TARGET = "TARGET"


class ParquetVersionValue(str):
    parquet_1_0 = "parquet-1-0"
    parquet_2_0 = "parquet-2-0"


class PluginNameValue(str):
    no_preference = "no-preference"
    test_decoding = "test-decoding"
    pglogical = "pglogical"


class RedisAuthTypeValue(str):
    none = "none"
    auth_role = "auth-role"
...
class SslSecurityProtocolValue(str):
    plaintext = "plaintext"
    ssl_encryption = "ssl-encryption"
