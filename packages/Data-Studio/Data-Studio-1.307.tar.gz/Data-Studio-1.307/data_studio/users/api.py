...
@method_decorator(name='update', decorator=swagger_auto_schema(
    ...
    Save details for a specific user, such as their name or contact information, in Data Studio.
    """,
    manual_parameters=[
        openapi.Parameter(
            name='id',
...
@method_decorator(name='list', decorator=swagger_auto_schema(
        ...
        operation_description='List the users that exist on the Data Studio server.'
    ))
@method_decorator(name='create', decorator=swagger_auto_schema(
        tags=['Users'],
        operation_summary='Create new user',
        operation_description='Create a user in Data Studio.',
        request_body=UserSerializer
    ))
@method_decorator(name='retrieve', decorator=swagger_auto_schema(
        tags=['Users'],
        operation_summary='Get user info',
        operation_description='Get info about a specific Data Studio user, based on the user ID.',
        manual_parameters = [
            openapi.Parameter(
                name='id',
                type=openapi.TYPE_INTEGER,
...
@method_decorator(name='partial_update', decorator=swagger_auto_schema(
        ...
        operation_description="""
        Update details for a specific user, such as their name or contact information, in Data Studio.
        """,
        manual_parameters=[
            openapi.Parameter(
                name='id',
...
@method_decorator(name='destroy', decorator=swagger_auto_schema(
        ...
        operation_description='Delete a specific Data Studio user.',
        manual_parameters=[
            openapi.Parameter(
                name='id',
                type=openapi.TYPE_INTEGER,
