...
def parse_input_args(input_args):
    ...
    # ---------------------------------------------------------------------------
    root_parser.add_argument('--version', dest='version', action='store_true', help='Show Data Studio version')
    ...
    parser_login_init.add_argument('--email', help='Email address for login')
    parser_login_init.add_argument('--password', help='Password for login')
    parser_login_init.add_argument('project_name', help='Name of the project to initialize', type=project_name, nargs='?')
    
    parser_delete_project = subparsers.add_parser('delete_project', help='Delete a project', parents=[root_parser])
    parser_delete_project.add_argument('project_name', help='Name of the project to delete')
    # ---------------------------------------------------------------------------
