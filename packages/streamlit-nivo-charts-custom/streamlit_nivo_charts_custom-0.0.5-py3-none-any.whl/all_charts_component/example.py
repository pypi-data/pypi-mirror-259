...
data_ = [{
            ...
            'data': [
                {'x': 0,
                  'hero': 'Bruno',
                  'y': 4028.983785981628,
                  'Img': 'http://localhost:8502/app/static/heroes/Bruno.png'},
                {'x': 1,
                  'hero': 'Claude',
                  'y': 3044.7647153292955,
                  'Img': 'http://localhost:8502/app/static/heroes/Claude.png'},
                {'x': 2,
                  'hero': 'Clint',
                  'y': 1266.4786745074477,
                  'Img': 'http://localhost:8502/app/static/heroes/Clint.png'},
                {'x': 3,
                  'hero': 'Edith',
                  'y': 1014.2804345938944,
                  'Img': 'http://localhost:8502/app/static/heroes/Edith.png'},
                {'x': 4,
                  'hero': 'Granger',
                  'y': 4754.352070501903,
                  'Img': 'http://localhost:8502/app/static/heroes/Granger.png'},
                {'x': 5,
                  'hero': 'Hanabi',
                  'y': 1518.792057618723,
                  'Img': 'http://localhost:8502/app/static/heroes/Hanabi.png'},
                {'x': 6,
                  'hero': 'Irithel',
                  'y': 3322.4989238308485,
                  'Img': 'http://localhost:8502/app/static/heroes/Irithel.png'},
                {'x': 7,
                  'hero': 'Karrie',
                  'y': 4345.433910143908,
                  'Img': 'http://localhost:8502/app/static/heroes/Karrie.png'},
                {'x': 8,
                  'hero': 'Kimmy',
                  'y': 3258.6523651328207,
                  'Img': 'http://localhost:8502/app/static/heroes/Kimmy.png'},
                {'x': 9,
                  'hero': 'Layla',
                  'y': 9800.203011290123,
                  'Img': 'http://localhost:8502/app/static/heroes/Layla.png'},
                {'x': 10,
                  'hero': 'Lesley',
                  'y': 1847.759260757279,
                  'Img': 'http://localhost:8502/app/static/heroes/Lesley.png'},
                {'x': 11,
                  'hero': 'Melissa',
                  'y': 3432.9756480348074,
                  'Img': 'http://localhost:8502/app/static/heroes/Melissa.png'}
              ]
        }]
