...
class Apps:
    ...
    webauthn_redirect_allowed: Optional[bool] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('webauthn_redirect_allowed'), 'exclude': lambda f: f is Apps.UNSET }})
    ...
    webauth_enabled: Optional[bool] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('webauth_enabled'), 'exclude': lambda f: f is Apps.UNSET }})
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class GetAppsResponseBody:
    r"""List of apps"""
    apps: Optional[List[Apps]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('apps'), 'exclude': lambda f: f is None }})
...
class GetAppsResponse:
    ...
    object: Optional[GetAppsResponseBody] = dataclasses.field(default=None)
    r"""List of apps"""
