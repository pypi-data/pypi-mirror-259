...
class Action(Body):
    ...
    def insert_dts(self, table: str, dts: list[dict],
                   ...
                   auto_lie_class=None):
        lies = dts[0].keys()
        return self.insert(table, lies, [dt.values() for dt in dts],
                           in_hz=in_hz, auto_lie_class=auto_lie_class)
    ...
    def create_insert(self, table, dts: list[dict],
                      ...
                      auto_lie_class=None):
        lies = dts[0].keys()
        self.createTable(table, lies, colmap, key=key, hz=hz)
        self.insert(table, lies, [dt.values() for dt in dts],
                    in_hz=in_hz, auto_lie_class=auto_lie_class)
    ...
    def update(self, table, dt: dict, where: str):
        ...
        return self.in_run(sql, lies, dt.values())
