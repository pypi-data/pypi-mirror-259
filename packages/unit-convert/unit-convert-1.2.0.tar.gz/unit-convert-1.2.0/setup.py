...
setup(
    ...
    url = 'https://github.com/huntfx/unit-convert',
    download_url = 'https://github.com/huntfx/unit-convert/archive/{}.tar.gz'.format(version),
    project_urls={
        #'Documentation': 'https://github.com/huntfx/unit-convert/wiki',
