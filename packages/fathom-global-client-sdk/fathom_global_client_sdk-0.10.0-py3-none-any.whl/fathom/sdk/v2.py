...
class GeoJSONClient:
    ...
    @_load_geojson.register(os.PathLike)
    def _load_geojson_typed(
        self,
        geojson: os.PathLike,
    ) -> Dict:
        return json.loads(pathlib.Path(geojson).read_text())

    @_load_geojson.register(str)
    @_load_geojson.register(bytes)
    @_load_geojson.register(bytearray)
    def _load_geojson_typed(
        self,
    ...
    @_load_geojson.register(io.BufferedIOBase)
    @_load_geojson.register(io.TextIOBase)
    def _load_geojson_typed(
        self,
    ...
    def get_polygon(
        ...
        loaded_geojson = self._load_geojson(geojson)
