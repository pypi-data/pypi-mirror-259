...
import pyrogramx
from pyrogramx import __version__, __license__
from pyrogramx import enums
from pyrogramx import raw
from pyrogramx import utils
from pyrogramx.crypto import aes
from pyrogramx.errors import CDNFileHashMismatch
from pyrogramx.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound,
    ChannelPrivate,
    BadRequest,
)
from pyrogramx.handlers.handler import Handler
from pyrogramx.methods import Methods
from pyrogramx.session import Auth, Session
from pyrogramx.storage import FileStorage, MemoryStorage
from pyrogramx.types import User, TermsOfService
from pyrogramx.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pyrogramx.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pyrogramx.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError(
                    ...
                    "More info: https://docs.pyrogramx.org/start/auth"
                )
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except pyrogramx.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
