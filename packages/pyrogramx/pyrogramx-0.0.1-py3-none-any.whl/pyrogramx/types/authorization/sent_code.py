...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~pyrogramx.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~pyrogramx.Client.sign_in` or :meth:`~pyrogramx.Client.sign_up`).

        next_type (:obj:`~pyrogramx.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~pyrogramx.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~pyrogramx.Client.resend_code`.
    """
