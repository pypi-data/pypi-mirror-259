...
class OnChatMemberUpdated:
    def on_chat_member_updated(self=None, filters=None, group: int = 0) -> Callable:
        ...
        :obj:`~pyrogramx.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramx.Client):
                self.add_handler(
                    pyrogramx.handlers.ChatMemberUpdatedHandler(func, filters), group
                )
                ...
                func.handlers.append(
                    (
                        pyrogramx.handlers.ChatMemberUpdatedHandler(func, self),
