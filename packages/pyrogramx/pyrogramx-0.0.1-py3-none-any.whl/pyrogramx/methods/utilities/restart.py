...
class Restart:
    async def restart(self: "pyrogramx.Client", block: bool = True):
        """Restart the Client.

        This method will first call :meth:`~pyrogramx.Client.stop` and then :meth:`~pyrogramx.Client.start` in a row in
        ...
        Returns:
            :obj:`~pyrogramx.Client`: The restarted client itself.
