...
import pyrogramx
from pyrogramx import raw, types
...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~pyrogramx.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~pyrogramx.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~pyrogramx.types.BotCommand`: On success, the list of bot commands is returned.
