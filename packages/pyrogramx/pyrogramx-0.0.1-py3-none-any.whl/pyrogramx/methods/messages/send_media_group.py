...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyrogramx.types.InputMediaPhoto`, :obj:`~pyrogramx.types.InputMediaVideo`, :obj:`~pyrogramx.types.InputMediaAudio` and :obj:`~pyrogramx.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyrogramx.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyrogramx.types import InputMediaPhoto, InputMediaVideo
