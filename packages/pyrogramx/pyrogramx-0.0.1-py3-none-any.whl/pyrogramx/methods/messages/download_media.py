...
from pyrogramx.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~pyrogramx.types.Message` | ``str``):
        ...
        Returns:
            ...
            :meth:`~pyrogramx.Client.stop_transmission`, None is returned.
