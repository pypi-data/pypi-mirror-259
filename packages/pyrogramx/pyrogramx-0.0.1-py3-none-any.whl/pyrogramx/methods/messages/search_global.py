...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyrogramx.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~pyrogramx.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyrogramx.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "pyrogramx". Get the first 50 results
                async for message in app.search_global("pyrogramx", limit=50):
                    print(message.text)
