...
from pyrogramx.connection import Connection
from pyrogramx.crypto import aes, rsa, prime
from pyrogramx.errors import SecurityCheckMismatch
from pyrogramx.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyrogramx.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
