...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pyrogramx.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pyrogramx.raw.base.PopularContact>`):
            N/A
