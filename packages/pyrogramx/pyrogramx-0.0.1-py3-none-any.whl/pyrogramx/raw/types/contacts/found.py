...
class Found(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results (List of :obj:`Peer <pyrogramx.raw.base.Peer>`):
            N/A

        results (List of :obj:`Peer <pyrogramx.raw.base.Peer>`):
            N/A
