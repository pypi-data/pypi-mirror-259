...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <pyrogramx.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <pyrogramx.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <pyrogramx.raw.base.WebDocument>`, *optional*):
            N/A
