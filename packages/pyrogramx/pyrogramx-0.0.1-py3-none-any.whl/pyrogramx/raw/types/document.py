...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <pyrogramx.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <pyrogramx.raw.base.VideoSize>`, *optional*):
            N/A
