...
class ForumTopic(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.ForumTopic`.
    ...
    Parameters:
        ...
        from_id (:obj:`Peer <pyrogramx.raw.base.Peer>`):
            N/A
        ...
        draft (:obj:`DraftMessage <pyrogramx.raw.base.DraftMessage>`, *optional*):
            N/A
