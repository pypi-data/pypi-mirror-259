...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <pyrogramx.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <pyrogramx.raw.base.PageRelatedArticle>`):
            N/A
