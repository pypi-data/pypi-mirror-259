...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <pyrogramx.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <pyrogramx.raw.base.ExportedChatlistInvite>`):
            N/A
