...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <pyrogramx.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <pyrogramx.raw.base.Peer>`):
            N/A
