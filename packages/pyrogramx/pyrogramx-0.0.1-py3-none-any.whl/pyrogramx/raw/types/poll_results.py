...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <pyrogramx.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <pyrogramx.raw.base.MessageEntity>`, *optional*):
            N/A
