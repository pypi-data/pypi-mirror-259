...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <pyrogramx.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <pyrogramx.raw.base.auth.CodeType>`, *optional*):
            N/A
