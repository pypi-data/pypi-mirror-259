...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <pyrogramx.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <pyrogramx.raw.base.PhoneConnection>`):
            N/A
