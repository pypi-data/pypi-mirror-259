...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <pyrogramx.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <pyrogramx.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <pyrogramx.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <pyrogramx.raw.base.InputDocument>`, *optional*):
            N/A
