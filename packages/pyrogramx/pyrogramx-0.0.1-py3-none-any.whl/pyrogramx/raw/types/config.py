...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pyrogramx.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pyrogramx.raw.base.Reaction>`, *optional*):
            N/A
