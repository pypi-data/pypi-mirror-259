...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <pyrogramx.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <pyrogramx.raw.base.Message>`):
            N/A
