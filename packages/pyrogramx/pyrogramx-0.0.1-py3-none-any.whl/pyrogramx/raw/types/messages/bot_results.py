...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <pyrogramx.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <pyrogramx.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <pyrogramx.raw.base.InlineBotWebView>`, *optional*):
            N/A
