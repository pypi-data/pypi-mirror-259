...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <pyrogramx.raw.base.SearchResultsPosition>`):
            N/A
