...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <pyrogramx.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <pyrogramx.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <pyrogramx.raw.base.PremiumSubscriptionOption>`):
            N/A
