...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <pyrogramx.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <pyrogramx.raw.base.GroupCallParticipant>`):
            N/A
