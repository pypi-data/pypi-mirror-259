...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <pyrogramx.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <pyrogramx.raw.base.VideoSize>`, *optional*):
            N/A
