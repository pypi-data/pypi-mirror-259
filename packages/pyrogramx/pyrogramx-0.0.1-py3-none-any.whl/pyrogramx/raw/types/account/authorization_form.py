...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pyrogramx.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pyrogramx.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <pyrogramx.raw.base.SecureValueError>`):
            N/A
