...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <pyrogramx.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <pyrogramx.raw.base.ThemeSettings>`, *optional*):
            N/A
