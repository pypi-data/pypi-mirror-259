...
class ChannelAdminLogEventActionParticipantToggleBan(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <pyrogramx.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <pyrogramx.raw.base.ChannelParticipant>`):
            N/A
