...
class ChatInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.ChatInvite`.
    ...
    Parameters:
        ...
        photo (:obj:`Photo <pyrogramx.raw.base.Photo>`):
            N/A
        ...
        participants (List of :obj:`User <pyrogramx.raw.base.User>`, *optional*):
            N/A
