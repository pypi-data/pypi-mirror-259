...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyrogramx.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <pyrogramx.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <pyrogramx.raw.base.MessagePeerReaction>`, *optional*):
            N/A
