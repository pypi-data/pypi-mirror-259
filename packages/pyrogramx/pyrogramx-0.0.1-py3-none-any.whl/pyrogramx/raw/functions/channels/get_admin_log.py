...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        channel (:obj:`InputChannel <pyrogramx.raw.base.InputChannel>`):
            N/A
        ...
        events_filter (:obj:`ChannelAdminLogEventsFilter <pyrogramx.raw.base.ChannelAdminLogEventsFilter>`, *optional*):
            N/A

        admins (List of :obj:`InputUser <pyrogramx.raw.base.InputUser>`, *optional*):
            N/A

    Returns:
        :obj:`channels.AdminLogResults <pyrogramx.raw.base.channels.AdminLogResults>`
    """
