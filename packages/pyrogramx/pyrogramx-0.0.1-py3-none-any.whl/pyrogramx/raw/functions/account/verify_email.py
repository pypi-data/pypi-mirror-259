...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <pyrogramx.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <pyrogramx.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <pyrogramx.raw.base.account.EmailVerified>`
    """
