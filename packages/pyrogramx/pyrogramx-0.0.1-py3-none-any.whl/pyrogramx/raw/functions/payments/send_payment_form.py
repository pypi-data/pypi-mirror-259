...
class SendPaymentForm(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        credentials (:obj:`InputPaymentCredentials <pyrogramx.raw.base.InputPaymentCredentials>`):
            N/A
    ...
    Returns:
        :obj:`payments.PaymentResult <pyrogramx.raw.base.payments.PaymentResult>`
    """
