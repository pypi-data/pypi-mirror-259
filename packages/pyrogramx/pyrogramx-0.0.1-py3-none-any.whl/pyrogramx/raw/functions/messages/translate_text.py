...
class TranslateText(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        peer (:obj:`InputPeer <pyrogramx.raw.base.InputPeer>`, *optional*):
            N/A

        id (List of ``int`` ``32-bit``, *optional*):
            N/A

        text (List of :obj:`TextWithEntities <pyrogramx.raw.base.TextWithEntities>`, *optional*):
            N/A

    Returns:
        :obj:`messages.TranslatedText <pyrogramx.raw.base.messages.TranslatedText>`
    """
