...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <pyrogramx.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <pyrogramx.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <pyrogramx.raw.base.messages.Messages>`
    """
