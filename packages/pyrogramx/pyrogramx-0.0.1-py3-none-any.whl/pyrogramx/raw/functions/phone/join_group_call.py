...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <pyrogramx.raw.base.InputGroupCall>`):
            N/A

        join_as (:obj:`InputPeer <pyrogramx.raw.base.InputPeer>`):
            N/A

        params (:obj:`DataJSON <pyrogramx.raw.base.DataJSON>`):
            N/A
