...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <pyrogramx.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <pyrogramx.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <pyrogramx.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <pyrogramx.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <pyrogramx.raw.base.photos.Photo>`
    """
