...
class Filter:
    async def __call__(self, client: "pyrogramx.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyrogramx.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from.
            For example, in a :obj:`~pyrogramx.handlers.MessageHandler` the *update* argument will be a :obj:`~pyrogramx.types.Message`; in a :obj:`~pyrogramx.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyrogramx.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyrogramx.filters.command` or :meth:`~pyrogramx.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyrogramx.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyrogramx.types.Dice` objects."""
...
def command(
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyrogramx.types.Message`.
    ...
    async def func(flt, client: pyrogramx.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyrogramx.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyrogramx.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyrogramx.types.InlineQuery`: The filter will match ``query``.
