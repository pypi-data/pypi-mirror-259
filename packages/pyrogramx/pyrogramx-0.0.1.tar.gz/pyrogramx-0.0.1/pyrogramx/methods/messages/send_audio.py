...
import pyrogramx
from pyrogramx import StopTransmission, enums
from pyrogramx import raw
from pyrogramx import types
from pyrogramx import utils
from pyrogramx.errors import FilePartMissing
from pyrogramx.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~pyrogramx.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyrogramx.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyrogramx.Client.stop_transmission`, None is returned.
