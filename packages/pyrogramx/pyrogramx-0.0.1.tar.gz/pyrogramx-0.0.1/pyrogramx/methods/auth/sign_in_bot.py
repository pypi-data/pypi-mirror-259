...
from pyrogramx.errors import UserMigrate
...
class SignInBot:
    async def sign_in_bot(self: "pyrogramx.Client", bot_token: str) -> "types.User":
        ...
        Returns:
            :obj:`~pyrogramx.types.User`: On success, the bot identity is return in form of a user object.
