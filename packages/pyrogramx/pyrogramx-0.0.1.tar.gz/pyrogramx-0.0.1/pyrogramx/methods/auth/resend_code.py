...
class ResendCode:
    async def resend_code(
        self: "pyrogramx.Client", phone_number: str, phone_code_hash: str
    ) -> "types.SentCode":
        """Re-send the confirmation code using a different type.

        The type of the code to be re-sent is specified in the *next_type* attribute of the
        :obj:`~pyrogramx.types.SentCode` object returned by :meth:`send_code`.
        ...
        Returns:
            :obj:`~pyrogramx.types.SentCode`: On success, an object containing information on the re-sent confirmation
            code is returned.
