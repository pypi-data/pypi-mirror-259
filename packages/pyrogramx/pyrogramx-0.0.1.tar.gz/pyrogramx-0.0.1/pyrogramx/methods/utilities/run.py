...
import pyrogramx
from pyrogramx.methods.utilities.idle import idle


class Run:
    def run(self: "pyrogramx.Client", coroutine=None):
        """Start the client, idle the main script and finally stop the client.

        When calling this method without any argument it acts as a convenience method that calls
        :meth:`~pyrogramx.Client.start`, :meth:`~pyrogramx.idle` and :meth:`~pyrogramx.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`pyrogramx.compose`.
