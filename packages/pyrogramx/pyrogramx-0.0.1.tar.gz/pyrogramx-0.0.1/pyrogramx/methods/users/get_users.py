...
class GetUsers:
    async def get_users(
        self: "pyrogramx.Client", user_ids: Union[int, str, Iterable[Union[int, str]]]
        ...
        Returns:
            :obj:`~pyrogramx.types.User` | List of :obj:`~pyrogramx.types.User`: In case *user_ids* was not a list,
