...
class OnChatJoinRequest:
    def on_chat_join_request(self=None, filters=None, group: int = 0) -> Callable:
        ...
        :obj:`~pyrogramx.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyrogramx.Client):
                self.add_handler(
                    pyrogramx.handlers.ChatJoinRequestHandler(func, filters), group
                )
                ...
                func.handlers.append(
                    (
                        pyrogramx.handlers.ChatJoinRequestHandler(func, self),
