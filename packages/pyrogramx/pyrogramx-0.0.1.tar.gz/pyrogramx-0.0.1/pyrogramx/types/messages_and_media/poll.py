...
import pyrogramx
from pyrogramx import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~pyrogramx.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~pyrogramx.types.MessageEntity`, *optional*):
