...
from pyrogramx.errors import MessageIdsEmpty, PeerIdInvalid
from pyrogramx.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        reply_to_message (:obj:`~pyrogramx.types.Message`, *optional*):
        ...
        service (:obj:`~pyrogramx.enums.MessageServiceType`, *optional*):
        ...
        entities (List of :obj:`~pyrogramx.types.MessageEntity`, *optional*):
        ...
        audio (:obj:`~pyrogramx.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~pyrogramx.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~pyrogramx.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~pyrogramx.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~pyrogramx.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~pyrogramx.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~pyrogramx.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~pyrogramx.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~pyrogramx.types.VideoNote`, *optional*):
        ...
        contact (:obj:`~pyrogramx.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~pyrogramx.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~pyrogramx.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~pyrogramx.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~pyrogramx.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~pyrogramx.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_members (List of :obj:`~pyrogramx.types.User`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`~pyrogramx.types.User`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~pyrogramx.types.Photo`, *optional*):
        ...
        pinned_message (:obj:`~pyrogramx.types.Message`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`~pyrogramx.types.GameHighScore`, *optional*):
        ...
        via_bot (:obj:`~pyrogramx.types.User`):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <pyrogramx.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~pyrogramx.filters.command`.

        video_chat_scheduled (:obj:`~pyrogramx.types.VideoChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        video_chat_started (:obj:`~pyrogramx.types.VideoChatStarted`, *optional*):
            Service message: the voice chat started.

        video_chat_ended (:obj:`~pyrogramx.types.VideoChatEnded`, *optional*):
            Service message: the voice chat has ended.

        video_chat_members_invited (:obj:`~pyrogramx.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new members were invited to the voice chat.

        web_app_data (:obj:`~pyrogramx.types.WebAppData`, *optional*):
    ...
    async def get_media_group(self) -> List["types.Message"]:
        """Bound method *get_media_group* of :obj:`~pyrogramx.types.Message`.
        ...
        Returns:
            List of :obj:`~pyrogramx.types.Message`: On success, a list of messages of the media group is returned.
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_chat_action(self, action: "enums.ChatAction") -> bool:
        """Bound method *reply_chat_action* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~pyrogramx.types.Message`.
        ...
        Parameters:
            ...
            type (:obj`~pyrogramx.enums.PollType`, *optional*):
                Poll type, :obj:`~pyrogramx.enums.PollType.QUIZ` or :obj:`~pyrogramx.enums.PollType.REGULAR`.
                Defaults to :obj:`~pyrogramx.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~pyrogramx.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~pyrogramx.types.MessageEntity`):
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~pyrogramx.types.Message`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~pyrogramx.types.Message`.
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~pyrogramx.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~pyrogramx.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~pyrogramx.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~pyrogramx.types.Message`.
        ...
        Parameters:
            media (:obj:`~pyrogramx.types.InputMedia`):
    ...
    async def edit_reply_markup(
        ...
        """Bound method *edit_reply_markup* of :obj:`~pyrogramx.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~pyrogramx.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~pyrogramx.types.Message` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~pyrogramx.types.Message`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~pyrogramx.types.Message`.
        ...
        Returns:
            :obj:`~pyrogramx.types.Message`: On success, the copied message is returned.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~pyrogramx.types.Message`.
    ...
    async def click(
        ...
        """Bound method *click* of :obj:`~pyrogramx.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~pyrogramx.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def react(self, emoji: str = "", big: bool = False) -> bool:
        """Bound method *react* of :obj:`~pyrogramx.types.Message`.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~pyrogramx.types.Message`.
        ...
        Returns:
            :obj:`~pyrogramx.types.Poll`: On success, the poll with the retracted vote is returned.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~pyrogramx.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~pyrogramx.types.Message`.
        ...
        Returns:
            :obj:`~pyrogramx.types.Poll`: On success, the poll with the chosen option is returned.
    ...
    async def pin(
        ...
        """Bound method *pin* of :obj:`~pyrogramx.types.Message`.
        ...
        Returns:
            :obj:`~pyrogramx.types.Message`: On success, the service message is returned.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~pyrogramx.types.Message`.
