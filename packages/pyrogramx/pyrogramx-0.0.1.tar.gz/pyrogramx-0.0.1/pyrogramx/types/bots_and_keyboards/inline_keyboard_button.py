...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~pyrogramx.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~pyrogramx.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~pyrogramx.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~pyrogramx.types.CallbackGame`, *optional*):
