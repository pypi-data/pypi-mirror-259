...
with open("pyrogramx/__init__.py", encoding="utf-8") as f:
...
setup(
    name="pyrogramx",
    version=version,
    description="Elegant, modern and asynchronous Telegram MTProto API framework in Python for users and bots Forked From pyrogramx.org",
    long_description=readme,
    long_description_content_type="text/markdown",
    url="https://github.com/kalanakt",
    download_url="https://github.com/kalanakt/pyrogramx/releases/latest",
    author="Kalana Kt",
