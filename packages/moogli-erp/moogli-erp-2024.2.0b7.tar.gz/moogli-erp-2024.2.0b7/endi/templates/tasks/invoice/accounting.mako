        ...
        <% url=request.route_path('/export/treasury/invoices/{id}', id=invoice.id, _query={'force': True}) %>
            ...
            <div class='content_vertical_padding'>
                <span class="icon status valid"><svg>
                        <use href="${request.static_url('endi:static/icons/endi.svg')}#check"></use>
                    </svg></span>
            ...
            <div class='content_vertical_padding'>
                <a class='btn' href="${url}">
                    <svg>
                        <use href="${request.static_url('endi:static/icons/endi.svg')}#file-export"></use>
                    </svg>
            ...
            <div class='content_vertical_padding'>
                <span class="icon status neutral"><svg>
                        <use href="${request.static_url('endi:static/icons/endi.svg')}#clock"></use>
                    </svg></span>
