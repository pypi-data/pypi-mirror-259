...
from endi.interfaces import IPaymentStateManager
...
from endi.models.action_manager import ActionManager, Action
from endi.utils.strings import PAID_STATUS
from endi.utils.status_rendering import STATUS_ICON
...
def invoice_paid_status_callback(request, task: Invoice, **kw):
    ...
    """
    meilisearch.push_invoice(request, task)
    task.cache_acl()
    return task
