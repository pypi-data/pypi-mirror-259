...
from endi.forms.management.contributions import get_list_schema
...
from endi.utils.strings import short_month_name
from endi.views import BaseListView
from endi.views.admin.sale.accounting.invoice import MODULE_COLLECTION_URL
from endi.views.admin.sale.accounting.internalinvoice import (
    MODULE_COLLECTION_URL as INTERNAL_MODULE_COLLECTION_URL,
)
from endi.views.management.utils import get_active_companies_on_period
    ...
    def get_contributions_amounts_on_period(self, period_start, period_end):
        ...
        query = (
            ...
            .query(
                ...
                func.sum(AccountingOperation.balance).label("contribution_value"),
            )
...
class ContributionsManagementXlsView(ContributionsManagementView):
    """
    Export du tableau de suivi des contributions au format XLS
    """
