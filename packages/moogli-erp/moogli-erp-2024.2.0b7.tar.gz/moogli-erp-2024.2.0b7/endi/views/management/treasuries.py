...
from endi.forms.management.treasuries import get_list_schema
...
from endi.views.accounting.treasury_measures import TreasuryGridCompute
...
class TreasuriesManagementView(BaseListView):
    ...
    title = "Suivi des trésoreries des enseignes de la CAE"
