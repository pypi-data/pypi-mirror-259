...
from endi.views.invoices.invoice import InvoiceGeneralView
from endi.views.invoices.layout import InvoiceLayout
...
def includeme(config):
    ...
    config.add_tree_view(
        ...
        renderer="endi:plugins/sap_urssaf3p/templates/tasks/invoice/general.mako",
