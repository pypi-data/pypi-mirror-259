...
##### New version 1.4.6 allow easier and more complex processing of images from Opera Phenix Plus High-Content Screening System.
...
```
imgs, img_length, img_width = jimg.image_sequences(opera_coordinates)
```
...
```   
jimg.mage_concatenate(path_to_images, imgs, metadata, img_length, img_width, overlap, chanenls, n_thread) 
```
...
```
jimg.select_pictures(imgs, 'Images', 'selected_images', numbers_of_pictures, ['ch2'])
```
