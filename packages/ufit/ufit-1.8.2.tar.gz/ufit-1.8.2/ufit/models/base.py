...
from ufit import Dataset, Param, UFitError, backends, param
from ufit.plotting import DataPlotter
from ufit.result import MultiResult, Result
from ufit.utils import cached_property, get_chisqr
...
class Model:
    ...
    * is_modifier() - return bool whether the specific model is a "modifier"
    ...
    def add_params(self, **params):
        ...
        """
        for pname, initval in params.items():
            self.params.append(Param.from_init(pname, initval))
    ...
    def __init__(self, fcn, name=None, **init):
        ...
        if name is None:
            if fcn.__name__ != '<lambda>':
                ...
                name = ''
        pvs = self._init_params(name, inspect.getfullargspec(fcn)[0][1:], init)
...
class GlobalModel(Model):
    ...
    def fit(self, datas, **kw):  # pylint: disable=arguments-renamed
