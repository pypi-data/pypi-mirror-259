...
from ufit.qt import QDialog, QDialogButtonBox, QInputDialog, QListWidgetItem, \
    QMessageBox, QTextCursor, QWidget, pyqtSignal, pyqtSlot
...
class ModelBuilder(QWidget):
    ...
    def createUI(self):
        ...
        self.buttonBox.addButton('Check', QDialogButtonBox.ButtonRole.NoRole)
        self.buttonBox.addButton(QDialogButtonBox.StandardButton.Apply)
