...
from ufit.qt import QApplication, QDialogButtonBox, QFileDialog, QMainWindow, \
    QMessageBox, QSplitter, Qt, QWidget, pyqtSignal, pyqtSlot

from ufit.data import ImageData, Loader, data_formats
...
class DataLoader(QWidget):
    ...
    def createUI(self, standalone):
        ...
        self.buttonBox.addButton('Preview', QDialogButtonBox.ButtonRole.NoRole)
    ...
    def on_buttonBox_clicked(self, button):
        ...
        elif role == QDialogButtonBox.ButtonRole.NoRole:  # "preview"
            self.open_data()
        else:  # "open"
...
''')
    ...
    def set_template(self, dtempl, numor, silent=True):
        ...
        try:
            cols, _xguess, _yguess, _dyguess, _mguess, nmon = \
    ...
    def open_data(self, final=False):
        ...
        try:
            datas = self.loader.load_numors(
                numors, prec, xcol, ycol, dycol, mcol, mscale, floatmerge, filt)
        except Exception as e:
