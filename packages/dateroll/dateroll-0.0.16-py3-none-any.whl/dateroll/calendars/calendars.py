...
SAMPLE_DATA_PATH = ROOT_DIR / "sampledata" / "*.csv"
...
def load_sample_data():
    print(f"[dateroll] loading sample data")
    ...
    for file in files:
        ...
        with open(file) as f:
            ...
            ld = []
            for i in ls:
                dtime = parser.parse(i)
                dt = datetime.date(dtime.year, dtime.month, dtime.day)
                ld.append(dt)
            data[name] = ld
    return data
