...
class OrderApi(object):
    ...
    def get_order_by_field(self, store, **kwargs):  # noqa: E501
        ...
        :param str status: Order status, available options are: WAIT_BUYER_PAY, WAIT_SELLER_SEND_GOODS, WAIT_BUYER_CONFIRM_GOODS, TRADE_SUCCESS, TRADE_CLOSED, TRADE_REFUND, TRADE_PARTIAL_REFUND, TRADE_FAILED.
