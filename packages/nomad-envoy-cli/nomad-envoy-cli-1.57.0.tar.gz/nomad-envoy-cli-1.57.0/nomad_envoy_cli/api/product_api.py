...
class ProductApi(object):
    ...
    def get_products_by_field(self, store, **kwargs):  # noqa: E501
        ...
        :param str sku_id: SKU (platform) ID for product to get.
        :param str barcode: Barcode (merchant) for product to get.
    ...
    def get_products_by_field_with_http_info(self, store, **kwargs):  # noqa: E501
        ...
        all_params = ['store', 'product_id', 'sku_id', 'barcode', 'page_no', 'page_size', 'is_onsale', 'created_range', 'updated_range']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'product_id' in local_var_params and local_var_params['product_id'] is not None:  # noqa: E501
            query_params.append(('product_id', local_var_params['product_id']))  # noqa: E501
        if 'sku_id' in local_var_params and local_var_params['sku_id'] is not None:  # noqa: E501
            query_params.append(('sku_id', local_var_params['sku_id']))  # noqa: E501
