...
from scalifiai.mcs.metadata.main import Metadata
...
class ModelVersion(BaseSubModule, MCS):
    ...
    # TODO[VIMPORTANT] FIX THIS, IT IS NOT WORKING
    def fetch_model(self):
        ...
        for id in core_metadata_ids:
            ...
            data = metadata_instance.generate_download_url()
            ...
            resp = requests.get(url=data["presigned_get_url"], stream=True)
            if resp.status_code == 200:
