...
class Demux2(QObject):
    ...
    out_updated = pyqtSignal('PyQt_PyObject')
    in0_updated = pyqtSignal('PyQt_PyObject')
    in1_updated = pyqtSignal('PyQt_PyObject')
    ...
    def in0(self, arg):
        self.in0_updated.emit(arg)

    def in1(self, arg):
        self.in1_updated.emit(arg)
