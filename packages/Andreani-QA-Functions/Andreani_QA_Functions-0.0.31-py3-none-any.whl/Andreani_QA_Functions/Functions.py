...
class Functions(Parameters):
    ...
    def get_data_resource(self, key: str):
        ...
        if value is None:
            print(f"{Functions.color_message('YELLOW', 'ADVERTENCIA:')} La clave {key} consultada no existe en el diccionario de resources.")
        return value

    def get_data_cache(self, key: str):
        """
        ...
        if value is None:
            print(f"{Functions.color_message('YELLOW', 'ADVERTENCIA:')} La clave {key} consultada no existe en el diccionario de cache.")
        return value
    @staticmethod
