...
class Env_parser():
    ...
    def __init__(self,arg_parser=None,parsed_args=None,defaults=None):
        ...
        self.defaults = {
            ...
            'CNF_DEBUG': False,
            'CNF_VERBOSE': False,
            'CNF_TMP': p.expanduser(f'~/work/{__name__}'),
            'CNF_PRODUCTS': p.expanduser(f'~/data/{__name__}'),
        }
    ...
    def parse_env(self):
        ...
        # create list of bool args so they can be correctly set by env vars
        bools = []
    ...
    def push_env(self):
        ...
        for arg in ['CNF_SILENT','CNF_DEBUG','CNF_VERBOSE','CNF_TMP','CNF_PRODUCTS']:
            if arg in self.args.__dict__:
                os.environ[arg] = self.args[arg]
