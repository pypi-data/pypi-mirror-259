'''
The function below (rolling_window_sigma_clip) is taken from the source code for the fundamentals package: https://github.com/thespacedoctor/fundamentals/tree/master, however part of the package that this package won't use
