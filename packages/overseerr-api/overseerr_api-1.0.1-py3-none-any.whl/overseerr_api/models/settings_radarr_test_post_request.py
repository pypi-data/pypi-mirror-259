...
class SettingsRadarrTestPostRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SettingsRadarrTestPostRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SettingsRadarrTestPostRequest:
        """Create an instance of SettingsRadarrTestPostRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SettingsRadarrTestPostRequest.parse_obj(obj)

        _obj = SettingsRadarrTestPostRequest.parse_obj({
