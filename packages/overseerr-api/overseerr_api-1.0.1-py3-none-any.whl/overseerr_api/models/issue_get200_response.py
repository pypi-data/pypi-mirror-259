...
class IssueGet200Response(BaseModel):
    ...
    results: Optional[conlist(Issue)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IssueGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IssueGet200Response:
        """Create an instance of IssueGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IssueGet200Response.parse_obj(obj)

        _obj = IssueGet200Response.parse_obj({
