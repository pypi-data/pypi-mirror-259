...
class TelegramSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TelegramSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TelegramSettings:
        """Create an instance of TelegramSettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TelegramSettings.parse_obj(obj)

        _obj = TelegramSettings.parse_obj({
            "enabled": obj.get("enabled"),
            "options": TelegramSettingsOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None,
            "types": obj.get("types")
        })
        return _obj
