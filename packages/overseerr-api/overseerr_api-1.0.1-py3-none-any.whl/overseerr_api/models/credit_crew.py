...
class CreditCrew(BaseModel):
    ...
    __properties = ["adult", "backdropPath", "creditId", "department", "episodeCount", "firstAirDate", "genreIds", "id", "job", "mediaInfo", "mediaType", "name", "originCountry", "originalLanguage", "originalName", "originalTitle", "overview", "popularity", "posterPath", "releaseDate", "title", "video", "voteAverage", "voteCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreditCrew:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreditCrew:
        """Create an instance of CreditCrew from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreditCrew.parse_obj(obj)

        _obj = CreditCrew.parse_obj({
            "adult": obj.get("adult"),
