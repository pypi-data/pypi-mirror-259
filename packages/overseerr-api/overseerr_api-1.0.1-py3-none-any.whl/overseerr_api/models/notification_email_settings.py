...
class NotificationEmailSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotificationEmailSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotificationEmailSettings:
        """Create an instance of NotificationEmailSettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotificationEmailSettings.parse_obj(obj)

        _obj = NotificationEmailSettings.parse_obj({
            "enabled": obj.get("enabled"),
            "options": NotificationEmailSettingsOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None,
            "types": obj.get("types")
        })
        return _obj
