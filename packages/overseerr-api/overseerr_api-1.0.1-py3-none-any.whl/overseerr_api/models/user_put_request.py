...
class UserPutRequest(BaseModel):
    ...
    UserPutRequest
    """
    ids: Optional[conlist(StrictInt)] = None
    permissions: Optional[StrictInt] = None
    __properties = ["ids", "permissions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserPutRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserPutRequest:
        """Create an instance of UserPutRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserPutRequest.parse_obj(obj)

        _obj = UserPutRequest.parse_obj({
            "ids": obj.get("ids"),
