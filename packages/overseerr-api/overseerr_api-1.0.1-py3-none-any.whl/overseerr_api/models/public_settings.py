...
class PublicSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicSettings:
        """Create an instance of PublicSettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicSettings.parse_obj(obj)

        _obj = PublicSettings.parse_obj({
