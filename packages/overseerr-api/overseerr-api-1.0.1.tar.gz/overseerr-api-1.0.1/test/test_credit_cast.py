...
from overseerr_api.models.credit_cast import CreditCast  # noqa: E501

class TestCreditCast(unittest.TestCase):
    """CreditCast unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditCast:
        """Test CreditCast
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditCast`
        """
        model = CreditCast()  # noqa: E501
        if include_optional:
            return CreditCast(
                adult = True,
                backdrop_path = '',
