...
class TvResult(BaseModel):
    ...
    __properties = ["backdropPath", "firstAirDate", "genreIds", "id", "mediaInfo", "mediaType", "name", "originCountry", "originalLanguage", "originalName", "overview", "popularity", "posterPath", "voteAverage", "voteCount"]
