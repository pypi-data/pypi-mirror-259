...
class PushoverSettingsOptions(BaseModel):
    ...
    user_token: Optional[StrictStr] = Field(None, alias="userToken")
    __properties = ["accessToken", "sound", "userToken"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PushoverSettingsOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PushoverSettingsOptions:
        """Create an instance of PushoverSettingsOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PushoverSettingsOptions.parse_obj(obj)
