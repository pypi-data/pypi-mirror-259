...
class MediaGet200Response(BaseModel):
    ...
    results: Optional[conlist(MediaInfo)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MediaGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MediaGet200Response:
        """Create an instance of MediaGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MediaGet200Response.parse_obj(obj)

        _obj = MediaGet200Response.parse_obj({
            "page_info": PageInfo.from_dict(obj.get("pageInfo")) if obj.get("pageInfo") is not None else None,
            "results": [MediaInfo.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
