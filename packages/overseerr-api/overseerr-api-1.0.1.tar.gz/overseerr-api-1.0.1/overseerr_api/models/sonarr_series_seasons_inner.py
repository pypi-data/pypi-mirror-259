...
class SonarrSeriesSeasonsInner(BaseModel):
    ...
    __properties = ["monitored", "seasonNumber"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SonarrSeriesSeasonsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SonarrSeriesSeasonsInner:
        """Create an instance of SonarrSeriesSeasonsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SonarrSeriesSeasonsInner.parse_obj(obj)

        _obj = SonarrSeriesSeasonsInner.parse_obj({
