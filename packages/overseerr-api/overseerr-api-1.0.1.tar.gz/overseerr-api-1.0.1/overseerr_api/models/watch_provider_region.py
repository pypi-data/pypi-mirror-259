...
class WatchProviderRegion(BaseModel):
    ...
    __properties = ["english_name", "iso_3166_1", "native_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WatchProviderRegion:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WatchProviderRegion:
        """Create an instance of WatchProviderRegion from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WatchProviderRegion.parse_obj(obj)

        _obj = WatchProviderRegion.parse_obj({
