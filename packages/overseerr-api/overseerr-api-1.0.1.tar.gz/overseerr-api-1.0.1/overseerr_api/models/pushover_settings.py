...
class PushoverSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PushoverSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PushoverSettings:
        """Create an instance of PushoverSettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PushoverSettings.parse_obj(obj)

        _obj = PushoverSettings.parse_obj({
            "enabled": obj.get("enabled"),
            "options": PushoverSettingsOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None,
            "types": obj.get("types")
        })
        return _obj
