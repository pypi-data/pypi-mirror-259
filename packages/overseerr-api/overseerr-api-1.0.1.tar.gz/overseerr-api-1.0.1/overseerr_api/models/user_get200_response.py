...
class UserGet200Response(BaseModel):
    ...
    results: Optional[conlist(User)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserGet200Response:
        """Create an instance of UserGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserGet200Response.parse_obj(obj)

        _obj = UserGet200Response.parse_obj({
