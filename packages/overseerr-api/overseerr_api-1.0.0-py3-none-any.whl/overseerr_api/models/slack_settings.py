...
class SlackSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SlackSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SlackSettings:
        """Create an instance of SlackSettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SlackSettings.parse_obj(obj)

        _obj = SlackSettings.parse_obj({
            "enabled": obj.get("enabled"),
            "options": SlackSettingsOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None,
            "types": obj.get("types")
        })
        return _obj
