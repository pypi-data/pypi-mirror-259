...
class SlackSettingsOptions(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SlackSettingsOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SlackSettingsOptions:
        """Create an instance of SlackSettingsOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SlackSettingsOptions.parse_obj(obj)

        _obj = SlackSettingsOptions.parse_obj({
