...
class RegionsGet200ResponseInner(BaseModel):
    ...
    __properties = ["english_name", "iso_3166_1"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegionsGet200ResponseInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegionsGet200ResponseInner:
        """Create an instance of RegionsGet200ResponseInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegionsGet200ResponseInner.parse_obj(obj)

        _obj = RegionsGet200ResponseInner.parse_obj({
