...
class LunaSeaSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LunaSeaSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LunaSeaSettings:
        """Create an instance of LunaSeaSettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LunaSeaSettings.parse_obj(obj)

        _obj = LunaSeaSettings.parse_obj({
            "enabled": obj.get("enabled"),
            "options": LunaSeaSettingsOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None,
            "types": obj.get("types")
        })
        return _obj
