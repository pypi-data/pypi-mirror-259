...
class MovieDetailsCollection(BaseModel):
    ...
    __properties = ["backdropPath", "id", "name", "posterPath"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MovieDetailsCollection:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MovieDetailsCollection:
        """Create an instance of MovieDetailsCollection from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MovieDetailsCollection.parse_obj(obj)

        _obj = MovieDetailsCollection.parse_obj({
