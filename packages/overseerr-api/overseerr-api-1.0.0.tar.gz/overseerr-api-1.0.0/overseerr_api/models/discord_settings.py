...
class DiscordSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiscordSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiscordSettings:
        """Create an instance of DiscordSettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiscordSettings.parse_obj(obj)

        _obj = DiscordSettings.parse_obj({
            "enabled": obj.get("enabled"),
            "options": DiscordSettingsOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None,
            "types": obj.get("types")
        })
        return _obj
