...
class Issue(BaseModel):
    ...
    Issue
    """
    comments: Optional[conlist(IssueComment)] = None
    ...
    modified_by: Optional[User] = Field(None, alias="modifiedBy")
    __properties = ["comments", "createdBy", "id", "issueType", "media", "modifiedBy"]
