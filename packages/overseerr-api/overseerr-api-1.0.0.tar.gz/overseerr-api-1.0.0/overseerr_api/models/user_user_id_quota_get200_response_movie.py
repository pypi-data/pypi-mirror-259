...
class UserUserIdQuotaGet200ResponseMovie(BaseModel):
    ...
    __properties = ["days", "limit", "remaining", "restricted", "used"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserUserIdQuotaGet200ResponseMovie:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserUserIdQuotaGet200ResponseMovie:
        """Create an instance of UserUserIdQuotaGet200ResponseMovie from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserUserIdQuotaGet200ResponseMovie.parse_obj(obj)

        _obj = UserUserIdQuotaGet200ResponseMovie.parse_obj({
            "days": obj.get("days"),
            "limit": obj.get("limit"),
