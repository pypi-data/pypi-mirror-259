...
class TvTvIdRatingsGet200Response(BaseModel):
    ...
    __properties = ["criticsRating", "criticsScore", "title", "url", "year"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TvTvIdRatingsGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TvTvIdRatingsGet200Response:
        """Create an instance of TvTvIdRatingsGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TvTvIdRatingsGet200Response.parse_obj(obj)

        _obj = TvTvIdRatingsGet200Response.parse_obj({
