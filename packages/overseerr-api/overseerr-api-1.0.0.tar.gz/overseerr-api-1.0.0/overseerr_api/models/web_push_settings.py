...
class WebPushSettings(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebPushSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebPushSettings:
        """Create an instance of WebPushSettings from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebPushSettings.parse_obj(obj)

        _obj = WebPushSettings.parse_obj({
