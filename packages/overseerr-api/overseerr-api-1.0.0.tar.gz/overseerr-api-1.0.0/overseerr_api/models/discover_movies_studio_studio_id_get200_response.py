...
class DiscoverMoviesStudioStudioIdGet200Response(BaseModel):
    ...
    __properties = ["page", "results", "studio", "totalPages", "totalResults"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiscoverMoviesStudioStudioIdGet200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DiscoverMoviesStudioStudioIdGet200Response:
        """Create an instance of DiscoverMoviesStudioStudioIdGet200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiscoverMoviesStudioStudioIdGet200Response.parse_obj(obj)

        _obj = DiscoverMoviesStudioStudioIdGet200Response.parse_obj({
            "page": obj.get("page"),
