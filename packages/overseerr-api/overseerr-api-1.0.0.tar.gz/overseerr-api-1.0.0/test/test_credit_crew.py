...
from overseerr_api.models.credit_crew import CreditCrew  # noqa: E501

class TestCreditCrew(unittest.TestCase):
    """CreditCrew unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreditCrew:
        """Test CreditCrew
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreditCrew`
        """
        model = CreditCrew()  # noqa: E501
        if include_optional:
            return CreditCrew(
                adult = True,
                backdrop_path = '',
