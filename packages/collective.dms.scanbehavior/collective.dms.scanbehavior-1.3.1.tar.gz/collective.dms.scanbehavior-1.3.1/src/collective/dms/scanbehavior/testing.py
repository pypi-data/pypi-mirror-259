...
class CollectiveDmsScanbehaviorLayer(PloneSandboxLayer):
    ...
    PLONE_FIXTURE.products = (
            ...
            ('plone.app.dexterity', {'loadZCML': True}, ),
    ...
    def setUpZope(self, app, configurationContext):
        """Set up Zope."""
        # Load ZCML
        self.loadZCML(package=collective.dms.scanbehavior,
                      name='testing.zcml')
        z2.installProduct(app, 'collective.dms.scanbehavior')
    ...
    def tearDownZope(self, app):
        """Tear down Zope."""
        z2.uninstallProduct(app, 'collective.dms.scanbehavior')


FIXTURE = CollectiveDmsScanbehaviorLayer(
    name="FIXTURE"
    )
