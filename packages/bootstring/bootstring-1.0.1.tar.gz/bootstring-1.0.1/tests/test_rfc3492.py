import pytest
from bootstring import decode
from bootstring import encode

# sample strings from RFC3492, section 7.1.
TESTCASES = {
    ...
    "989aomsvi5e83db1d2a355cv1e0vak1dwrv93d5xbh15a0dt30a5jpsd879ccm6fea98c": "\uC138\uACC4\uC758\uBAA8\uB4E0\uC0AC\uB78C\uB4E4\uC774\uD55C\uAD6D\uC5B4\uB97C\uC774\uD574\uD55C\uB2E4\uBA74\uC5BC\uB9C8\uB098\uC88B\uC744\uAE4C",
    ...
    "TisaohkhngthchnitingVit-kjcr8268qyxafd2f1b9g": "\u0054\u1EA1\u0069\u0073\u0061\u006F\u0068\u1ECD\u006B\u0068\u00F4\u006E\u0067\u0074\u0068\u1EC3\u0063\u0068\u1EC9\u006E\u00F3\u0069\u0074\u0069\u1EBF\u006E\u0067\u0056\u0069\u1EC7\u0074",
    ...
    "MajiKoi5-783gue6qz075azm5e": "\u004D\u0061\u006A\u0069\u3067\u004B\u006F\u0069\u3059\u308B\u0035\u79D2\u524D",
...
@pytest.mark.parametrize("encoded,decoded", TESTCASES.items())
def test_decode(encoded, decoded):
    assert decode(encoded) == decoded


@pytest.mark.parametrize("encoded,decoded", TESTCASES.items())
def test_encode(encoded, decoded):
