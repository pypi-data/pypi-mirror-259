        ...
        for sid, vms in vm_list.items():
            ...
            for vm in vms:
                ...
                if average_cpu < 50 and avg_used_mem_percent < 50:
                    current_vm_price_per_hour = get_price(vm_location=current_vm_location, vm_size=current_vm_size,
                    ...
                    for size in available_sizes:
                        if (max_ideal_cpu_cores >= size.number_of_cores >= min_ideal_cpu_cores and
                            ...
                            # new_size_pricing
                            resized_vm_price_per_hour = get_price(vm_location=current_vm_location, vm_size=size.name,
                                                                  current_vm_linux=current_vm_linux)
