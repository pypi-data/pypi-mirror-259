...
import numpy
import typing
__all__ = ['AFTER', 'AUDIO', 'AudioConfig', 'AudioData', 'AudioDataRecord', 'BAROMETER', 'BEFORE', 'BLUETOOTH', 'BarometerConfigRecord', 'BarometerData', 'BluetoothBeaconConfigRecord', 'BluetoothBeaconData', 'CLOSEST', 'DEVICE_TIME', 'GPS', 'GpsConfigRecord', 'GpsData', 'HOST_TIME', 'IMAGE', 'IMU', 'ImageConfigRecord', 'ImageData', 'ImageDataRecord', 'MAGNETOMETER', 'MotionConfigRecord', 'MotionData', 'NOT_VALID', 'PixelFrame', 'RECORD_TIME', 'SensorConfiguration', 'SensorData', 'SensorDataType', 'TIME_CODE', 'TimeDomain', 'TimeQueryOptions', 'WPS', 'WifiBeaconConfigRecord', 'WifiBeaconData', 'get_sensor_data_type_name', 'get_time_domain_name', 'has_calibration', 'supports_host_time_domain']
class AudioConfig:
    """
...
class SensorConfiguration:
    ...
    def wps_configuration(self) -> WifiBeaconConfigRecord:
        ...
        """
class SensorData:
    def __init__(self, arg0: projectaria_tools.core.stream_id.StreamId, arg1: None | tuple[ImageData, ImageDataRecord] | MotionData | GpsData | WifiBeaconData | tuple[AudioData, AudioDataRecord] | BarometerData | BluetoothBeaconData, arg2: SensorDataType, arg3: int, arg4: int) -> None:
        ...
...
class TimeDomain:
    ...
    __members__: typing.ClassVar[typing.Dict[str, TimeDomain]]  # value = {'RECORD_TIME': <TimeDomain.RECORD_TIME: 0>, 'DEVICE_TIME': <TimeDomain.DEVICE_TIME: 1>, 'HOST_TIME': <TimeDomain.HOST_TIME: 2>, 'TIME_CODE': <TimeDomain.TIME_CODE: 3>}
    def __eq__(self, other: object) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
TIME_CODE: TimeDomain  # value = <TimeDomain.TIME_CODE: 3>
