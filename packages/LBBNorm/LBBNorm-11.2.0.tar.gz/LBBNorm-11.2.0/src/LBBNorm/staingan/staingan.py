...
Hint: you can download the pretrained model with `model.download_model()`, or you can specify it like this `StainGAN(model_path='../../../model.pth')` on creation time.""")
        ...
        for i, data in enumerate(dataset):
            ...
            img = visualizer.save_images(webpage, visuals, img_path, aspect_ratio=opt.aspect_ratio)
...
#     load_path = "D:\\Uni\\Image\\StainGAN-master1\\StainGAN-master\\checkpoints\\aicha\\experiment_name\\latest_net_G.pth"
#     path_image = "D:\\Uni\\Image\\StainGAN-master1\\StainGAN-master\\test_data\\1.jpg"
#     path_size = 1024
#     results_dir = "C:\\Users\\ahmad.M3402\\Desktop\\"
#     stainGan_normalizer().transform(load_path,path_image,results_dir)
