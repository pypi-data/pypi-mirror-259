...
class BaseOptions():
    ...
    def initialize(self, path_size):
        ...
        self.parser.add_argument('--loadSize', type=int, default=path_size, help='scale images to this size')
        self.parser.add_argument('--fineSize', type=int, default=path_size, help='then crop to this size')
        ...
        # self.parser.add_argument('--model', type=str, default='test',help='chooses which model to use. cycle_gan, pix2pix, test')
    ...
    def parse(self, path_size,results_dir):
        if not self.initialized:
            self.initialize(path_size,results_dir)
