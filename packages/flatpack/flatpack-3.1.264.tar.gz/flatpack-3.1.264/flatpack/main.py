...
def fpk_vector(directory_name: str, vector_dimension=128, metric='angular', n_trees=10, verbose=False):
    """
    Create and manage a vector index for a specific directory, ensuring file creation and handling.
    Validates the directory name before proceeding.
    """

    # Validate directory name using the provided validation logic
    if not fpk_valid_directory_name(directory_name):
        print(f"❌ Invalid directory name: '{directory_name}'.")
        return None
