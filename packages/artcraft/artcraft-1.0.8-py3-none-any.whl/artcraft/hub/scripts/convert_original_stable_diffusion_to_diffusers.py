...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help=(
            "The custom type. One of 'FrozenOpenCLIPEmbedder', 'FrozenCLIPEmbedder', 'PaintByExample'"
            ". If `None` custom will be automatically inferred."
        ),
    )
    parser.add_argument(
        "--image_size",
    ...
    parser.add_argument(
        "--to_safetensors",
        action="store_true",
        help="Whether to store custom in safetensors format or not.",
    )
    ...
    parser.add_argument(
        ...
        default=None,
        required=False,
        help="Specify the custom class name",
    )
