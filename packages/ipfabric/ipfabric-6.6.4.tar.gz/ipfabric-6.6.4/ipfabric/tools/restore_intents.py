...
V4_4_PATH = files("ipfabric.tools.factory_defaults.v4.4")
V5_0_PATH = files("ipfabric.tools.factory_defaults.v5.0")
V6_0_PATH = files("ipfabric.tools.factory_defaults.v6.0")
V6_3_PATH = files("ipfabric.tools.factory_defaults.v6.3")

DEFAULT_SETUP = {
    "v4.4": {
        "intents": json.loads(V4_4_PATH.joinpath(INTENTS).read_text()),
        "groups": json.loads(V4_4_PATH.joinpath(GROUPS).read_text()),
        "dashboard": json.loads(V4_4_PATH.joinpath(DASHBOARD).read_text(), object_pairs_hook=OrderedDict),
    },
    "v5.0": {
        "intents": json.loads(V5_0_PATH.joinpath(INTENTS).read_text()),
        "groups": json.loads(V5_0_PATH.joinpath(GROUPS).read_text()),
        "dashboard": json.loads(V5_0_PATH.joinpath(DASHBOARD).read_text(), object_pairs_hook=OrderedDict),
    },
    "v6.0": {
        "intents": json.loads(V6_0_PATH.joinpath(INTENTS).read_text()),
        "groups": json.loads(V6_0_PATH.joinpath(GROUPS).read_text()),
        "dashboard": json.loads(V6_0_PATH.joinpath(DASHBOARD).read_text(), object_pairs_hook=OrderedDict),
    },
    "v6.3": {
        "intents": json.loads(V6_3_PATH.joinpath(INTENTS).read_text()),
        "groups": json.loads(V6_3_PATH.joinpath(GROUPS).read_text()),
        "dashboard": json.loads(V6_3_PATH.joinpath(DASHBOARD).read_text(), object_pairs_hook=OrderedDict),
    },
}
