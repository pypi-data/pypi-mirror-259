...
import dot from '../../images/Ellipsis.gif'
...
const Chat = () => {
    ...
    const getAgentAsk = async () => {
        try {
            setLoading(true);
            const askRes = await ApiPost(API_Path.agentAsk, { agent_info: chatContext?.reactSelect, message: prompt })
            if (askRes?.status === 200) {
                setAskRes(askRes?.data?.reply)
            }
        } catch (error) {
                            ...
                            <div className="w-full">
                                <div className='mt-10 ms-7 pe-8 h-[calc(100vh-218px)] overflow-auto scrollbar'>
                                    <div className='mb-10'>
                                        ...
                                        {loading && <div className="mt-8 ps-6">
                                            <img src={dot} alt="wave" className='w-[30px] h-[30px]' />
                                        </div>
                                        }
