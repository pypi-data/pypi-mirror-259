...
class CloudInputstream:
    ...
    def __init__(self, user_token:str, **kwargs):
        self.token  = user_token
        mongo_conn  = os.environ.get("MONGO_CONN_STRING", "localhost")
        mongo_db    = os.environ.get("MONGO_DB", "a2g")
    ...
    def find(self, ikey:str, query:dict):
        """
    ...
    def find_one(self, ikey, query:dict):
        """
    ...
    def get_data_aggregate(self, ikey:str, query: list[dict]):
        """
        return data from inputstream
        params:
            ikey: str
