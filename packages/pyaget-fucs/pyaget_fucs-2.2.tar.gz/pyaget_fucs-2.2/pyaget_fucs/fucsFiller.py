...
TO UPDATE
=========
export PYAGET_VERSION=1.0.0 && python3 -m build --sdist && twine upload dist/* && rm -R dist/*.tar.gz
"""
...
1.7. Design of synchronous sequential circuits. counters, shift-register. 
...
"""
    ...
    fucName = {
        1: "Introduação à Arquitetura de Computadores",
    ...
    interface.exportAnswers(fucName, "txt", ".")
