...
PEDAGOGICAL_MODEL = """
The total contact hours for this course is {contactHours} hours, the ECTS equal {ECTS}, and the estimated total working hours are around {workingHours}.Integrates all answers with applied psychology.
"""
    ...
    1.0: {# ILO and Evidence OK, but Teaching Methodologies nope
        "importantTopics": [
            ...
            ("Intended learning outcomes (ILOs)",
                "use the Bloom's taxonomy verbs to develop your answer",
                "display answer in numeric list",
                "do not quote syllabus topic",
                "do not detail it"),

            ("Evidence of the each syllabus topic coherence with the previous ILOs",
                "link ILOs topics to related, one or more, syllabus topic numbers",
                "optimize your answer citing syllabus and ILOs numbers ",
            ...
            ("Optimized Teaching Methodologies (TMs) and specific learning of the curricular unit",
                ...
                "include autonomous student time to study and specify how to",
                "cite digital technology applications that could be used in TMs",
                "cite syllabus topics"),
