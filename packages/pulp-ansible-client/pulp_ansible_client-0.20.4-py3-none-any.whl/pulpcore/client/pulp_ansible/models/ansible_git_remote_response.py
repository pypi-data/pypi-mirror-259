...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, connect_timeout=None, pulp_href=None, client_cert=None, proxy_url=None, name=None, pulp_created=None, url=None, download_concurrency=None, ca_cert=None, max_retries=None, headers=None, pulp_labels=None, rate_limit=None, tls_validation=None, sock_read_timeout=None, pulp_last_updated=None, sock_connect_timeout=None, total_timeout=None, hidden_fields=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
