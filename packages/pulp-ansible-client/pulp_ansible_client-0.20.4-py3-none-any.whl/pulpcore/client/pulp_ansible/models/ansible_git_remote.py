...
class AnsibleGitRemote(object):
    ...
    def __init__(self, connect_timeout=None, client_cert=None, proxy_url=None, name=None, password=None, url=None, download_concurrency=None, ca_cert=None, max_retries=None, proxy_password=None, proxy_username=None, headers=None, pulp_labels=None, rate_limit=None, tls_validation=None, sock_read_timeout=None, username=None, client_key=None, sock_connect_timeout=None, total_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
