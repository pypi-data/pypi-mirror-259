...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, name=None, pulp_labels=None, proxy_password=None, proxy_url=None, client_cert=None, sock_read_timeout=None, total_timeout=None, proxy_username=None, tls_validation=None, rate_limit=None, max_retries=None, username=None, download_concurrency=None, url=None, client_key=None, ca_cert=None, password=None, headers=None, connect_timeout=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
