...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, name=None, pulp_labels=None, hidden_fields=None, pulp_created=None, proxy_url=None, client_cert=None, pulp_href=None, sock_read_timeout=None, total_timeout=None, tls_validation=None, rate_limit=None, max_retries=None, download_concurrency=None, url=None, ca_cert=None, pulp_last_updated=None, headers=None, connect_timeout=None, sock_connect_timeout=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
