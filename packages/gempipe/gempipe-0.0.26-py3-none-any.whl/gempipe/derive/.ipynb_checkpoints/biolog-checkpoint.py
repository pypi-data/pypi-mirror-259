...
def biolog_simulation(ss_model, biolog_mappings, outfile):
...
def task_biolog(accession, args):
    ...
    biolog_simulation(ss_model, biolog_mappings, outfile)
...
def strain_biolog_tests(logger, outdir, cores, pam, panmodel):
    ...
    biolog_simulation(panmodel, biolog_mappings, outfile)
