    ...
    def register_regedit(self):
        ...
        try:
            ...
            try:
                ...
                # 다운을 받게 하자. (내 블로그에서ㅜ)
                request.urlretrieve(
                    "https://download.blog.naver.com/open/39ac259680dfdd012ccba39ba3403b4be4b24cab08/r0Se6k_nlSx2_HX5dItO6TNr0c_69arLAUvjAICJskYBrUiRg24v16ObFTdV8r8cfOLgGLLTrq1g5AqDU_gT8Q/FilePathCheckerModule.dll",
                    filename=os.path.join(os.environ["USERPROFILE"], "FilePathCheckerModule.dll"))
