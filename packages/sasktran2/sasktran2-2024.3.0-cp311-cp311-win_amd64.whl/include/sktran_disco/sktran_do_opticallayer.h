...
namespace sasktran_disco {
    ...
    class OpticalLayer : public OpticalLayerROP<NSTOKES>,
      ...
      public:
        ...
        inline const VectorDim1<LegendreCoefficient<NSTOKES>>&
        expansionPhaseFunction(AEOrder m) const {
            return *m_lephasef;
        }

        inline bool computeDerivative() const { return m_compute_deriv; }
      ...
      protected:
        ...
        // These are used to avoid reallocs, should probably move into
        // ThreadData class along with the above Duals?
