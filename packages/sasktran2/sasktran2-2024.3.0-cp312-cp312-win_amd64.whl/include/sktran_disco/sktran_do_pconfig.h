...
namespace sasktran_disco {
    ...
    class PersistentConfiguration : public BasicProperties<NSTOKES>,
      ...
      public: // Configuration getters
        ...
        // Returns true if we are going to use the pseudo-spherical
        // approximation
        ...
        inline SKTRAN_DO_UserSpec::LayerConstructionMethod
        layer_construction_method() const {
