...
class EcsCluster:
    ...
    def service(self,
        ...
        print("**** docker.py. self.scope.env:", self.scope.env)
        print("**** docker.py. self.subnet_type:", self.subnet_type)
        task_subnets = self.scope.env.service_subnets(self.subnet_type)
        print("**** docker.py. self.scope.env.service_subnets(self.subnet_type):", task_subnets)
        for subnet in task_subnets:
            print(f"**** docker.py. subnet.subnet_id: {subnet.subnet_id} subnet: {subnet}")
