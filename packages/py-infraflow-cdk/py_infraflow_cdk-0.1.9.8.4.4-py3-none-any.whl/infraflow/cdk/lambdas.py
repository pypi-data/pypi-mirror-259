...
class LambdaContext:
    ...
    def function(
        ...
        print("**** lambdas.py. self.stage.env:", self.stage.env)
        print("**** lambdas.py. self.subnet_type:", self.subnet_type)
        print("**** lambdas.py. self.stage.env.service_subnets(self.subnet_type):", self.stage.env.service_subnets(self.subnet_type))
        # if self.role:
