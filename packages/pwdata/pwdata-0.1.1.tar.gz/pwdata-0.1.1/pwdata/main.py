...
from pwdata.datasets_saver import save_to_dataset
...
class Configs(object):
    ...
    @staticmethod
    def to(self, output_path, file_name = None, file_format = None, direct = True, sort = False, wrap = False, train_ratio = 0.8, **kwargs):
        """
        ...
        Kwargs:
        Additional keyword arguments for saving the file.
        ...
        if file_format.lower() == 'pwmat/config':
            ...
            save_to_movement(self, output_path, file_name, is_cartesian=self.cartesian)
        elif file_format.lower() == "extxyz":
            save_to_extxyz(self, output_path, file_name)
        elif file_format.lower() == "pwmlff/npy":
            save_to_dataset(self, datasets_path = output_path, train_ratio = train_ratio, data_name = file_name, **kwargs)
        else:
