    ...
    class DATA(
        ...
        class FORMAT:
            ...
            def wappi_status(
                ...
                if value.authorized:
                    payment_expired_at: datetime = DateTimeTool.date_from_string(
                        value.payment_expired_at  # type: ignore
                    )  # type: ignore
                    day_last_for_payment_expiration: int = (
                        payment_expired_at - DateTimeTool.today()
                    ).days  # type: ignore
                    return j(
                        (
                            title,
    ...
    class RESULT(ResultTool):
        ...
        class NOTES:
            ...
            def _convert_from_event(value: EventDS) -> Result[Note | File]:
                ...
                if value.name == CONST.NOTES.SECTION:
        ...
        class FILES:
            ...
            def find(
                ...
                if need_update or e(PIH.RESULT.NOTES._local_database_cache[CONST]):
                    PIH.RESULT.NOTES._local_database_cache = ResultTool.map(
                        lambda item: File(
