...
class Stage:
    ...
    Attributes:
        ...
        description (:obj:`str`): The stage's description.
        ...
        services (:obj:`dict`): If supported by the stage's, a dictionary mapping a service name to
...
class PipelineBuilder:
    ...
    def _update_parameter_name_in_config(self, configurations, config_definition_map, old_param, new_param):
        # A port of pipeline_creation_helper.ts's updateParameterNameInConfig (https://git.io/Jqdsz)
        for config_list in configurations:
