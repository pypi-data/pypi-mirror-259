...
class OrganizationsLocal(GenericCRUDML):
    ...
    def insert_organization(self, organization_dict: dict) -> tuple[int, int]:
        ...
        organization_data_json = {
            ...
            "is_test_data": organization_dict.get('is_test_data'),
            "created_user_id": organization_dict.get('created_user_id'),
            "created_real_user_id": organization_dict.get('created_real_user_id'),
            "created_effective_user_id": organization_dict.get('created_effective_user_id'),
            "created_effective_profile_id": organization_dict.get('created_effective_profile_id'),
            "updated_user_id": organization_dict.get('updated_user_id'),
            "updated_real_user_id": organization_dict.get('updated_real_user_id'),
            "updated_effective_user_id": organization_dict.get('updated_effective_user_id'),
            "updated_effective_profile_id": organization_dict.get('updated_effective_profile_id'),
    ...
    def upsert_organization(self, organization_dict: dict, order_by: str = None) -> tuple[int, int]:
        logger.start(object={'data': str(organization_dict)})
        organization_id = self.select_one_value_by_where(
            view_table_name="organization_ml_view",
            select_clause_value="organization_id",
            where="name = %s AND lang_code = %s AND description = %s",
            params=(organization_dict.get('name'), organization_dict.get('lang_code'), organization_dict.get('description')),
            order_by=order_by
        )
        ...
        organization_id = GenericCRUDML.upsert(self, data_json=organization_data_json,
    ...
    def get_organization_dict_by_organization_id(self, organization_id: int, organization_ml_id: int = None) -> dict:
        ...
        if organization_ml_id:
            organization_ml_dict = self.select_one_dict_by_id(view_table_name="organization_ml_view",
                                                              ...
                                                              id_column_name="organization_ml_id")
        organization_dict = self.select_one_dict_by_id(view_table_name="organization_view", id_column_value=organization_id,
                                                       id_column_name="organization_id")
        logger.end(object={'organization_ml_dict': str(organization_ml_dict),
                   'organization_view': str(organization_dict)})
