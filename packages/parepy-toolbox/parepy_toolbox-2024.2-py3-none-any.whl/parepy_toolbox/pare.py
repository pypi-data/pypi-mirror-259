...
def sampling_algorithm_structural_analysis(setup):
    ...
    in structural reliability problems.
    
    See documentation in https://wmpjrufg.github.io/PAREPY/framework_samplingAlgStructuralAnalysis.html
...
def type_process_run(dataset, obj, none_variable, n_constraints):
    ...
    Args:
        ...
        obj (def): Objective function. The PAREpy user defined this function.
        none_variable (None, list, float, dictionary, str or any): None variable. 
                       User can use this variable in objective function
        n_constraints (int): Number of state limit functions or constraints.
    
    returns:
        type_process (str): Best type process.
        elapsed_time (float): Elapsed time.
    """

    # Selecting a sample to test
    dataset_x = dataset[:50]
