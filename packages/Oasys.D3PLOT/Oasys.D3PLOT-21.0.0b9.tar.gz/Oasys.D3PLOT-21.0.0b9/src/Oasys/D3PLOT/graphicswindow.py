...
class GraphicsWindowType(type):
    _consts = {'NO_OFFSET', 'OFFSET_MODEL_SPACE', 'OFFSET_SCREEN_SPACE'}
...
class GraphicsWindow(Oasys.gRPC.OasysItem, metaclass=GraphicsWindowType):
    _props = {'active', 'models', 'number', 'state', 'states'}
...
# Instance methods
    ...
    def RemoveModel(self):
        ...
        None
            No return value
        """
        return Oasys.D3PLOT._connection.instanceMethod(self.__class__.__name__, self._handle, "RemoveModel")
