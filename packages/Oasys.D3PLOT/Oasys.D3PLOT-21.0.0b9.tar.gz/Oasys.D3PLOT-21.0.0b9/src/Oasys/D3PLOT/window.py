...
# Static methods
    def Error(title, error, buttons=Oasys.gRPC.defaultArg):
        ...
        int
            Button pressed
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "Error", title, error, buttons)
    ...
    def GetDirectory(initial=Oasys.gRPC.defaultArg):
        ...
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "GetDirectory", initial)
    ...
    def GetFile(extension=Oasys.gRPC.defaultArg, save=Oasys.gRPC.defaultArg, initial=Oasys.gRPC.defaultArg):
        ...
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "GetFile", extension, save, initial)
    ...
    def GetFilename(title, message, extension=Oasys.gRPC.defaultArg, initial=Oasys.gRPC.defaultArg, save=Oasys.gRPC.defaultArg):
        ...
        str
            filename (string), (or None if cancel pressed)
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "GetFilename", title, message, extension, initial, save)
    ...
    def GetFiles(extension=Oasys.gRPC.defaultArg):
        ...
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "GetFiles", extension)
    ...
    def GetInteger(title, message, initial=Oasys.gRPC.defaultArg):
        ...
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "GetInteger", title, message, initial)
    ...
    def GetNumber(title, message, initial=Oasys.gRPC.defaultArg):
        ...
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "GetNumber", title, message, initial)
    ...
    def GetPassword(title, message):
        ...
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "GetPassword", title, message)
    ...
    def GetString(title, message, initial=Oasys.gRPC.defaultArg):
        ...
        str
            value input (string), or None if cancel pressed
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "GetString", title, message, initial)
    ...
    def Information(title, info, buttons=Oasys.gRPC.defaultArg):
        ...
        int
            Button pressed
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "Information", title, info, buttons)
    ...
    def Message(title, message, buttons=Oasys.gRPC.defaultArg):
        ...
        int
            Button pressed
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "Message", title, message, buttons)
    ...
    def Question(title, question, buttons=Oasys.gRPC.defaultArg):
        ...
        int
            Button pressed
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "Question", title, question, buttons)
    ...
    def Warning(title, warning, buttons=Oasys.gRPC.defaultArg):
        ...
        int
            Button pressed
        """
        return Oasys.D3PLOT._connection.classMethod(__class__.__name__, "Warning", title, warning, buttons)
