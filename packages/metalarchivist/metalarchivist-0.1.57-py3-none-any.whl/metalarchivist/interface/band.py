...
class BandProfile:
    ...
    @staticmethod
    def _parse_description_titles(profile_document: lxml.etree) -> list[str]:
    ...
    @staticmethod
    def _parse_description_details(profile_document: lxml.etree) -> list[str]:
        ...
        desc_detail = [None if detail == 'N/A' else detail for detail in desc_detail]
