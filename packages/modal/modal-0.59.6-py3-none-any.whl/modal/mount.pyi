...
class _MountCache:
    cache: typing.Dict[typing.FrozenSet[typing.Tuple[pathlib.Path, pathlib.PurePosixPath]], _Mount]

    def __init__(self):
        ...

    def _cache_key(self, mount: _Mount) -> typing.FrozenSet[typing.Tuple[pathlib.Path, pathlib.PurePosixPath]]:
        ...

    def get(self, mount: _Mount) -> _Mount:
        ...

    def get_many(self, mounts: typing.Collection[_Mount]) -> typing.List[_Mount]:
        ...
