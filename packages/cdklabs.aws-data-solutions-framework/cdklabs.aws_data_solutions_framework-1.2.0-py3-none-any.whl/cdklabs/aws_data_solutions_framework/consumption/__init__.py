...
class OpenSearchCluster(
    ...
    def add_role_mapping(
        ...
        return typing.cast(None, jsii.invoke(self, "addRoleMapping", [id, name, role]))
    ...
    def call_open_search_api(
        ...
        return typing.cast(None, jsii.invoke(self, "callOpenSearchApi", [id, api_path, body]))
