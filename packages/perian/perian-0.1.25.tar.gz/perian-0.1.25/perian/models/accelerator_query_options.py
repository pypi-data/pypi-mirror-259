...
class AcceleratorQueryOptions(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[QueryOptions, object]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: List[str] = Field(default=Literal["QueryOptions", "object"])
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[QueryOptions] = None
        try:
            instance.actual_instance = QueryOptions.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], QueryOptions, object]]:
