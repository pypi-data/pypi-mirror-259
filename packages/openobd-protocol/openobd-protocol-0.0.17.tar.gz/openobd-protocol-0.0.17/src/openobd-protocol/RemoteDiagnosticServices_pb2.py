...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_REMOTEDIAGNOSTICSERVICES']._serialized_start=174
  _globals['_REMOTEDIAGNOSTICSERVICES']._serialized_end=803
