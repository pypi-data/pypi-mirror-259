...
class EcuId(_message.Message):
    __slots__ = ("request_id", "response_id", "extended_request_address", "extended_response_address", "padding")
    ...
    padding: bytes
    def __init__(self, request_id: _Optional[bytes] = ..., response_id: _Optional[bytes] = ..., extended_request_address: _Optional[bytes] = ..., extended_response_address: _Optional[bytes] = ..., padding: _Optional[bytes] = ...) -> None: ...
