...
class RemoteDiagnosticServicesStub(object):
    ...
    def __init__(self, channel):
        ...
        self.sendRequest = channel.unary_unary(
                ...
                request_serializer=ObdMessage__pb2.ObdMessage.SerializeToString,
                response_deserializer=ObdMessage__pb2.ObdMessage.FromString,
                )
...
def add_RemoteDiagnosticServicesServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'sendRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=ObdMessage__pb2.ObdMessage.FromString,
                    response_serializer=ObdMessage__pb2.ObdMessage.SerializeToString,
            ),
...
class RemoteDiagnosticServices(object):
    ...
    def sendRequest(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/com.jifeline.OpenOBD.Protocol.RemoteDiagnosticServices/sendRequest',
            ObdMessage__pb2.ObdMessage.SerializeToString,
            ObdMessage__pb2.ObdMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
