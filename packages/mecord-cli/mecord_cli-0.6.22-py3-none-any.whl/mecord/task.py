...
# with open("C:\\Users\\123\\Downloads\\models.config", "r", encoding="utf-8") as f:
...
#     if len(models[speaker]["text"]) > 0:
#         print(speaker)
#         # dd = json.dumps({"lan":"zh-Hant","messages":[{"content":"很高兴见到你，让我们一同探索无限可能，共同创造美好的回忆。无论何时何地，我都期待着再次与你相见。","gender":"female","speaker":speaker,"train_name":speaker,"train_mp3":"","pitch":0,"speed":1,"speakerMap":{"default":""}}]})
#         # configs_sql.append(f"UPDATE `mecord`.`talker_audio_config` SET `config` = '{dd}' WHERE `name` = '{speaker}';")
#         # idx += 1

# # with open("C:\\Users\\123\\Downloads\\models_config.txt", "w") as f:
# #     f.write("\n".join(configs_sql))
