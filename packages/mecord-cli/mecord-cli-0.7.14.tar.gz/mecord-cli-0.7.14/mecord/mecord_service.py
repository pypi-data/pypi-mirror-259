...
class MecordService:
    ...
    def start(self, threadNum=1):
        ...
        self.THEADING_LIST.append(TaskConnector.MecordLongConnectThread("us"))
        self.THEADING_LIST.append(TaskConnector.MecordLongConnectThread("test"))
        self.THEADING_LIST.append(TaskConnector.MecordShortConnectThread("sg"))
