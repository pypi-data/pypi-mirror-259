...
def syncify(instance: Any) -> None:
    ...
    One known limitation of this approach is that it breaks return type inference of mypy for the patched functions.
    A possible way to get around this could be to use metaprogramming to create a new class with the patched functions
    on the fly and hope mypy can infer that.
