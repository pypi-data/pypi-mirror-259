...
from zope.schema import Choice, Float, Int, Object, Text, TextLine, URI
...
from pyams_workflow.interfaces import WORKFLOWS_VOCABULARY
...
class IMovieTheaterPortalPage(IPortalPage):
    """Movie theater portal page marker interface"""
