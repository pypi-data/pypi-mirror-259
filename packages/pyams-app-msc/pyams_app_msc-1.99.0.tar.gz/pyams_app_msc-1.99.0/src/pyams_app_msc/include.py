...
from pyams_app_msc.interfaces import CREATE_BOOKING_PERMISSION, MANAGE_BOOKING_PERMISSION, MANAGE_CATALOG_PERMISSION, \
    MANAGE_PLANNING_PERMISSION, MANAGE_THEATER_PERMISSION, MSC_CLIENT_ROLE, MSC_CONTRIBUTOR_ROLE, MSC_MANAGER_ROLE, \
    MSC_OPERATOR_ROLE, MSC_OWNER_ROLE, MSC_READER_ROLE, MSC_SITES_MANAGER_ROLE, VIEW_BOOKING_PERMISSION, \
    VIEW_CATALOG_PERMISSION, VIEW_PLANNING_PERMISSION, VIEW_THEATER_PERMISSION
...
from pyams_content.interfaces import COMMENT_CONTENT_PERMISSION, CREATE_CONTENT_PERMISSION, CREATE_VERSION_PERMISSION, \
    MANAGE_CONTENT_PERMISSION, MANAGE_SITE_PERMISSION, MANAGE_SITE_TREE_PERMISSION, \
    MANAGE_TOOL_PERMISSION, PUBLISH_CONTENT_PERMISSION, WEBMASTER_ROLE
...
def include_package(config):
    ...
    config.register_role({
        ...
        'permissions': {
            VIEW_CATALOG_PERMISSION, CREATE_BOOKING_PERMISSION
        },
        'managers': {
            ADMIN_USER_ID,
            ROLE_ID.format(SYSTEM_ADMIN_ROLE)
    ...
    config.register_role({
        ...
        'permissions': {
            VIEW_CATALOG_PERMISSION, MANAGE_BOOKING_PERMISSION
        },
        'managers': {
            ADMIN_USER_ID,
            ROLE_ID.format(SYSTEM_ADMIN_ROLE)
