/*! For license information please see 27764.hqwkTIds85Y.js.LICENSE.txt */
export const id=27764;export const ids=[27764];export const modules={61436:(e,t,i)=>{i.d(t,{e:()=>l});var s=i(17072),o=i(84244),r=i(22964);const n=Symbol("valueNotInitialized");class a extends r.w${constructor(e){if(super(e),e.type!==s.sZ.ELEMENT)throw new Error(`\`${this.constructor.name}\` must be bound to an element.`);this.previousValue=n}render(e,t){return o.qs}update(e,[t,i]){if(!this.hasChanged(i))return o.qs;this.host=e.options&&e.options.host,this.element=e.element,this.renderer=t;return this.previousValue===n?this.addRenderer():this.runRenderer(),this.previousValue=Array.isArray(i)?[...i]:i,o.qs}reconnected(){this.addRenderer()}disconnected(){this.removeRenderer()}addRenderer(){throw new Error("The `addRenderer` method must be implemented.")}runRenderer(){throw new Error("The `runRenderer` method must be implemented.")}removeRenderer(){throw new Error("The `removeRenderer` method must be implemented.")}renderRenderer(e,...t){const i=this.renderer.call(this.host,...t);(0,o.ai)(i,e,{host:this.host})}hasChanged(e){return Array.isArray(e)?!Array.isArray(this.previousValue)||(this.previousValue.length!==e.length||e.some(((e,t)=>e!==this.previousValue[t]))):this.previousValue!==e}}const l=(0,s.E$)(class extends a{addRenderer(){this.element.renderer=(e,t,i)=>{this.renderRenderer(e,i.item,i,t)}}runRenderer(){this.element.requestContentUpdate()}removeRenderer(){this.element.renderer=null}})},4172:(e,t,i)=>{function s(e){const t=customElements.get(e.is);if(t){const i=t.version;i&&e.version&&i===e.version?console.warn(`The component ${e.is} has been loaded twice`):console.error(`Tried to define ${e.is} version ${e.version} when version ${t.version} is already in use. Something will probably break.`)}else Object.defineProperty(e,"version",{get:()=>"24.3.5"}),customElements.define(e.is,e)}class o extends HTMLElement{static get is(){return"vaadin-material-styles"}}s(o);var r=i(840),n=i(93648);const a=(e,...t)=>{(0,n.cn)(`material-${e}`,t)},l=r.gV`
  :host {
    /* Text colors */
...
`;(0,r.Up)("",l,{moduleId:"material-color-light"});const h=r.gV`
  :host {
    /* Text colors */
    --material-body-text-color: var(--dark-theme-text-color, rgba(255, 255, 255, 1));
    --material-secondary-text-color: var(--dark-theme-secondary-color, rgba(255, 255, 255, 0.7));
...
`;(0,r.Up)("",h,{moduleId:"material-color-dark"});a("color-base",r.gV`
  :host {
    /* Text colors */
    --material-body-text-color: var(--light-theme-text-color, rgba(0, 0, 0, 0.87));
    --material-secondary-text-color: var(--light-theme-secondary-color, rgba(0, 0, 0, 0.54));
...
`;(0,r.Up)("vaadin-item",d,{moduleId:"material-item"});const c=r.gV`
  :host {
    cursor: pointer;
...
`;(0,r.Up)("vaadin-combo-box-item",[d,c],{moduleId:"material-combo-box-item"});const u=r.gV`
  [part~='loader'] {
    height: 2px;
...
`;(0,r.Up)("",_,{moduleId:"material-overlay"});const p=_;(0,r.Up)("",p,{moduleId:"material-menu-overlay"});const m=r.gV`
  [part='overlay'] {
    position: relative;
    overflow: visible;
